(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/262/function_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      ...
      __LINE__ = 5;
      a/*Runtime*/.assert( true,1 === d/*test*/(),"1 === test()",5,'./function_test.js' );
      
      __LINE__ = 7;
      var e/*testExpression*/ = function () {
            try {
              __LINE__ = 8;
              return 1;
            } catch( e ){
      ...
      __LINE__ = 10;
      a/*Runtime*/.assert( true,1 === e/*testExpression*/(),"1 === testExpression()",10,'./function_test.js' );
      ...
      __LINE__ = 18;
      a/*Runtime*/.assert( true,1 === f/*testObject*/.prop(),"1 === testObject.prop()",18,'./function_test.js' );
      
      function g/*testFormal*/( b/*arg*/,c/*arg2*/,d/*arg3*/ ) {
        try {
          __LINE__ = 21;
          return b/*arg*/+c/*arg2*/+d/*arg3*/;
        } catch( e ){
          a.exceptionHandler( __LINE__ , __FILE__ , e );
        }
      }
      __LINE__ = 23;
      a/*Runtime*/.assert( true,3 === g/*testFormal*/( 1,1,1 ),"3 === testFormal( 1,1,1 )",23,'./function_test.js' );
      
      __LINE__ = 26;
      var h/*testExpressionFormal*/ = function ( b/*arg*/,c/*arg2*/,d/*arg3*/ ) {
            try {
              __LINE__ = 27;
              return b/*arg*/+c/*arg2*/+d/*arg3*/;
            } catch( e ){
      ...
      __LINE__ = 29;
      a/*Runtime*/.assert( true,3 === h/*testExpressionFormal*/( 1,1,1 ),"3 === testExpressionFormal( 1,1,1 )",29,'./function_test.js' );
      
      __LINE__ = 31;
      var i/*testObjectFormal*/ =  {
            prop : function ( b/*arg*/,c/*arg2*/,d/*arg3*/ ) {
              try {
                __LINE__ = 33;
                return b/*arg*/+c/*arg2*/+d/*arg3*/;
              } catch( e ){
      ...
      __LINE__ = 36;
      a/*Runtime*/.assert( true,3 === i/*testObjectFormal*/.prop( 1,1,1 ),"3 === testObjectFormal.prop( 1,1,1 )",36,'./function_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  })();
