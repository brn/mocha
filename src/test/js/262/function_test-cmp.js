!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 5;
      a.assert( true,1 === d(),"1 === test()",5,'./function_test.js' );
      ...
      __LINE__ = 10;
      a.assert( true,1 === e(),"1 === testExpression()",10,'./function_test.js' );
      ...
      __LINE__ = 18;
      a.assert( true,1 === f.prop(),"1 === testObject.prop()",18,'./function_test.js' );
      ...
      __LINE__ = 23;
      a.assert( true,3 === g( 1,1,1 ),"3 === testFormal( 1,1,1 )",23,'./function_test.js' );
      ...
      __LINE__ = 29;
      a.assert( true,3 === h( 1,1,1 ),"3 === testExpressionFormal( 1,1,1 )",29,'./function_test.js' );
      ...
      __LINE__ = 36;
      a.assert( true,3 === i.prop( 1,1,1 ),"3 === testObjectFormal.prop( 1,1,1 )",36,'./function_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  }();
