!function() {
  ...
  !function () {
    ...
    function e() {
      ...
      var k = new new i.highFn();
      
      var l = new new new i.highFn();
      
      var m = new i.highFnInner.highFn();
      
      var n = new new i.highFnInner.highFn();
      
      var o = new new new i.highFnInner.highFn();
    }
    function f() {
      var d = function () {
            return function () {
    ...
    function g() {
      ...
      var t = 'onmouseenter' in s && 'onmouseleave' in s;
    }
    function h() {
      var b = 0;
