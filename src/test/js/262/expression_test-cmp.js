(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./expression_test.js'] = {};
    
    var N/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./expression_test.js'];
    
    /aaaa/.test( "aaaa" );
    
    function O/*parseTest*/() {
      var b/*x*/ = .200*10;
    ...
    function P/*objectAndNewTest*/() {
      var q/*testObject*/ = {};
      
      q/*testObject*/.testProp = {};
      
      q/*testObject*/.testProp.testProp = {};
      
      q/*testObject*/.testProp.testProp.testProp = {};
      
      q/*testObject*/.testFn = function () {
        return true;
      };
      
      q/*testObject*/.testProp.testFn = function () {
        return false;
      };
      
      q/*testObject*/.testProp.testProp.testFn = function () {
        return 2;
      };
      
      var r/*highFn*/ = function () {
            return o/*inner1*/;
          };
      
      var o/*inner1*/ = function () {
            return p/*inner2*/;
          };
      
      var p/*inner2*/ = function (){};
      
      var s/*instance*/ = new r/*highFn*/();
      
      var t/*instance2*/ = new new r/*highFn*/();
      
      var u/*instance3*/ = new new new r/*highFn*/();
      ...
      var w/*instance4*/ = new v/*fnObj*/.highFn();
      
      var x/*instance5*/ = new new v/*fnObj*/.highFn();
      
      var y/*instance6*/ = new new new v/*fnObj*/.highFn();
      
      var z/*instance7*/ = new v/*fnObj*/.highFnInner.highFn();
      
      var A/*instance8*/ = new new v/*fnObj*/.highFnInner.highFn();
      
      var B/*instance9*/ = new new new v/*fnObj*/.highFnInner.highFn();
    }
    function Q/*callExpressionTest*/() {
      var i/*highFn*/ = function () {
            return function () {
              return function () {
                return true;
              };
      ...
      var g/*inner1*/ = function () {
            return h/*inner2*/;
          };
      
      var h/*inner2*/ = function (){};
      
      var j/*flg*/ = 1;
      
      var k/*instance*/ = new ( ( j/*flg*/ )?i/*highFn*/ : g/*inner1*/ );
      
      var l/*flg2*/ = 0;
      
      k/*instance*/ = new ( ( l/*flg2*/ )?i/*highFn*/ : g/*inner1*/ );
    }
    function R/*binaryExpressionTest*/() {
      var v/*item*/ = 100,
          w/*trueValue*/ = true,
          x/*falseValue*/ = false,
          t/*val*/ = 0;
      
      if ( v/*item*/ && w/*trueValue*/ && !x/*falseValue*/ ){
        t/*val*/ = 1;
      };
      ...
      if ( ( v/*item*/ && x/*falseValue*/ ) || !w/*trueValue*/ ){
        t/*val*/ = 3;
      };
      
      var y/*changeVal*/ = function ( v/*value*/ ) {
            t/*val*/ = v/*value*/;
          };
      
      ( v/*item*/ ) && ( w/*trueValue*/ ) && ( !x/*falseValue*/ ) && ( y/*changeVal*/( 4 ) );
      ...
      var M/*testInAnd*/ = 'onmouseenter' in L/*obj*/ && 'onmouseleave' in L/*obj*/;
    }
    function S/*postfixExpressionTest*/() {
      var c/*add*/ = 0;
    ...
    function T/*unaryExpressionTest*/() {
      var e/*strNum*/ = "1",
          f/*ret*/ = +e/*strNum*/;
    ...
    function U/*memberExpressionTest*/() {
      var b/*test*/ =  {
            test2 :  {
              "@test" :  {
                0 :  {
    ...
    Q/*callExpressionTest*/();
    
    R/*binaryExpressionTest*/();
    
    S/*postfixExpressionTest*/();
    
    T/*unaryExpressionTest*/();
    
    U/*memberExpressionTest*/();
