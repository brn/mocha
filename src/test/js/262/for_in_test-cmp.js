(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/262/for_in_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./for_in_test.js'] = {};
      
      __LINE__ = 3;
      var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./for_in_test.js'];
      ...
      __LINE__ = 8;
      for ( var g/*i*/ in e/*target*/ ){
        __LINE__ = 0;
        f/*arr*/.push( e/*target*/[g/*i*/] );
      };
      
      __LINE__ = 11;
      a/*Runtime*/.assert( true,f/*arr*/[0] === 100,"arr[0] === 100",11,'./for_in_test.js' );
      
      __LINE__ = 12;
      a/*Runtime*/.assert( true,f/*arr*/[1] === 200,"arr[1] === 200",12,'./for_in_test.js' );
      
      __LINE__ = 13;
      a/*Runtime*/.assert( true,f/*arr*/[2] === 300,"arr[2] === 300",13,'./for_in_test.js' );
      
      __LINE__ = 14;
      a/*Runtime*/.assert( true,f/*arr*/[3] === 400,"arr[3] === 400",14,'./for_in_test.js' );
      ...
      __LINE__ = 20;
      a/*Runtime*/.assert( true,f/*arr*/[0] === 100,"arr[0] === 100",20,'./for_in_test.js' );
      
      __LINE__ = 21;
      a/*Runtime*/.assert( true,f/*arr*/[1] === 200,"arr[1] === 200",21,'./for_in_test.js' );
      
      __LINE__ = 22;
      a/*Runtime*/.assert( true,f/*arr*/[2] === 300,"arr[2] === 300",22,'./for_in_test.js' );
      
      __LINE__ = 23;
      a/*Runtime*/.assert( true,f/*arr*/[3] === 400,"arr[3] === 400",23,'./for_in_test.js' );
      ...
      __LINE__ = 28;
      a/*Runtime*/.assert( true,f/*arr*/[0] === 100,"arr[0] === 100",28,'./for_in_test.js' );
      
      __LINE__ = 29;
      a/*Runtime*/.assert( true,f/*arr*/[1] === 200,"arr[1] === 200",29,'./for_in_test.js' );
      
      __LINE__ = 30;
      a/*Runtime*/.assert( true,f/*arr*/[2] === 300,"arr[2] === 300",30,'./for_in_test.js' );
      
      __LINE__ = 31;
      a/*Runtime*/.assert( true,f/*arr*/[3] === 400,"arr[3] === 400",31,'./for_in_test.js' );
      ...
      __LINE__ = 36;
      a/*Runtime*/.assert( true,f/*arr*/[0] === 100,"arr[0] === 100",36,'./for_in_test.js' );
      
      __LINE__ = 37;
      a/*Runtime*/.assert( true,f/*arr*/[1] === 200,"arr[1] === 200",37,'./for_in_test.js' );
      
      __LINE__ = 38;
      a/*Runtime*/.assert( true,f/*arr*/[2] === 300,"arr[2] === 300",38,'./for_in_test.js' );
      
      __LINE__ = 39;
      a/*Runtime*/.assert( true,f/*arr*/[3] === 400,"arr[3] === 400",39,'./for_in_test.js' );
      ...
      __LINE__ = 43;
      for ( h/*index*/.prop in e/*target*/ ){
        __LINE__ = 0;
        f/*arr*/.push( e/*target*/[h/*index*/.prop] );
      };
      
      __LINE__ = 46;
      a/*Runtime*/.assert( true,f/*arr*/[0] === 100,"arr[0] === 100",46,'./for_in_test.js' );
      
      __LINE__ = 47;
      a/*Runtime*/.assert( true,f/*arr*/[1] === 200,"arr[1] === 200",47,'./for_in_test.js' );
      
      __LINE__ = 48;
      a/*Runtime*/.assert( true,f/*arr*/[2] === 300,"arr[2] === 300",48,'./for_in_test.js' );
      
      __LINE__ = 49;
      a/*Runtime*/.assert( true,f/*arr*/[3] === 400,"arr[3] === 400",49,'./for_in_test.js' );
    } catch( e ){
