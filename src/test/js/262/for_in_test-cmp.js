(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./for_in_test.js'] = {};
    
    var I/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./for_in_test.js'];
    ...
    for ( var L/*i*/ in J/*target*/ ){
      K/*arr*/.push( J/*target*/[L/*i*/] );
    };
    ...
    for ( M/*index*/.prop in J/*target*/ ){
      K/*arr*/.push( J/*target*/[M/*index*/.prop] );
    };
  })();
})();
