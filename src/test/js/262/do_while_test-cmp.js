!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 8;
      a.assert( true,f[0] === 'j',"ret[0] === 'j'",8,'./do_while_test.js' );
      
      __LINE__ = 9;
      a.assert( true,f[1] === 'i',"ret[1] === 'i'",9,'./do_while_test.js' );
      
      __LINE__ = 10;
      a.assert( true,f[2] === 'h',"ret[2] === 'h'",10,'./do_while_test.js' );
      
      __LINE__ = 11;
      a.assert( true,f[3] === 'g',"ret[3] === 'g'",11,'./do_while_test.js' );
      
      __LINE__ = 12;
      a.assert( true,f[4] === 'f',"ret[4] === 'f'",12,'./do_while_test.js' );
      
      __LINE__ = 13;
      a.assert( true,f[5] === 'e',"ret[5] === 'e'",13,'./do_while_test.js' );
      
      __LINE__ = 14;
      a.assert( true,f[6] === 'd',"ret[6] === 'd'",14,'./do_while_test.js' );
      
      __LINE__ = 15;
      a.assert( true,f[7] === 'c',"ret[7] === 'c'",15,'./do_while_test.js' );
      
      __LINE__ = 16;
      a.assert( true,f[8] === 'b',"ret[8] === 'b'",16,'./do_while_test.js' );
      
      __LINE__ = 17;
      a.assert( true,f[9] === 'a',"ret[9] === 'a'",17,'./do_while_test.js' );
      ...
      __LINE__ = 24;
      a.assert( true,f[0] === 'j',"ret[0] === 'j'",24,'./do_while_test.js' );
      
      __LINE__ = 25;
      a.assert( true,f[1] === 'i',"ret[1] === 'i'",25,'./do_while_test.js' );
      
      __LINE__ = 26;
      a.assert( true,f[2] === 'h',"ret[2] === 'h'",26,'./do_while_test.js' );
      
      __LINE__ = 27;
      a.assert( true,f[3] === 'g',"ret[3] === 'g'",27,'./do_while_test.js' );
      
      __LINE__ = 28;
      a.assert( true,f[4] === 'f',"ret[4] === 'f'",28,'./do_while_test.js' );
      
      __LINE__ = 29;
      a.assert( true,f[5] === 'e',"ret[5] === 'e'",29,'./do_while_test.js' );
      
      __LINE__ = 30;
      a.assert( true,f[6] === 'd',"ret[6] === 'd'",30,'./do_while_test.js' );
      
      __LINE__ = 31;
      a.assert( true,f[7] === 'c',"ret[7] === 'c'",31,'./do_while_test.js' );
      
      __LINE__ = 32;
      a.assert( true,f[8] === 'b',"ret[8] === 'b'",32,'./do_while_test.js' );
      
      __LINE__ = 33;
      a.assert( true,f[9] === 'a',"ret[9] === 'a'",33,'./do_while_test.js' );
    } catch( e ){
