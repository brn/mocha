(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/262/label_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./label_test.js'] = {};
      
      __LINE__ = 3;
      var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./label_test.js'];
      ...
      __LINE__ = 7;
      a/*Runtime*/.assert( true,e/*ret*/ === 100,"ret === 100",7,'./label_test.js' );
      __LINE__ = 9;
      TEST_LABEL2 : 
      {
        __LINE__ = 0;
      ...
      __LINE__ = 10;
      a/*Runtime*/.assert( true,e/*ret*/ === 200,"ret === 200",10,'./label_test.js' );
    } catch( e ){
