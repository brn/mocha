(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/262/continue_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./continue_test.js'] = {};
      
      __LINE__ = 3;
      var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./continue_test.js'];
      
      __LINE__ = 1;
      for ( var e/*i*/ = 0;e/*i*/<10;e/*i*/ ++  ){
        __LINE__ = 2;
        continue ;
      };
      
      __LINE__ = 4;
      a/*Runtime*/.assert( true,e/*i*/ === 10,"i === 10",4,'./continue_test.js' );
      
      __LINE__ = 5;
      a/*Runtime*/.assert( true,e/*i*/ === 10,"i === 10",5,'./continue_test.js' );
      ...
      for ( e/*i*/ = 0;e/*i*/<10;e/*i*/ ++  ){
        ...
        __LINE__ = 11;
        a/*Runtime*/.assert( true,f/*j*/ === 0,"j === 0",11,'./continue_test.js' );
      };
      
      __LINE__ = 13;
      a/*Runtime*/.assert( true,e/*i*/ === 10,"i === 10",13,'./continue_test.js' );
      
      __LINE__ = 14;
      a/*Runtime*/.assert( true,e/*i*/ === 10,"i === 10",14,'./continue_test.js' );
      
      __LINE__ = 15;
      a/*Runtime*/.assert( true,e/*i*/ === 10,"i === 10",15,'./continue_test.js' );
    } catch( e ){
