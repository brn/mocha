  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/262/for_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./for_test.js'] = {};
      
      __LINE__ = 3;
      var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./for_test.js'];
      
      __LINE__ = 1;
      var e/*target*/ = ['a','b','c','d','e','f','g','h','i','j'];
      
      __LINE__ = 2;
      var f/*arr*/ = [];
      
      __LINE__ = 3;
      for ( var g/*i*/ = 0;g/*i*/<10;g/*i*/ ++  ){
        __LINE__ = 0;
        f/*arr*/.push( e/*target*/[g/*i*/] );
      };
      
      __LINE__ = 6;
      a/*Runtime*/.assert( true,f/*arr*/[0] === 'a',"arr[0] === 'a'",6,'./for_test.js' );
      
      __LINE__ = 7;
      a/*Runtime*/.assert( true,f/*arr*/[1] === 'b',"arr[1] === 'b'",7,'./for_test.js' );
      
      __LINE__ = 8;
      a/*Runtime*/.assert( true,f/*arr*/[2] === 'c',"arr[2] === 'c'",8,'./for_test.js' );
      
      __LINE__ = 9;
      a/*Runtime*/.assert( true,f/*arr*/[3] === 'd',"arr[3] === 'd'",9,'./for_test.js' );
      
      __LINE__ = 10;
      a/*Runtime*/.assert( true,f/*arr*/[4] === 'e',"arr[4] === 'e'",10,'./for_test.js' );
      
      __LINE__ = 11;
      a/*Runtime*/.assert( true,f/*arr*/[5] === 'f',"arr[5] === 'f'",11,'./for_test.js' );
      
      __LINE__ = 12;
      a/*Runtime*/.assert( true,f/*arr*/[6] === 'g',"arr[6] === 'g'",12,'./for_test.js' );
      
      __LINE__ = 13;
      a/*Runtime*/.assert( true,f/*arr*/[7] === 'h',"arr[7] === 'h'",13,'./for_test.js' );
      
      __LINE__ = 14;
      a/*Runtime*/.assert( true,f/*arr*/[8] === 'i',"arr[8] === 'i'",14,'./for_test.js' );
      
      __LINE__ = 15;
      a/*Runtime*/.assert( true,f/*arr*/[9] === 'j',"arr[9] === 'j'",15,'./for_test.js' );
      ...
      __LINE__ = 21;
      a/*Runtime*/.assert( true,f/*arr*/[0] === 'a',"arr[0] === 'a'",21,'./for_test.js' );
      
      __LINE__ = 22;
      a/*Runtime*/.assert( true,f/*arr*/[1] === 'b',"arr[1] === 'b'",22,'./for_test.js' );
      
      __LINE__ = 23;
      a/*Runtime*/.assert( true,f/*arr*/[2] === 'c',"arr[2] === 'c'",23,'./for_test.js' );
      
      __LINE__ = 24;
      a/*Runtime*/.assert( true,f/*arr*/[3] === 'd',"arr[3] === 'd'",24,'./for_test.js' );
      
      __LINE__ = 25;
      a/*Runtime*/.assert( true,f/*arr*/[4] === 'e',"arr[4] === 'e'",25,'./for_test.js' );
      
      __LINE__ = 26;
      a/*Runtime*/.assert( true,f/*arr*/[5] === 'f',"arr[5] === 'f'",26,'./for_test.js' );
      
      __LINE__ = 27;
      a/*Runtime*/.assert( true,f/*arr*/[6] === 'g',"arr[6] === 'g'",27,'./for_test.js' );
      
      __LINE__ = 28;
      a/*Runtime*/.assert( true,f/*arr*/[7] === 'h',"arr[7] === 'h'",28,'./for_test.js' );
      
      __LINE__ = 29;
      a/*Runtime*/.assert( true,f/*arr*/[8] === 'i',"arr[8] === 'i'",29,'./for_test.js' );
      
      __LINE__ = 30;
      a/*Runtime*/.assert( true,f/*arr*/[9] === 'j',"arr[9] === 'j'",30,'./for_test.js' );
      ...
      __LINE__ = 38;
      a/*Runtime*/.assert( true,f/*arr*/[0] === 'a',"arr[0] === 'a'",38,'./for_test.js' );
      
      __LINE__ = 39;
      a/*Runtime*/.assert( true,f/*arr*/[1] === 'b',"arr[1] === 'b'",39,'./for_test.js' );
      
      __LINE__ = 40;
      a/*Runtime*/.assert( true,f/*arr*/[2] === 'c',"arr[2] === 'c'",40,'./for_test.js' );
      
      __LINE__ = 41;
      a/*Runtime*/.assert( true,f/*arr*/[3] === 'd',"arr[3] === 'd'",41,'./for_test.js' );
      
      __LINE__ = 42;
      a/*Runtime*/.assert( true,f/*arr*/[4] === 'e',"arr[4] === 'e'",42,'./for_test.js' );
      
      __LINE__ = 43;
      a/*Runtime*/.assert( true,f/*arr*/[5] === 'f',"arr[5] === 'f'",43,'./for_test.js' );
      
      __LINE__ = 44;
      a/*Runtime*/.assert( true,f/*arr*/[6] === 'g',"arr[6] === 'g'",44,'./for_test.js' );
      
      __LINE__ = 45;
      a/*Runtime*/.assert( true,f/*arr*/[7] === 'h',"arr[7] === 'h'",45,'./for_test.js' );
      
      __LINE__ = 46;
      a/*Runtime*/.assert( true,f/*arr*/[8] === 'i',"arr[8] === 'i'",46,'./for_test.js' );
      
      __LINE__ = 47;
      a/*Runtime*/.assert( true,f/*arr*/[9] === 'j',"arr[9] === 'j'",47,'./for_test.js' );
      ...
      __LINE__ = 54;
      a/*Runtime*/.assert( true,f/*arr*/[0] === 'a',"arr[0] === 'a'",54,'./for_test.js' );
      
      __LINE__ = 55;
      a/*Runtime*/.assert( true,f/*arr*/[1] === 'b',"arr[1] === 'b'",55,'./for_test.js' );
      
      __LINE__ = 56;
      a/*Runtime*/.assert( true,f/*arr*/[2] === 'c',"arr[2] === 'c'",56,'./for_test.js' );
      
      __LINE__ = 57;
      a/*Runtime*/.assert( true,f/*arr*/[3] === 'd',"arr[3] === 'd'",57,'./for_test.js' );
      
      __LINE__ = 58;
      a/*Runtime*/.assert( true,f/*arr*/[4] === 'e',"arr[4] === 'e'",58,'./for_test.js' );
      
      __LINE__ = 59;
      a/*Runtime*/.assert( true,f/*arr*/[5] === 'f',"arr[5] === 'f'",59,'./for_test.js' );
      
      __LINE__ = 60;
      a/*Runtime*/.assert( true,f/*arr*/[6] === 'g',"arr[6] === 'g'",60,'./for_test.js' );
      
      __LINE__ = 61;
      a/*Runtime*/.assert( true,f/*arr*/[7] === 'h',"arr[7] === 'h'",61,'./for_test.js' );
      
      __LINE__ = 62;
      a/*Runtime*/.assert( true,f/*arr*/[8] === 'i',"arr[8] === 'i'",62,'./for_test.js' );
      
      __LINE__ = 63;
      a/*Runtime*/.assert( true,f/*arr*/[9] === 'j',"arr[9] === 'j'",63,'./for_test.js' );
    } catch( e ){
