  ...
  !function () {
    try {
      ...
      with ( e ){
        ...
        __LINE__ = 3;
        a.assert( true,prop === 200,"prop === 200",3,'./with_test.js' );
      };
      ...
      __LINE__ = 13;
      a.assert( true,f[0]() === 0,"ret[0]() === 0",13,'./with_test.js' );
      
      __LINE__ = 14;
      a.assert( true,f[1]() === 1,"ret[1]() === 1",14,'./with_test.js' );
      
      __LINE__ = 15;
      a.assert( true,f[2]() === 2,"ret[2]() === 2",15,'./with_test.js' );
      
      __LINE__ = 16;
      a.assert( true,f[3]() === 3,"ret[3]() === 3",16,'./with_test.js' );
      
      __LINE__ = 17;
      a.assert( true,f[4]() === 4,"ret[4]() === 4",17,'./with_test.js' );
      
      __LINE__ = 18;
      a.assert( true,f[5]() === 5,"ret[5]() === 5",18,'./with_test.js' );
      
      __LINE__ = 19;
      a.assert( true,f[6]() === 6,"ret[6]() === 6",19,'./with_test.js' );
      
      __LINE__ = 20;
      a.assert( true,f[7]() === 7,"ret[7]() === 7",20,'./with_test.js' );
      
      __LINE__ = 21;
      a.assert( true,f[8]() === 8,"ret[8]() === 8",21,'./with_test.js' );
      
      __LINE__ = 22;
      a.assert( true,f[9]() === 9,"ret[9]() === 9",22,'./with_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  }();
