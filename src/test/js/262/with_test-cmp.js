  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/262/with_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./with_test.js'] = {};
      
      __LINE__ = 3;
      var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./with_test.js'];
      ...
      with ( e/*testvalue*/ ){
        ...
        __LINE__ = 3;
        a/*Runtime*/.assert( true,prop === 200,"prop === 200",3,'./with_test.js' );
      };
      ...
      __LINE__ = 13;
      a/*Runtime*/.assert( true,f/*ret*/[0]() === 0,"ret[0]() === 0",13,'./with_test.js' );
      
      __LINE__ = 14;
      a/*Runtime*/.assert( true,f/*ret*/[1]() === 1,"ret[1]() === 1",14,'./with_test.js' );
      
      __LINE__ = 15;
      a/*Runtime*/.assert( true,f/*ret*/[2]() === 2,"ret[2]() === 2",15,'./with_test.js' );
      
      __LINE__ = 16;
      a/*Runtime*/.assert( true,f/*ret*/[3]() === 3,"ret[3]() === 3",16,'./with_test.js' );
      
      __LINE__ = 17;
      a/*Runtime*/.assert( true,f/*ret*/[4]() === 4,"ret[4]() === 4",17,'./with_test.js' );
      
      __LINE__ = 18;
      a/*Runtime*/.assert( true,f/*ret*/[5]() === 5,"ret[5]() === 5",18,'./with_test.js' );
      
      __LINE__ = 19;
      a/*Runtime*/.assert( true,f/*ret*/[6]() === 6,"ret[6]() === 6",19,'./with_test.js' );
      
      __LINE__ = 20;
      a/*Runtime*/.assert( true,f/*ret*/[7]() === 7,"ret[7]() === 7",20,'./with_test.js' );
      
      __LINE__ = 21;
      a/*Runtime*/.assert( true,f/*ret*/[8]() === 8,"ret[8]() === 8",21,'./with_test.js' );
      
      __LINE__ = 22;
      a/*Runtime*/.assert( true,f/*ret*/[9]() === 9,"ret[9]() === 9",22,'./with_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  })();
