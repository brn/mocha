(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/262/switch_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./switch_test.js'] = {};
      
      __LINE__ = 3;
      var c/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./switch_test.js'];
      
      function d/*switchTest*/( b/*type*/ ) {
        try {
          __LINE__ = 3;
          var c/*ret*/ = 0;
      ...
      __LINE__ = 35;
      a/*Runtime*/.assert( true,d/*switchTest*/( 1 ) === 1,"switchTest( 1 ) === 1",35,'./switch_test.js' );
      
      __LINE__ = 36;
      a/*Runtime*/.assert( true,d/*switchTest*/( 2 ) === 100,"switchTest( 2 ) === 100",36,'./switch_test.js' );
      
      __LINE__ = 37;
      a/*Runtime*/.assert( true,d/*switchTest*/( 3 ) === 1,"switchTest( 3 ) === 1",37,'./switch_test.js' );
      
      __LINE__ = 38;
      a/*Runtime*/.assert( true,d/*switchTest*/( 4 ) === 1,"switchTest( 4 ) === 1",38,'./switch_test.js' );
      
      __LINE__ = 39;
      a/*Runtime*/.assert( true,d/*switchTest*/( 5 ) === 1,"switchTest( 5 ) === 1",39,'./switch_test.js' );
      
      __LINE__ = 40;
      a/*Runtime*/.assert( true,d/*switchTest*/( 6 ) === 10,"switchTest( 6 ) === 10",40,'./switch_test.js' );
      
      __LINE__ = 41;
      a/*Runtime*/.assert( true,d/*switchTest*/( 7 ) === 10,"switchTest( 7 ) === 10",41,'./switch_test.js' );
      
      __LINE__ = 42;
      a/*Runtime*/.assert( true,d/*switchTest*/( 8 ) === 100,"switchTest( 8 ) === 100",42,'./switch_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  })();
