!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 35;
      a.assert( true,d( 1 ) === 1,"switchTest( 1 ) === 1",35,'./switch_test.js' );
      
      __LINE__ = 36;
      a.assert( true,d( 2 ) === 100,"switchTest( 2 ) === 100",36,'./switch_test.js' );
      
      __LINE__ = 37;
      a.assert( true,d( 3 ) === 1,"switchTest( 3 ) === 1",37,'./switch_test.js' );
      
      __LINE__ = 38;
      a.assert( true,d( 4 ) === 1,"switchTest( 4 ) === 1",38,'./switch_test.js' );
      
      __LINE__ = 39;
      a.assert( true,d( 5 ) === 1,"switchTest( 5 ) === 1",39,'./switch_test.js' );
      
      __LINE__ = 40;
      a.assert( true,d( 6 ) === 10,"switchTest( 6 ) === 10",40,'./switch_test.js' );
      
      __LINE__ = 41;
      a.assert( true,d( 7 ) === 10,"switchTest( 7 ) === 10",41,'./switch_test.js' );
      
      __LINE__ = 42;
      a.assert( true,d( 8 ) === 100,"switchTest( 8 ) === 100",42,'./switch_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  }();
