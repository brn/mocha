(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./json_parse.js'] = {};
    
    var E/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./json_parse.js'];
    
    var F/*json_parse*/ = ( function () {
          "use strict";
          ...
          var n/*at*/,
              ...
              s/*next*/ = function ( r/*c*/ ) {
                if ( r/*c*/ && r/*c*/ !== p/*ch*/ ){
                  q/*error*/( "Expected '"+r/*c*/+"' instead of '"+p/*ch*/+"'" );
                };
                
                p/*ch*/ = o/*text*/.charAt( n/*at*/ );
                  ...
                  while ( s/*next*/() ){
                    if ( p/*ch*/ === '"' ){
                      ...
                      if ( p/*ch*/ === 'u' ){
                        ...
                        for ( A/*i*/ = 0;A/*i*/<4;A/*i*/ += 1 ){
                          z/*hex*/ = parseInt( s/*next*/(),16 );
                          if ( !isFinite( z/*hex*/ ) ){
                            break;
                          };
                          
                          C/*uffff*/ = C/*uffff*/*16+z/*hex*/;
                        };
                        
                        B/*string*/ += String.fromCharCode( C/*uffff*/ );
                      } else if ( typeof y/*escapee*/[p/*ch*/] === 'string' ){
                        B/*string*/ += y/*escapee*/[p/*ch*/];
                      } else {
                        break;
                      };
                    } else {
              ...
              C/*object*/ = function () {
                ...
                if ( p/*ch*/ === '{' ){
                  ...
                  while ( p/*ch*/ ){
                    ...
                    if ( Object.hasOwnProperty.call( F/*object*/,E/*key*/ ) ){
                      q/*error*/( 'Duplicate key "'+E/*key*/+'"' );
                    };
                    
                    F/*object*/[E/*key*/] = F/*value*/();
          ...
          F/*value*/ = function () {
            ...
            switch ( p/*ch*/ ) {
              ...
              case '-' :
                return t/*number*/();
              default :
                return p/*ch*/ >= '0' && p/*ch*/ <= '9'?t/*number*/() : E/*word*/();
                
            };
          };
          return function ( e/*source*/,J/*reviver*/ ) {
            var f/*result*/;
            ...
            if ( p/*ch*/ ){
              q/*error*/( "Syntax error" );
            };
            return typeof J/*reviver*/ === 'function'?( function I/*walk*/( K/*holder*/,L/*key*/ ) {
              var M/*k*/,
                  N/*v*/,
                  O/*value*/ = K/*holder*/[L/*key*/];
              
              if ( O/*value*/ && typeof O/*value*/ === 'object' ){
                for ( M/*k*/ in O/*value*/ ){
                  if ( Object.prototype.hasOwnProperty.call( O/*value*/,M/*k*/ ) ){
                    N/*v*/ = I/*walk*/( O/*value*/,M/*k*/ );
              ...
              return J/*reviver*/.call( K/*holder*/,L/*key*/,O/*value*/ );
            }(  {
              '' : f/*result*/
            },'') ) : f/*result*/;
          };
