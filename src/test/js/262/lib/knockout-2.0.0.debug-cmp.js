    ...
    !function ( a,undefined ) {
      ...
      b.utils = new function () {
        var c = /^(\s|\u00A0)+|(\s|\u00A0)+$/g,
            g = {},
            e = {},
            h = /Firefox\/2/i.test( navigator.userAgent )?'KeyboardEvent' : 'UIEvents';
        ...
        function d( a,b ) {
          ...
          arrayGetDistinctValues : function ( a ) {
            ...
            for ( var d = 0,e = a.length;d<e;d ++  )
            b.utils.arrayIndexOf( c,a[d] )<0 && c.push( a[d] );
            return c;
          },
          ...
          evalWithinScope : function ( a ) {
            ...
            b[d] && typeof b[d] == "object" && ( c = "with(sc["+d+"]) { "+c+" } " );
            ...
            if ( typeof jQuery != "undefined" ){
              if ( d( c,e ) ){
                ...
                b = function ( b,c ) {
                  ...
                  c && ( this.checked = c.checkedStateBeforeEvent !== true );
          ...
          triggerEvent : function ( f,g ) {
            ...
            if ( typeof jQuery != "undefined" ){
              ...
              g == "click" && ( f.tagName == "INPUT" ) && ( ( f.type.toLowerCase() == "checkbox" ) || ( f.type.toLowerCase() == "radio" ) ) && ( f.checked = f.checked !== true );
          ...
          postJson : function ( c,d,e ) {
            ...
            var f = e['params'] || {},
                g = e['includeFields'] || this.fieldsIncludedWithJsonPost,
                h = c;
      ...
      b.utils.domNodeDisposal = new function () {
        ...
        function e( d ) {
          ...
          ( typeof jQuery == "function" ) && ( typeof jQuery['cleanData'] == "function" ) && jQuery['cleanData']( [d] );
        }return  {
      ...
      !function () {
        ...
        function d( c ) {
          var d = b.utils.stringTrim( c ).toLowerCase(),
              ...
              f = d.match( /^<(thead|tbody|tfoot)/ ) && [1,"<table>","</table>"] || !d.indexOf( "<tr" ) && [2,"<table><tbody>","</tbody></table>"] || ( !d.indexOf( "<td" ) || !d.indexOf( "<th" ) ) && [3,"<table><tbody><tr>","</tr></tbody></table>"] || [0,"",""],
              g = "ignored<div>"+f[1]+c+f[2]+"</div>";
          
          typeof a['innerShiv'] == "function"?e.appendChild( a['innerShiv']( g ) ) : e.innerHTML = g;
      ...
      b.subscribable['fn'] =  {
        subscribe : function ( e,f,a ) {
          ...
          var g = f?e.bind( f ) : e,
              d = new b.subscription( g,function () {
        ...
        "notifySubscribers" : function ( a,d ) {
          ...
          this._subscriptions[d] && b.utils.arrayForEach( this._subscriptions[d].slice( 0 ),
          function ( b ) {
            b && ( b.isDisposed !== true ) && b.callback( a );
          });
        },
        getSubscriptionsCount : function () {
          ...
          this._subscriptions.hasOwnProperty( b ) && ( a += this._subscriptions[b].length );
          return a;
        },
        extend : g
      };
      ...
      b.observableArray['fn'] =  {
        remove : function ( a ) {
          var b = this(),
              c = [],
              d = typeof a == "function"?a : function ( b ) {
                return b === a;
              };
          ...
          for ( var e = 0;e<b.length;e ++  ){
            ...
            if ( d( f ) ){
              c.length === 0 && this.valueWillMutate();
      ...
      b.dependentObservable = function ( p,l,j ) {
        var m,
            i = false,
            j = e( p,l,j ),
            c = ( typeof j["disposeWhenNodeIsRemoved"] == "object" )?j["disposeWhenNodeIsRemoved"] : null,
            o = null;
        ...
        a.dispose = function () {
          c && b.utils.domNodeDisposal.removeDisposeCallback( c,o );
        ...
        b.selectExtensions =  {
          readValue : function ( c ) {
            if ( c.tagName == 'OPTION' ){
              ...
              return c.tagName == 'SELECT'?c.selectedIndex >= 0?b.selectExtensions.readValue( c.options[c.selectedIndex] ) : undefined : c.value;
            };
          },
      ...
      b.jsonExpressionRewriting = function () {
        ...
        function f( a ) {
          ...
          parseObjectLiteral : function ( f ) {
            ...
            g.charAt( 0 ) === "{" && ( g = g.substring( 1,g.length-1 ) );
      ...
      !function () {
        ...
        function i( a,c ) {
          ...
          for ( var e = 0,f = a.length;e<f;e ++  ){
            c && b.utils.domNodeDisposal.cleanNode( a[e] );
        ...
        b.virtualElements =  {
          ...
          prepend : function ( a,b ) {
            !f( a )?a.firstChild?a.insertBefore( b,a.firstChild ) : a.appendChild( b ) : a.parentNode.insertBefore( b,a.nextSibling );
          },
          insertAfter : function ( a,b,c ) {
            !f( a )?c.nextSibling?a.insertBefore( b,c.nextSibling ) : a.appendChild( b ) : a.parentNode.insertBefore( b,c.nextSibling );
          },
            ...
            if ( m ){
              do if ( m.nodeType === 1 ){
                ...
                if ( n ){
                  ...
                  o?l.insertBefore( n[p],o ) : l.appendChild( n[p] );
                };
              };
      ...
      !function () {
        ...
        function c( f,g,h ) {
          ...
          j && b.virtualElements.normaliseVirtualElementDomStructure( g );
          
          var k = ( j && h ) || b.bindingProvider['instance']['nodeHasBindings']( g );
          
          k && ( i = d( g,null,f,h ).shouldBindDescendants );
        ...
        function d( e,g,c,d ) {
          ...
          new b.dependentObservable( function () {
            ...
            d && b.storedBindingContextForNode( e,l );
        ...
        b.applyBindingsToNode = function ( a,c,e ) {
          a.nodeType === 1 && b.virtualElements.normaliseVirtualElementDomStructure( a );
          return d( a,c,e,true );
        };
      ...
      b.bindingHandlers['event'] =  {
        'init' : function ( c,d,e,f ) {
          ...
          !function () {
            ...
            typeof g == "string" && b.utils.registerEventHandler( c,g,
            function ( h ) {
              var i,
                  j = d()[g];
              ...
              try {
                ...
                i !== true && h.preventDefault?h.preventDefault() : h.returnValue = false;
              };
        ...
        'init' : function ( d,a,e,c ) {
          ...
          function ( e ) {
            ...
            try {
              ...
              f !== true && e.preventDefault?e.preventDefault() : e.returnValue = false;
            };
          });
        }
      };
      ...
      b.bindingHandlers['visible'] =  {
        'update' : function ( a,c ) {
          ...
          d && !e?a.style.display = "" : ( !d ) && e && ( a.style.display = "none" );
        }
      };
      ...
      b.bindingHandlers['enable'] =  {
        'update' : function ( a,c ) {
          ...
          d && a.disabled?a.removeAttribute( "disabled" ) : ( !d ) && ( !a.disabled ) && ( a.disabled = true );
        }
      };
      ...
      function f( a,c,d ) {
        d && c !== b.selectExtensions.readValue( a ) && b.selectExtensions.writeValue( a,c );
        
        c !== b.selectExtensions.readValue( a ) && b.utils.triggerEvent( a,"change" );
      }
      b.bindingHandlers['value'] =  {
        'init' : function ( a,c,d ) {
          ...
          function ( f ) {
            ...
            function () {
              e( function () {
                var e = c(),
                    f = b.selectExtensions.readValue( a );
                ...
                if ( b.isWriteableObservable( e ) ){
                  ...
                  g['_ko_property_writers'] && g['_ko_property_writers']['value'] && g['_ko_property_writers']['value']( f );
                };
              });
            });
          });
        ...
        'update' : function ( a,g ) {
          var c = b.utils.unwrapObservable( g() ),
              h = b.selectExtensions.readValue( a ),
              i = ( c != h );
          ...
          ( a.tagName == "SELECT" ) && ( a.length>0 ) && f( a,c,false );
        }
      };
      ...
      b.bindingHandlers['options'] =  {
        'update' : function ( a,c,d ) {
          ...
          var e = a.length == 0,
              g = b.utils.arrayMap( b.utils.arrayFilter( a.childNodes,
              function ( a ) {
          ...
          if ( i ){
            ...
            for ( var m = 0,n = i.length;m<n;m ++  ){
              ...
              typeof p == "function"?q = p( i[m] ) : typeof p == "string"?q = i[m][p] : q = o;
              
              ( ( q === null ) || ( q === undefined ) ) && ( q = "" );
            ...
            e && ( 'value' in k ) && f( a,b.utils.unwrapObservable( k['value'] ),true );
          };
        }
      };
      ...
      b.bindingHandlers['selectedOptions'] =  {
        getSelectedValuesFromSelectNode : function ( a ) {
          ...
          for ( var e = 0,f = d.length;e<f;e ++  ){
            ...
            ( g.tagName == "OPTION" ) && g.selected && c.push( b.selectExtensions.readValue( g ) );
          };
          return c;
        },
        'init' : function ( d,a,c ) {
          ...
          function () {
            ...
            if ( b.isWriteableObservable( d ) ){
              ...
              e['_ko_property_writers'] && e['_ko_property_writers']['value'] && e['_ko_property_writers']['value']( b.bindingHandlers['selectedOptions'].getSelectedValuesFromSelectNode( this ) );
            };
          });
        },
        'update' : function ( a,c ) {
          ...
          if ( d && typeof d.length == "number" ){
            ...
            for ( var f = 0,g = e.length;f<g;f ++  ){
              ...
              h.tagName == "OPTION" && b.utils.setOptionNodeSelectionState( h,b.utils.arrayIndexOf( d,b.selectExtensions.readValue( h ) ) >= 0 );
            };
          };
        }
      };
      ...
      b.bindingHandlers['uniqueName'] =  {
        'init' : function ( a,c ) {
          if ( c() ){
            ...
            ( b.utils.isIe6 || b.utils.isIe7 ) && a.mergeAttributes( document.createElement( "<input name='"+a.name+"'/>" ),false );
          };
        }
      };
      ...
      b.bindingHandlers['checked'] =  {
        'init' : function ( a,c,d ) {
          var e = function () {
                ...
                if ( ( a.type == "checkbox" ) && ( b.utils.unwrapObservable( f ) instanceof Array ) ){
                  ...
                  a.checked && ( g<0 )?f.push( a.value ) : ( !a.checked ) && ( g >= 0 ) && f.splice( g,1 );
                } else if ( b.isWriteableObservable( f ) ){
                  f() !== e && f( e );
                } else {
                  var h = d();
                  
                  h['_ko_property_writers'] && h['_ko_property_writers']['checked'] && h['_ko_property_writers']['checked']( e );
                };
              };
          
          b.utils.registerEventHandler( a,"click",e );
          
          ( a.type == "radio" ) && !a.name && b.bindingHandlers['uniqueName']['init']( a,
          function () {
            return true;
          });
        },
        'update' : function ( a,c ) {
          ...
          a.type == "checkbox"?d instanceof Array?a.checked = b.utils.arrayIndexOf( d,a.value ) >= 0 : a.checked = d : a.type == "radio" && ( a.checked = ( a.value == d ) );
        }
      };
      ...
      b.bindingHandlers['attr'] =  {
        'update' : function ( a,c,d ) {
          ...
          if ( typeof f == "string" ){
            ...
            ( g === false ) || ( g === null ) || ( g === undefined )?a.removeAttribute( f ) : a.setAttribute( f,g.toString() );
          };
        }
      };
        ...
        'init' : function ( e,a,c ) {
          var d = function ( d ) {
                ...
                if ( b.isWriteableObservable( e ) ){
                  ...
                  f['_ko_property_writers'] && f['_ko_property_writers']['hasfocus'] && f['_ko_property_writers']['hasfocus']( d );
                };
              };
      ...
      b.templateRewriting = function () {
        ...
        function e( c,d,e ) {
          ...
          var g = b.jsonExpressionRewriting.insertPropertyAccessorsIntoJson( f ),
              h = "ko.templateRewriting.applyMemoizedBindingsToNextSibling(function() { \
            return (function() { return { "+g+" } })() \
        })";
          return e['createJavaScriptEvaluatorBlock']( h )+d;
        }return  {
          ensureTemplateIsRewritten : function ( c,a ) {
            !a['isTemplateRewritten']( c ) && a['rewriteTemplate']( c,
            function ( c ) {
          ...
          applyMemoizedBindingsToNextSibling : function ( a ) {
            return b.memoization.memoize( function ( c,d ) {
              c.nextSibling && b.applyBindingsToNode( c.nextSibling,a,d );
            });
          }
        };
      }();
      ...
      !function () {
        ...
        function e( c,d,e,f,g ) {
          ...
          if ( j ){
            ...
            g['afterRender'] && g['afterRender']( i,f['$data'] );
          };
          return i;
        }
          ...
          if ( h ){
            ...
            return new b.dependentObservable( function () {
              var k = ( f && ( f instanceof b.bindingContext ) )?f : new b.bindingContext( b.utils.unwrapObservable( f ) ),
                  l = typeof ( g ) == 'function'?g( k['$data'] ) : g,
                  m = e( h,i,l,k,j );
        ...
        b.renderTemplateForEach = function ( i,f,d,g,a ) {
          var c = function ( c ) {
              ...
              h = function ( e,f ) {
                ...
                d['afterRender'] && d['afterRender']( f,g['$data'] );
              };
          return new b.dependentObservable( function () {
            var j = b.utils.unwrapObservable( f ) || [];
            
            typeof j.length == "undefined" && ( j = [j] );
        ...
        function g( g,h ) {
          ...
          i && ( typeof ( i.dispose ) == 'function' ) && i.dispose();
        ...
        b.bindingHandlers['template'] =  {
          ...
          'update' : function ( h,i,j,k,l ) {
            ...
            if ( typeof m == "string" ){
              ...
              'if' in m && ( o = o && b.utils.unwrapObservable( m['if'] ) );
              
              'ifnot' in m && ( o = o && !b.utils.unwrapObservable( m['ifnot'] ) );
            };
      ...
      !function () {
        ...
        function c( a,b,c ) {
          ...
          while ( ( d>0 ) || ( e>0 ) ){
            ...
            ( ( i === undefined ) || ( i<h-1 ) ) && ( i = g+1 );
            
            ( ( j === undefined ) || ( j<h-1 ) ) && ( j = g+1 );
      ...
      !function () {
        function a( a ) {
          if ( a.length>2 ){
            ...
            [].splice.apply( a,[0,a.length].concat( d ) );
          };
        }
        function d( g,c,d,f ) {
          var e = [],
        ...
        b.utils.setDomNodeChildrenFromArrayMapping = function ( i,j,k,l,m ) {
          ...
          var n = b.utils.domData.get( i,c ) === undefined,
              o = b.utils.domData.get( i,c ) || [],
              p = b.utils.arrayMap( o,
              function ( a ) {
                return a.arrayEntry;
              }),
              g = b.utils.compareArrays( p,j ),
              q = [],
              r = 0,
              e = [],
              s = [],
          ...
          switch ( g[f].status ) {
            case "retained" :
              ...
              u.domNodes.length>0 && ( h = u.domNodes[u.domNodes.length-1] );
            ...
            case "added" :
              ...
              for ( var y = 0,z = x.length;y<z;y ++  ){
                ...
                h == null?b.virtualElements.prepend( i,A ) : b.virtualElements.insertAfter( i,A,h );
