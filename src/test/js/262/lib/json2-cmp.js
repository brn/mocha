(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./json2.js'] = {};
    
    var F/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./json2.js'];
    ...
    ( function () {
      ...
      if ( typeof Date.prototype.toJSON !== 'function' ){
        Date.prototype.toJSON = function ( k/*key*/ ) {
          return isFinite( this.valueOf() )?this.getUTCFullYear()+'-'+j/*f*/( this.getUTCMonth()+1 )+'-'+j/*f*/( this.getUTCDate() )+'T'+j/*f*/( this.getUTCHours() )+':'+j/*f*/( this.getUTCMinutes() )+':'+j/*f*/( this.getUTCSeconds() )+'Z' : null;
        };
      ...
      var B/*cx*/ = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
          k/*escapable*/ = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
          n/*gap*/,
          t/*indent*/,
          m/*meta*/ =  {
            '\b' : '\\b',
      ...
      function s/*quote*/( n/*string*/ ) {
        k/*escapable*/.lastIndex = 0;
        return k/*escapable*/.test( n/*string*/ )?'"'+n/*string*/.replace( k/*escapable*/,
        function ( c/*a*/ ) {
          var d/*c*/ = m/*meta*/[c/*a*/];
          return typeof d/*c*/ === 'string'?d/*c*/ : '\\u'+( '0000'+c/*a*/.charCodeAt( 0 ).toString( 16 ) ).slice( -4 );
        })+'"' : '"'+n/*string*/+'"';
      }
      function x/*str*/( B/*key*/,C/*holder*/ ) {
        var D/*i*/,
            E/*k*/,
            F/*v*/,
            G/*length*/,
            H/*mind*/ = n/*gap*/,
            I/*partial*/,
            J/*value*/ = C/*holder*/[B/*key*/];
        
        if ( J/*value*/ && typeof J/*value*/ === 'object' && typeof J/*value*/.toJSON === 'function' ){
          J/*value*/ = J/*value*/.toJSON( B/*key*/ );
        };
        
        if ( typeof r/*rep*/ === 'function' ){
          J/*value*/ = r/*rep*/.call( C/*holder*/,B/*key*/,J/*value*/ );
        };
        
        switch ( typeof J/*value*/ ) {
          case 'string' :
            return s/*quote*/( J/*value*/ );
          case 'number' :
            return isFinite( J/*value*/ )?String( J/*value*/ ) : 'null';
          case 'boolean' :
          case 'null' :
          ...
          case 'object' :
            ...
            if ( Object.prototype.toString.apply( J/*value*/ ) === '[object Array]' ){
              G/*length*/ = J/*value*/.length;
              
              for ( D/*i*/ = 0;D/*i*/<G/*length*/;D/*i*/ += 1 ){
                I/*partial*/[D/*i*/] = x/*str*/( D/*i*/,J/*value*/ ) || 'null';
              };
              
              F/*v*/ = I/*partial*/.length === 0?'[]' : n/*gap*/?'[\n'+n/*gap*/+I/*partial*/.join( ',\n'+n/*gap*/ )+'\n'+H/*mind*/+']' : '['+I/*partial*/.join( ',' )+']';
            ...
            if ( r/*rep*/ && typeof r/*rep*/ === 'object' ){
              G/*length*/ = r/*rep*/.length;
              
              for ( D/*i*/ = 0;D/*i*/<G/*length*/;D/*i*/ += 1 ){
                if ( typeof r/*rep*/[D/*i*/] === 'string' ){
                  E/*k*/ = r/*rep*/[D/*i*/];
                  
                  F/*v*/ = x/*str*/( E/*k*/,J/*value*/ );
                  
                  if ( F/*v*/ ){
                    I/*partial*/.push( s/*quote*/( E/*k*/ )+( n/*gap*/?': ' : ':' )+F/*v*/ );
                  };
                };
              };
            } else {
              for ( E/*k*/ in J/*value*/ ){
                if ( Object.prototype.hasOwnProperty.call( J/*value*/,E/*k*/ ) ){
                  F/*v*/ = x/*str*/( E/*k*/,J/*value*/ );
                  if ( F/*v*/ ){
                    I/*partial*/.push( s/*quote*/( E/*k*/ )+( n/*gap*/?': ' : ':' )+F/*v*/ );
                  };
      ...
      if ( typeof JSON.stringify !== 'function' ){
        JSON.stringify = function ( e/*value*/,f/*replacer*/,g/*space*/ ) {
          var h/*i*/;
          ...
          if ( typeof g/*space*/ === 'number' ){
            for ( h/*i*/ = 0;h/*i*/<g/*space*/;h/*i*/ += 1 ){
              t/*indent*/ += ' ';
            };
          } else if ( typeof g/*space*/ === 'string' ){
            t/*indent*/ = g/*space*/;
          };
          
          r/*rep*/ = f/*replacer*/;
          
          if ( f/*replacer*/ && typeof f/*replacer*/ !== 'function' && ( typeof f/*replacer*/ !== 'object' || typeof f/*replacer*/.length !== 'number' ) ){
      ...
      if ( typeof JSON.parse !== 'function' ){
        JSON.parse = function ( F/*text*/,g/*reviver*/ ) {
          var G/*j*/;
          
          function f/*walk*/( h/*holder*/,i/*key*/ ) {
            var j/*k*/,
                k/*v*/,
                l/*value*/ = h/*holder*/[i/*key*/];
            
            if ( l/*value*/ && typeof l/*value*/ === 'object' ){
              for ( j/*k*/ in l/*value*/ ){
                if ( Object.prototype.hasOwnProperty.call( l/*value*/,j/*k*/ ) ){
                  k/*v*/ = f/*walk*/( l/*value*/,j/*k*/ );
            ...
            return g/*reviver*/.call( h/*holder*/,i/*key*/,l/*value*/ );
          }
          ...
          if ( B/*cx*/.test( F/*text*/ ) ){
            F/*text*/ = F/*text*/.replace( B/*cx*/,
            function ( b/*a*/ ) {
              return '\\u'+( '0000'+b/*a*/.charCodeAt( 0 ).toString( 16 ) ).slice( -4 );
            });
          };
          
          if ( /^[\],:{}\s]*$/.test( F/*text*/.replace( /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,'@' ).replace( /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,']' ).replace( /(?:^|:|,)(?:\s*\[)+/g,'' ) ) ){
            G/*j*/ = eval( '('+F/*text*/+')' );
            return typeof g/*reviver*/ === 'function'?f/*walk*/(  {
              '' : G/*j*/
            },'') : G/*j*/;
          };
