(function() {
  ...
  ( function () {
    p/*_mochaGlobalExport*/['./json2.js'] = {};
    
    var j/*_mochaGlobalAlias*/ = p/*_mochaGlobalExport*/['./json2.js'];
    ...
    ( function () {
      ...
      var k/*cx*/ = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
          l/*escapable*/ = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
          m/*gap*/,
          n/*indent*/,
          o/*meta*/ =  {
            '\b' : '\\b',
      ...
      function q/*quote*/( a/*string*/ ) {
        l/*escapable*/.lastIndex = 0;
        return l/*escapable*/.test( a/*string*/ )?'"'+a/*string*/.replace( l/*escapable*/,
        function ( b/*a*/ ) {
          var d/*c*/ = o/*meta*/[b/*a*/];
          return typeof d/*c*/ === 'string'?d/*c*/ : '\\u'+( '0000'+b/*a*/.charCodeAt( 0 ).toString( 16 ) ).slice( -4 );
        })+'"' : '"'+a/*string*/+'"';
      }
      function r/*str*/( d/*key*/,e/*holder*/ ) {
        var f/*i*/,
            g/*k*/,
            h/*v*/,
            j/*length*/,
            l/*mind*/ = m/*gap*/,
            m/*partial*/,
            n/*value*/ = e/*holder*/[d/*key*/];
        
        if ( n/*value*/ && typeof n/*value*/ === 'object' && typeof n/*value*/.toJSON === 'function' ){
          n/*value*/ = n/*value*/.toJSON( d/*key*/ );
        };
        
        if ( typeof p/*rep*/ === 'function' ){
          n/*value*/ = p/*rep*/.call( e/*holder*/,d/*key*/,n/*value*/ );
        };
        
        switch ( typeof n/*value*/ ) {
          case 'string' :
            return q/*quote*/( n/*value*/ );
          case 'number' :
          ...
          case 'object' :
            ...
            if ( Object.prototype.toString.apply( n/*value*/ ) === '[object Array]' ){
              j/*length*/ = n/*value*/.length;
              
              for ( f/*i*/ = 0;f/*i*/<j/*length*/;f/*i*/ += 1 ){
                m/*partial*/[f/*i*/] = r/*str*/( f/*i*/,n/*value*/ ) || 'null';
              };
              
              h/*v*/ = m/*partial*/.length === 0?'[]' : m/*gap*/?'[\n'+m/*gap*/+m/*partial*/.join( ',\n'+m/*gap*/ )+'\n'+l/*mind*/+']' : '['+m/*partial*/.join( ',' )+']';
              
              m/*gap*/ = l/*mind*/;
              return h/*v*/;
            };
            
            if ( p/*rep*/ && typeof p/*rep*/ === 'object' ){
              j/*length*/ = p/*rep*/.length;
              
              for ( f/*i*/ = 0;f/*i*/<j/*length*/;f/*i*/ += 1 ){
                if ( typeof p/*rep*/[f/*i*/] === 'string' ){
                  g/*k*/ = p/*rep*/[f/*i*/];
                  
                  h/*v*/ = r/*str*/( g/*k*/,n/*value*/ );
                  
                  if ( h/*v*/ ){
                    m/*partial*/.push( q/*quote*/( g/*k*/ )+( m/*gap*/?': ' : ':' )+h/*v*/ );
                  };
                };
              };
            } else {
              for ( g/*k*/ in n/*value*/ ){
                if ( Object.prototype.hasOwnProperty.call( n/*value*/,g/*k*/ ) ){
                  h/*v*/ = r/*str*/( g/*k*/,n/*value*/ );
                  if ( h/*v*/ ){
                    m/*partial*/.push( q/*quote*/( g/*k*/ )+( m/*gap*/?': ' : ':' )+h/*v*/ );
                  };
      ...
      if ( typeof k/*JSON*/.stringify !== 'function' ){
        k/*JSON*/.stringify = function ( b/*value*/,c/*replacer*/,d/*space*/ ) {
          var e/*i*/;
          ...
          if ( typeof d/*space*/ === 'number' ){
            for ( e/*i*/ = 0;e/*i*/<d/*space*/;e/*i*/ += 1 ){
              n/*indent*/ += ' ';
            };
          } else if ( typeof d/*space*/ === 'string' ){
            n/*indent*/ = d/*space*/;
          };
      ...
      if ( typeof k/*JSON*/.parse !== 'function' ){
        k/*JSON*/.parse = function ( f/*text*/,g/*reviver*/ ) {
          var h/*j*/;
          
          function i/*walk*/( c/*holder*/,d/*key*/ ) {
            var e/*k*/,
                f/*v*/,
                g/*value*/ = c/*holder*/[d/*key*/];
            
            if ( g/*value*/ && typeof g/*value*/ === 'object' ){
              for ( e/*k*/ in g/*value*/ ){
                if ( Object.prototype.hasOwnProperty.call( g/*value*/,e/*k*/ ) ){
                  f/*v*/ = i/*walk*/( g/*value*/,e/*k*/ );
            ...
            return g/*reviver*/.call( c/*holder*/,d/*key*/,g/*value*/ );
          }
          ...
          if ( /^[\],:{}\s]*$/.test( f/*text*/.replace( /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,'@' ).replace( /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,']' ).replace( /(?:^|:|,)(?:\s*\[)+/g,'' ) ) ){
            h/*j*/ = eval( '('+f/*text*/+')' );
            return typeof g/*reviver*/ === 'function'?i/*walk*/(  {
              '' : h/*j*/
            },'') : h/*j*/;
          };
