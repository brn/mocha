(function() {
  ...
  ( function () {
    p/*_mochaGlobalExport*/['./json2_compiled.js'] = {};
    
    var a/*_mochaGlobalAlias*/ = p/*_mochaGlobalExport*/['./json2_compiled.js'];
    
    var b/*g*/ = null;
    
    var h/*json_parse*/ = function () {
          function h/*o*/() {
            switch ( a ) {
              case "t" :
          ...
          function k/*l*/() {
            ...
            if ( a/*a*/ === '"' )for ( ;a/*b*/( b/*g*/ ); ){
              if ( a/*a*/ === '"' )return a/*b*/( b/*g*/ ) , j/*d*/;
               else if ( a/*a*/ === "\\" )if ( a/*b*/( b/*g*/ ) , a/*a*/ === "u" ){
                for ( i/*f*/ = k/*e*/ = 0;i/*f*/<4;i/*f*/ += 1 ){
                  h/*c*/ = parseInt( a/*b*/( b/*g*/ ),16 );
                  if ( !isFinite( h/*c*/ ) )break;
                  
                  k/*e*/ = k/*e*/*16+h/*c*/;
                };
                
                j/*d*/ += String.fromCharCode( k/*e*/ );
              } else if ( typeof n/*m*/[a/*a*/] === "string" )j/*d*/ += n/*m*/[a/*a*/];
               else break;
               else j/*d*/ += a/*a*/;
            };
          ...
          function l/*n*/() {
            ...
            if ( a/*a*/ === "." )for ( e/*c*/ += ".";a/*b*/( b/*g*/ ) && a/*a*/ >= "0" && a/*a*/ <= "9"; ){
              e/*c*/ += a/*a*/;
            };
          ...
          function a/*b*/( c/*b*/ ) {
            c/*b*/ && c/*b*/ !== a/*a*/ && d/*h*/( "Expected '"+c/*b*/+"' instead of '"+a/*a*/+"'" );
          ...
          p/*j*/ = function () {
            ...
            switch ( a/*a*/ ) {
                ...
                a : 
                {
                  ...
                  if ( a/*a*/ === "{" ){
                    ...
                    for ( ;a/*a*/; ){
                      ...
                      Object.hasOwnProperty.call( i/*d*/,h/*f*/ ) && d/*h*/( 'Duplicate key "'+h/*f*/+'"' );
              ...
              case "-" :
                return l/*n*/();
              default :
                return a/*a*/ >= "0" && a/*a*/ <= "9"?l/*n*/() : h/*o*/();
                
            };
          };
          return function ( g/*b*/,h/*f*/ ) {
            var l/*d*/;
            ...
            return typeof h/*f*/ === "function"?function m/*p*/( g/*a*/,h/*b*/ ) {
              var i/*c*/,
                  j/*e*/,
                  k/*d*/ = g/*a*/[h/*b*/];
              
              if ( k/*d*/ && typeof k/*d*/ === "object" )for ( i/*c*/ in k/*d*/ ){
                Object.prototype.hasOwnProperty.call( k/*d*/,i/*c*/ ) && ( j/*e*/ = m/*p*/( k/*d*/,i/*c*/ ) , j/*e*/ !== void 0?k/*d*/[i/*c*/] = j/*e*/ : delete k/*d*/[i/*c*/] );
              };
              return h/*f*/.call( g/*a*/,h/*b*/,k/*d*/ );
            }(  {
              "" : l/*d*/
            },"") : l/*d*/;
          };
    ...
    ( function () {
      var a/*json_str*/ = '{"test" : 1,"test2":"test2","test3":null,"test4":{"test5":5}}';
      
      var b/*json*/ = h/*json_parse*/( a/*json_str*/ );
    })();
  })();
})();
