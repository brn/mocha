    ...
    try {
          ...
          d = function () {
            try {
              ...
              function d( i ) {
                try {
                  __LINE__ = 0;
                  i && i !== b && e( "Expected '"+i+"' instead of '"+b+"'" );
                      ...
                      a : 
                      {
                        ...
                        if ( b === "{" ){
                          ...
                          for ( ;b; ){
                            ...
                            __LINE__ = 0;
                            Object.hasOwnProperty.call( p,o ) && e( 'Duplicate key "'+o+'"' );
              ...
              return function ( f,d ) {
                try {
                  ...
                  b && e( "Syntax error" );
                  __LINE__ = 1;
                  return typeof d === "function"?function c( e,f ) {
                    try {
                      __LINE__ = 1;
                      var g,
                          h,
                      ...
                      if ( i && typeof i === "object" ){
                        ...
                        for ( g in i ){
                          __LINE__ = 0;
                          ( {} ).hasOwnProperty.call( i,g ) && ( h = c( i,g ) , h !== void 0?i[g] = h : delete i[g] );
                        };
                      };
                      __LINE__ = 1;
                      return d.call( e,f,i );
      ...
      !function () {
        try {
          ...
          __LINE__ = 6;
          a.assert( true,f["test"] === 1,"json[\"test\"] === 1",6,'./json2_compiled.js' );
          
          __LINE__ = 7;
          a.assert( true,f["test2"] === "test2","json[\"test2\"] === \"test2\"",7,'./json2_compiled.js' );
          
          __LINE__ = 8;
          a.assert( true,f["test3"] === null,"json[\"test3\"] === null",8,'./json2_compiled.js' );
          
          __LINE__ = 9;
          a.assert( true,f["test4"]["test5"] === 5,"json[\"test4\"][\"test5\"] === 5",9,'./json2_compiled.js' );
        } catch( e ){
          a.exceptionHandler( __LINE__ , __FILE__ , e );
        }
      }();
