!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 7;
      a.assert( true,f[0] === 'a',"ret[0] === 'a'",7,'./while_test.js' );
      
      __LINE__ = 8;
      a.assert( true,f[1] === 'b',"ret[1] === 'b'",8,'./while_test.js' );
      
      __LINE__ = 9;
      a.assert( true,f[2] === 'c',"ret[2] === 'c'",9,'./while_test.js' );
      
      __LINE__ = 10;
      a.assert( true,f[3] === 'd',"ret[3] === 'd'",10,'./while_test.js' );
      
      __LINE__ = 11;
      a.assert( true,f[4] === 'e',"ret[4] === 'e'",11,'./while_test.js' );
      
      __LINE__ = 12;
      a.assert( true,f[5] === 'f',"ret[5] === 'f'",12,'./while_test.js' );
      
      __LINE__ = 13;
      a.assert( true,f[6] === 'g',"ret[6] === 'g'",13,'./while_test.js' );
      
      __LINE__ = 14;
      a.assert( true,f[7] === 'h',"ret[7] === 'h'",14,'./while_test.js' );
      
      __LINE__ = 15;
      a.assert( true,f[8] === 'i',"ret[8] === 'i'",15,'./while_test.js' );
      
      __LINE__ = 16;
      a.assert( true,f[9] === 'j',"ret[9] === 'j'",16,'./while_test.js' );
      ...
      __LINE__ = 23;
      a.assert( true,f[0] === 'a',"ret[0] === 'a'",23,'./while_test.js' );
      
      __LINE__ = 24;
      a.assert( true,f[1] === 'b',"ret[1] === 'b'",24,'./while_test.js' );
      
      __LINE__ = 25;
      a.assert( true,f[2] === 'c',"ret[2] === 'c'",25,'./while_test.js' );
      
      __LINE__ = 26;
      a.assert( true,f[3] === 'd',"ret[3] === 'd'",26,'./while_test.js' );
      
      __LINE__ = 27;
      a.assert( true,f[4] === 'e',"ret[4] === 'e'",27,'./while_test.js' );
      
      __LINE__ = 28;
      a.assert( true,f[5] === 'f',"ret[5] === 'f'",28,'./while_test.js' );
      
      __LINE__ = 29;
      a.assert( true,f[6] === 'g',"ret[6] === 'g'",29,'./while_test.js' );
      
      __LINE__ = 30;
      a.assert( true,f[7] === 'h',"ret[7] === 'h'",30,'./while_test.js' );
      
      __LINE__ = 31;
      a.assert( true,f[8] === 'i',"ret[8] === 'i'",31,'./while_test.js' );
      
      __LINE__ = 32;
      a.assert( true,f[9] === 'j',"ret[9] === 'j'",32,'./while_test.js' );
    } catch( e ){
