(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./while_test.js'] = {};
    
    var H/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./while_test.js'];
    
    var I/*testvalue*/ = 0;
    
    var J/*table*/ = ['a','b','c','d','e','f','g','h','i','j'];
    
    var K/*ret*/ = [];
    
    while ( I/*testvalue*/<10 ){
      K/*ret*/.push( J/*table*/[I/*testvalue*/ ++ ] );
    };
