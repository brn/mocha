(function() {
  ...
  ( function () {
    p/*_mochaGlobalExport*/['./while_test.js'] = {};
    
    var a/*_mochaGlobalAlias*/ = p/*_mochaGlobalExport*/['./while_test.js'];
    
    var b/*testvalue*/ = 0;
    
    var c/*table*/ = ['a','b','c','d','e','f','g','h','i','j'];
    
    var d/*ret*/ = [];
    
    while ( b/*testvalue*/<10 ){
      d/*ret*/.push( c/*table*/[b/*testvalue*/ ++ ] );
    };
