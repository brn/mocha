  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/262/while_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./while_test.js'] = {};
      
      __LINE__ = 3;
      var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./while_test.js'];
      ...
      __LINE__ = 4;
      while ( e/*testvalue*/<10 ){
        __LINE__ = 0;
        g/*ret*/.push( f/*table*/[e/*testvalue*/ ++ ] );
      };
      
      __LINE__ = 7;
      a/*Runtime*/.assert( true,g/*ret*/[0] === 'a',"ret[0] === 'a'",7,'./while_test.js' );
      
      __LINE__ = 8;
      a/*Runtime*/.assert( true,g/*ret*/[1] === 'b',"ret[1] === 'b'",8,'./while_test.js' );
      
      __LINE__ = 9;
      a/*Runtime*/.assert( true,g/*ret*/[2] === 'c',"ret[2] === 'c'",9,'./while_test.js' );
      
      __LINE__ = 10;
      a/*Runtime*/.assert( true,g/*ret*/[3] === 'd',"ret[3] === 'd'",10,'./while_test.js' );
      
      __LINE__ = 11;
      a/*Runtime*/.assert( true,g/*ret*/[4] === 'e',"ret[4] === 'e'",11,'./while_test.js' );
      
      __LINE__ = 12;
      a/*Runtime*/.assert( true,g/*ret*/[5] === 'f',"ret[5] === 'f'",12,'./while_test.js' );
      
      __LINE__ = 13;
      a/*Runtime*/.assert( true,g/*ret*/[6] === 'g',"ret[6] === 'g'",13,'./while_test.js' );
      
      __LINE__ = 14;
      a/*Runtime*/.assert( true,g/*ret*/[7] === 'h',"ret[7] === 'h'",14,'./while_test.js' );
      
      __LINE__ = 15;
      a/*Runtime*/.assert( true,g/*ret*/[8] === 'i',"ret[8] === 'i'",15,'./while_test.js' );
      
      __LINE__ = 16;
      a/*Runtime*/.assert( true,g/*ret*/[9] === 'j',"ret[9] === 'j'",16,'./while_test.js' );
      ...
      __LINE__ = 23;
      a/*Runtime*/.assert( true,g/*ret*/[0] === 'a',"ret[0] === 'a'",23,'./while_test.js' );
      
      __LINE__ = 24;
      a/*Runtime*/.assert( true,g/*ret*/[1] === 'b',"ret[1] === 'b'",24,'./while_test.js' );
      
      __LINE__ = 25;
      a/*Runtime*/.assert( true,g/*ret*/[2] === 'c',"ret[2] === 'c'",25,'./while_test.js' );
      
      __LINE__ = 26;
      a/*Runtime*/.assert( true,g/*ret*/[3] === 'd',"ret[3] === 'd'",26,'./while_test.js' );
      
      __LINE__ = 27;
      a/*Runtime*/.assert( true,g/*ret*/[4] === 'e',"ret[4] === 'e'",27,'./while_test.js' );
      
      __LINE__ = 28;
      a/*Runtime*/.assert( true,g/*ret*/[5] === 'f',"ret[5] === 'f'",28,'./while_test.js' );
      
      __LINE__ = 29;
      a/*Runtime*/.assert( true,g/*ret*/[6] === 'g',"ret[6] === 'g'",29,'./while_test.js' );
      
      __LINE__ = 30;
      a/*Runtime*/.assert( true,g/*ret*/[7] === 'h',"ret[7] === 'h'",30,'./while_test.js' );
      
      __LINE__ = 31;
      a/*Runtime*/.assert( true,g/*ret*/[8] === 'i',"ret[8] === 'i'",31,'./while_test.js' );
      
      __LINE__ = 32;
      a/*Runtime*/.assert( true,g/*ret*/[9] === 'j',"ret[9] === 'j'",32,'./while_test.js' );
    } catch( e ){
