(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/262/if_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./if_test.js'] = {};
      
      __LINE__ = 3;
      var c/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./if_test.js'];
      
      function d/*ifTest*/( b/*flg*/ ) {
        try {
          __LINE__ = 2;
          if ( b/*flg*/ === 1 ){
            __LINE__ = 3;
      ...
      __LINE__ = 11;
      a/*Runtime*/.assert( true,d/*ifTest*/( 1 ) === 1,"ifTest( 1 ) === 1",11,'./if_test.js' );
      
      __LINE__ = 12;
      a/*Runtime*/.assert( true,d/*ifTest*/( 2 ) === 2,"ifTest( 2 ) === 2",12,'./if_test.js' );
      
      __LINE__ = 13;
      a/*Runtime*/.assert( true,d/*ifTest*/( 3 ) === 3,"ifTest( 3 ) === 3",13,'./if_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  })();
