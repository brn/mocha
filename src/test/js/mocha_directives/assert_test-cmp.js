(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/Users/aono_taketoshi/github/mocha/src/test/js/mocha_directives/assert_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport['./assert_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias = _mochaGlobalExport['./assert_test.js'];
      ...
      __LINE__ = 3;
      Runtime.assert( true,test.x === true,"test.x === true",3,'./assert_test.js' );
      
      __LINE__ = 4;
      Runtime.assert( true,test.x === false,"test.x === false",4,'./assert_test.js' );
    } catch( e ){
