!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-1426553882-json2.js'] = {};
    
    var c/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-1426553882-json2.js'],
        JSON;
    ...
    (function () {
      ...
      function d/*str*/(q/*key*/,p/*holder*/) {
        var o/*i*/,
            ...
            k/*mind*/ = h/*gap*/,
            j/*partial*/,
            i/*value*/ = p/*holder*/[q/*key*/];
        
        i/*value*/ && typeof i/*value*/ === 'object' && typeof i/*value*/.toJSON === 'function' && (i/*value*/ = i/*value*/.toJSON(q/*key*/));
        
        typeof g/*rep*/ === 'function' && (i/*value*/ = g/*rep*/.call(p/*holder*/,q/*key*/,i/*value*/));
        
        switch (typeof i/*value*/) {
          case 'string' :
            return e/*quote*/(i/*value*/);
          case 'number' :
          ...
          case 'object' :
            ...
            if (Object.prototype.toString.apply(i/*value*/) === '[object Array]'){
              
              l/*length*/ = i/*value*/.length;
              
              for (o/*i*/ = 0;o/*i*/<l/*length*/;o/*i*/ += 1){
                
                j/*partial*/[o/*i*/] = d/*str*/(o/*i*/,i/*value*/) || 'null';
              }
              
              m/*v*/ = j/*partial*/.length === 0?'[]' : h/*gap*/?'[\n'+h/*gap*/+j/*partial*/.join(',\n'+h/*gap*/)+'\n'+k/*mind*/+']' : '['+j/*partial*/.join(',')+']';
              
              h/*gap*/ = k/*mind*/;
              return m/*v*/;
            }
            
            if (g/*rep*/ && typeof g/*rep*/ === 'object'){
              
              l/*length*/ = g/*rep*/.length;
              
              for (o/*i*/ = 0;o/*i*/<l/*length*/;o/*i*/ += 1){
                
                if (typeof g/*rep*/[o/*i*/] === 'string'){
                  
                  n/*k*/ = g/*rep*/[o/*i*/];
                  
                  m/*v*/ = d/*str*/(n/*k*/,i/*value*/);
                  
                  if (m/*v*/){
                    
                    j/*partial*/.push(e/*quote*/(n/*k*/)+(h/*gap*/?': ' : ':')+m/*v*/);
                  }
              ...
              for (n/*k*/ in i/*value*/){
                if (Object.prototype.hasOwnProperty.call(i/*value*/,n/*k*/)){
      ...
      function e/*quote*/(d/*string*/) {
        c/*escapable*/.lastIndex = 0;
        return c/*escapable*/.test(d/*string*/)?'"'+d/*string*/.replace(c/*escapable*/,
        function (c/*a*/) {
          var a/*c*/ = b/*meta*/[c/*a*/];
          return typeof a/*c*/ === 'string'?a/*c*/ : '\\u'+('0000'+c/*a*/.charCodeAt(0).toString(16)).slice(-4);
        })+'"' : '"'+d/*string*/+'"';
      }
      function a/*f*/(a/*n*/) {
        return a/*n*/<10?'0'+a/*n*/ : a/*n*/;
      }
      if (typeof Date.prototype.toJSON !== 'function'){
        
        Date.prototype.toJSON = function (b/*key*/) {
          return isFinite(this.valueOf())?this.getUTCFullYear()+'-'+a/*f*/(this.getUTCMonth()+1)+'-'+a/*f*/(this.getUTCDate())+'T'+a/*f*/(this.getUTCHours())+':'+a/*f*/(this.getUTCMinutes())+':'+a/*f*/(this.getUTCSeconds())+'Z' : null;
        };
        
        String.prototype.toJSON = Number.prototype.toJSON = Boolean.prototype.toJSON = function (a/*key*/) {
          return this.valueOf();
        };
      }
      ...
      typeof JSON.stringify !== 'function' && (JSON.stringify = function (e/*value*/,c/*replacer*/,b/*space*/) {
        var a/*i*/;
        ...
        if (typeof b/*space*/ === 'number')for (a/*i*/ = 0;a/*i*/<b/*space*/;a/*i*/ += 1)f/*indent*/ += ' ';
         else typeof b/*space*/ === 'string' && (f/*indent*/ = b/*space*/);
        
        g/*rep*/ = c/*replacer*/;
        
        if (c/*replacer*/ && typeof c/*replacer*/ !== 'function' && (typeof c/*replacer*/ !== 'object' || typeof c/*replacer*/.length !== 'number'))throw new Error('JSON.stringify')
        return d/*str*/('', {
          '' : e/*value*/
        });
      });
      
      typeof JSON.parse !== 'function' && (JSON.parse = function (k/*text*/,a/*reviver*/) {
        function b/*walk*/(g/*holder*/,f/*key*/) {
          var e/*k*/,
              d/*v*/,
              c/*value*/ = g/*holder*/[f/*key*/];
          
          if (c/*value*/ && typeof c/*value*/ === 'object')for (e/*k*/ in c/*value*/)if (({}).hasOwnProperty.call(c/*value*/,e/*k*/)){
            
            d/*v*/ = b/*walk*/(c/*value*/,e/*k*/);
            
            d/*v*/ !== undefined?c/*value*/[e/*k*/] = d/*v*/ : delete c/*value*/[e/*k*/];
          }
          return a/*reviver*/.call(g/*holder*/,f/*key*/,c/*value*/);
        }
        var j/*j*/;
        
        k/*text*/ = String(k/*text*/);
        
        i/*cx*/.lastIndex = 0;
        
        i/*cx*/.test(k/*text*/) && (k/*text*/ = k/*text*/.replace(i/*cx*/,
        function (a/*a*/) {
          return '\\u'+('0000'+a/*a*/.charCodeAt(0).toString(16)).slice(-4);
        }));
        
        if (/^[\],:{}\s]*$/.test(k/*text*/.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,'@').replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,']').replace(/(?:^|:|,)(?:\s*\[)+/g,''))){
          
          j/*j*/ = eval('('+k/*text*/+')');
          return typeof a/*reviver*/ === 'function'?b/*walk*/( {
            '' : j/*j*/
          },'') : j/*j*/;
        }
