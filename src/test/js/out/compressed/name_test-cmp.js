!function() {
  ...
  !function () {
    ...
    function c/*b*/(){}
    b/*_mochaGlobalExport*/['-310326848-name_test.js'] = {};
    
    var p/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-310326848-name_test.js'];
    ...
    a/*Runtime*/.createUnenumProp(f/*_mochaLocalTmp0*/,m/*x*/, {
      
    });
    
    a/*Runtime*/.createUnenumProp(f/*_mochaLocalTmp0*/[m/*x*/],m/*x*/, {
      
    });
    
    a/*Runtime*/.createUnenumProp(f/*_mochaLocalTmp0*/[m/*x*/][m/*x*/],m/*x*/,300);
    
    var j/*m*/ = f/*_mochaLocalTmp0*/;
  }();
}();
