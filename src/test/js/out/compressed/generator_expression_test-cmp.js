!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-759650552-generator_expression_test.js'] = {};
    
    var h/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-759650552-generator_expression_test.js'],
        e/*_mochaLocalTmp0*/ = b/*_mochaGlobalExport*/.iterators,
        d/*keys*/ = e/*_mochaLocalTmp0*/.keys,
        g/*allItems*/ = e/*_mochaLocalTmp0*/.allItems,
        c/*testObject*/ =  {
          value1 : 100,
          value2 : 200,
          value3 : 300
              ...
              i/*_mochaGenerator*/ = function (k/*_isYieldSend*/,j/*_isYieldSafe*/) {
                ...
                switch (f/*_yieldState*/) {
                  case 0 :
                    ...
                    for (var i/*_mochaLocalTmp1*/ in c/*testObject*/)
                    g/*_mochaLocalTmp2*/.push(i/*_mochaLocalTmp1*/);
                    
                    e/*_mochaLocalTmp3*/ = 0;
                    
                    d/*length*/ = g/*_mochaLocalTmp2*/.length;
                    
                    if (!(e/*_mochaLocalTmp3*/<d/*length*/)){
                  ...
                  case 1 :
                    ...
                    b/*x*/ = g/*_mochaLocalTmp2*/[e/*_mochaLocalTmp3*/];
                    
                    b/*x*/ = c/*testObject*/[b/*x*/];
                    return b/*x*/;
                  case 2 :
    ...
    f/*test*/ = function () {
      var g/*_mochaIsNewBorn*/ = true,
          i/*_yieldResult*/ = undefined,
          e/*_yieldState*/ = 0,
          b/*x*/,
          f/*_mochaLocalTmp4*/ = d/*keys*/(c/*testObject*/),
          h/*_mochaGenerator*/ = function (i/*_isYieldSend*/,h/*_isYieldSafe*/) {
            !i/*_isYieldSend*/?g/*_mochaIsNewBorn*/ = false : i/*_isYieldSend*/ && g/*_mochaIsNewBorn*/ && arguments[1] !== undefined && a/*Runtime*/.exceptionHandler('attempt to send to newborn generator.');
            ...
            switch (e/*_yieldState*/) {
              ...
              case 1 :
                ...
                if (!((b/*x*/ = f/*_mochaLocalTmp4*/.__nothrowNext__()))){
              ...
              case 5 :
                ...
                a/*Runtime*/.exceptionHandler(14,'..///Users/aono_taketoshi/github/mocha/src/test/js/harmony/generator_expression_test.js','for of statement expect iterator or generator object.');
              case 6 :
              case -1 :
          ...
          i/*_mochaGenerator*/ = function (k/*_isYieldSend*/,j/*_isYieldSafe*/) {
            ...
            switch (e/*_yieldState*/) {
              case 0 :
                ...
                for (var i/*_mochaLocalTmp5*/ in c/*testObject*/)
                g/*_mochaLocalTmp6*/.push(i/*_mochaLocalTmp5*/);
                
                f/*_mochaLocalTmp7*/ = 0;
                
                d/*length*/ = g/*_mochaLocalTmp6*/.length;
                
                if (!(f/*_mochaLocalTmp7*/<d/*length*/)){
              ...
              case 1 :
                ...
                b/*x*/ = g/*_mochaLocalTmp6*/[f/*_mochaLocalTmp7*/];
    ...
    f/*test*/ = function () {
      var g/*_mochaIsNewBorn*/ = true,
          ...
          e/*_yieldState*/ = 0,
          b/*x*/,
          f/*_mochaLocalTmp8*/ = d/*keys*/(c/*testObject*/),
          h/*_mochaGenerator*/ = function (i/*_isYieldSend*/,h/*_isYieldSafe*/) {
            !i/*_isYieldSend*/?g/*_mochaIsNewBorn*/ = false : i/*_isYieldSend*/ && g/*_mochaIsNewBorn*/ && arguments[1] !== undefined && a/*Runtime*/.exceptionHandler('attempt to send to newborn generator.');
            ...
            switch (e/*_yieldState*/) {
              ...
              case 1 :
                ...
                if (!((b/*x*/ = f/*_mochaLocalTmp8*/.__nothrowNext__()))){
              ...
              case 7 :
                ...
                a/*Runtime*/.exceptionHandler(23,'..///Users/aono_taketoshi/github/mocha/src/test/js/harmony/generator_expression_test.js','for of statement expect iterator or generator object.');
              case 8 :
              case -1 :
