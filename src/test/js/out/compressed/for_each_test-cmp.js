!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-759650552-for_each_test.js'] = {};
    
    var g/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-759650552-for_each_test.js'],
        e/*targetObject*/ =  {
          value1 : 100,
          value2 : 200,
          value3 : 300
    ...
    for (var c/*i*/ in e/*targetObject*/){
      
      c/*i*/ = e/*targetObject*/[c/*i*/];
    ...
    for (d/*prop*/.val in e/*targetObject*/){
      
      d/*prop*/.val = e/*targetObject*/[d/*prop*/.val];
      
      f/*arr*/.push(d/*prop*/.val);
    }
