!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-759650552-module_test.js'] = {};
    
    var a/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-759650552-module_test.js'],
        d/*testModule1*/ = a/*_mochaGlobalAlias*/.testModule1 = function () {
          function a/*testExport1*/() {
            return 1;
          }
          var b/*_mochaLocalExport*/ = {};
          
          b/*_mochaLocalExport*/.testExport1 = a/*testExport1*/;
          return b/*_mochaLocalExport*/;
        }(),
        c/*testModule2*/ = a/*_mochaGlobalAlias*/.testModule2 = function () {
          var b/*_mochaLocalExport*/ = {},
              a/*testInnerModule3*/ = b/*_mochaLocalExport*/.testInnerModule3 = function () {
                function b/*testExport2*/() {
                  return 2;
                }
                var c/*_mochaLocalExport*/ = {};
                
                c/*_mochaLocalExport*/.testExport2 = b/*testExport2*/;
                
                var a/*testExport3*/ = c/*_mochaLocalExport*/.testExport3 =  {
                      test : 200
                    };
    ...
    !function () {
      function b/*testExport5*/() {
        return 4;
      }
      var d/*_mochaLocalExport*/ = a/*_mochaGlobalAlias*/,
          c/*testInnerModule4*/ = d/*_mochaLocalExport*/.testInnerModule4 = function () {
            function a/*testExport4*/() {
              return 3;
            }
            var b/*_mochaLocalExport*/ = {};
            
            b/*_mochaLocalExport*/.testExport4 = a/*testExport4*/;
            return b/*_mochaLocalExport*/;
          }();
      
      d/*_mochaLocalExport*/.testExport5 = b/*testExport5*/;
      return d/*_mochaLocalExport*/;
    }();
  }();
  
  !function () {
    b/*_mochaGlobalExport*/['-759650552-import_test.js'] = {};
    
    var l/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-759650552-import_test.js'],
        j/*_mochaLocalTmp0*/ = b/*_mochaGlobalExport*/['-759650552-module_test.js'],
        k/*testExport1*/ = j/*_mochaLocalTmp0*/.testModule1 && j/*_mochaLocalTmp0*/.testModule1.testExport1?j/*_mochaLocalTmp0*/.testModule1.testExport1 : undefined,
        g/*testExport2*/ = j/*_mochaLocalTmp0*/.testModule2 && j/*_mochaLocalTmp0*/.testModule2.testInnerModule3 && j/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport2?j/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport2 : undefined,
        f/*testExport3*/ = j/*_mochaLocalTmp0*/.testModule2 && j/*_mochaLocalTmp0*/.testModule2.testInnerModule3 && j/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport3?j/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport3 : undefined,
        i/*testExport4*/ = j/*_mochaLocalTmp0*/.testInnerModule4 && j/*_mochaLocalTmp0*/.testInnerModule4.testExport4?j/*_mochaLocalTmp0*/.testInnerModule4.testExport4 : undefined,
        e/*testExport5*/ = j/*_mochaLocalTmp0*/.testExport5;
    
    var h/*testModule*/ = l/*_mochaGlobalAlias*/.testModule = function () {
          function a/*foo*/() {
            return "ok";
          }
          var b/*_mochaLocalExport*/ = {};
          
          b/*_mochaLocalExport*/.foo = a/*foo*/;
          return b/*_mochaLocalExport*/;
        }(),
        c/*_mochaLocalTmp1*/ = h/*testModule*/,
        d/*foo*/ = c/*_mochaLocalTmp1*/.foo;
  }();
}();
