!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-759650552-function_test.js'] = {};
    
    var c/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-759650552-function_test.js'];
    
    !function () {
      function a/*testWithContext*/() {
        return console.log(1);
      }
      function k/*testHasFormalWithContext*/() {
        return console.log(1);
      }
      function c/*testHasFormalHasBlockWithContext*/() {
        console.log(1);
      }
      function l/*test*/() {
        return console.log(1);
      }
      function h/*testHasFormal*/() {
        return console.log(1);
      }
      function d/*testHasFormalHasBlock*/() {
        console.log(1);
      }
      function p/*testConstFunctionWithContext*/() {
        return console.log(1);
      }
      function g/*testConstFunctionHasFormalWithContext*/() {
        return console.log(1);
      }
      function r/*testConstFunctionNonFormal*/() {
        return console.log(1);
      }
      function m/*testConstFunctionHasForaml*/() {
        return console.log(1);
      }
      function o/*testConstFunctionHasBlockHasFormal*/() {
        console.log(1);
      }
      function s/*testDeclNonForamlWithContext*/() {
        return console.log(1);
      }
      function w/*testDeclHasFormalWithContext*/() {
        return console.log(1);
      }
      function v/*testDeclNonFormal*/() {
        return console.log(1);
      }
      function e/*testDeclHasFormal*/() {
        return console.log(1);
      }
      var j/*_mochaLocalTmp0*/ = this;
      
      var t/*_mochaLocalTmp1*/ = this;
      
      var x/*contextTest*/ = function () {
            return console.log(this);
          }.bind(this);
      
      var i/*_mochaLocalTmp2*/ = this;
      
      var q/*_mochaLocalTmp3*/ = this;
      
      var f/*x*/ = function (c/*a*/,b/*b*/,a/*c*/) {
            c/*a*/+b/*b*/;
          },
          f/*x*/ = function (c/*a*/,b/*b*/,a/*c*/) {
            return c/*a*/+b/*b*/;
          };
      
      var n/*_mochaLocalTmp4*/ = this;
      
      var u/*_mochaLocalTmp5*/ = this;
      
      var b/*_mochaLocalTmp6*/ = this;
    }();
    
    !function () {
      function b/*testHasFormalDstaWithContext*/(k/*_mochaLocalTmp38*/,h/*_mochaLocalTmp39*/,g/*_mochaLocalTmp40*/) {
        var j/*args*/ = k/*_mochaLocalTmp38*/.args,
            f/*args2*/ = h/*_mochaLocalTmp39*/.tmp && h/*_mochaLocalTmp39*/.tmp["args2"]?h/*_mochaLocalTmp39*/.tmp.args2 : undefined,
            e/*args3*/ = g/*_mochaLocalTmp40*/[0],
            d/*args4*/ = g/*_mochaLocalTmp40*/[1],
            c/*args5*/ = g/*_mochaLocalTmp40*/[2] && g/*_mochaLocalTmp40*/[2].args5?g/*_mochaLocalTmp40*/[2].args5 : undefined,
            i/*args7*/ = g/*_mochaLocalTmp40*/[2] && g/*_mochaLocalTmp40*/[2].args6 && g/*_mochaLocalTmp40*/[2].args6.args7?g/*_mochaLocalTmp40*/[2].args6.args7 : undefined;
        return console.log(1);
      }
      function n/*testHasFormalWithContext*/(c/*args*/,b/*args2*/,a/*args3*/) {
        return console.log(1);
      }
      function d/*testHasFormalDstaHasBlockWithContext*/(k/*_mochaLocalTmp33*/,j/*_mochaLocalTmp34*/,h/*_mochaLocalTmp35*/) {
        var f/*args*/ = k/*_mochaLocalTmp33*/.args,
            g/*args2*/ = j/*_mochaLocalTmp34*/.tmp && j/*_mochaLocalTmp34*/.tmp["args2"]?j/*_mochaLocalTmp34*/.tmp.args2 : undefined,
            i/*args3*/ = h/*_mochaLocalTmp35*/[0],
            d/*args4*/ = h/*_mochaLocalTmp35*/[1],
            c/*args5*/ = h/*_mochaLocalTmp35*/[2] && h/*_mochaLocalTmp35*/[2].args5?h/*_mochaLocalTmp35*/[2].args5 : undefined,
            e/*args7*/ = h/*_mochaLocalTmp35*/[2] && h/*_mochaLocalTmp35*/[2].args6 && h/*_mochaLocalTmp35*/[2].args6.args7?h/*_mochaLocalTmp35*/[2].args6.args7 : undefined;
        
        console.log(1);
      }
      function p/*testHasFormalHasBlockWithContext*/(c/*args*/,b/*args2*/,a/*args3*/) {
        console.log(1);
      }
      function q/*testHasFormalDsta*/(k/*_mochaLocalTmp29*/,i/*_mochaLocalTmp30*/,h/*_mochaLocalTmp31*/) {
        var f/*args*/ = k/*_mochaLocalTmp29*/.args,
            d/*args2*/ = i/*_mochaLocalTmp30*/.tmp && i/*_mochaLocalTmp30*/.tmp["args2"]?i/*_mochaLocalTmp30*/.tmp.args2 : undefined,
            g/*args3*/ = h/*_mochaLocalTmp31*/[0],
            c/*args4*/ = h/*_mochaLocalTmp31*/[1],
            b/*args5*/ = h/*_mochaLocalTmp31*/[2] && h/*_mochaLocalTmp31*/[2].args5?h/*_mochaLocalTmp31*/[2].args5 : undefined,
            e/*args7*/ = h/*_mochaLocalTmp31*/[2] && h/*_mochaLocalTmp31*/[2].args6 && h/*_mochaLocalTmp31*/[2].args6.args7?h/*_mochaLocalTmp31*/[2].args6.args7 : undefined;
        return console.log(1);
      }
      function e/*testHasFormal*/(c/*args*/,b/*args2*/,a/*args3*/) {
        return console.log(1);
      }
      function g/*testHasFormalDstaHasBlock*/(k/*_mochaLocalTmp26*/,i/*_mochaLocalTmp27*/,h/*_mochaLocalTmp28*/) {
        var g/*args*/ = k/*_mochaLocalTmp26*/.args,
            e/*args2*/ = i/*_mochaLocalTmp27*/.tmp && i/*_mochaLocalTmp27*/.tmp["args2"]?i/*_mochaLocalTmp27*/.tmp.args2 : undefined,
            d/*args3*/ = h/*_mochaLocalTmp28*/[0],
            c/*args4*/ = h/*_mochaLocalTmp28*/[1],
            j/*args5*/ = h/*_mochaLocalTmp28*/[2] && h/*_mochaLocalTmp28*/[2].args5?h/*_mochaLocalTmp28*/[2].args5 : undefined,
            f/*args7*/ = h/*_mochaLocalTmp28*/[2] && h/*_mochaLocalTmp28*/[2].args6 && h/*_mochaLocalTmp28*/[2].args6.args7?h/*_mochaLocalTmp28*/[2].args6.args7 : undefined;
        
        console.log(1);
      }
      function h/*testHasFormalHasBlock*/(c/*args*/,b/*args2*/,a/*args3*/) {
        console.log(1);
      }
      function j/*testConstFunctionHasFormalDstaWithContext*/(k/*_mochaLocalTmp22*/,j/*_mochaLocalTmp23*/,i/*_mochaLocalTmp24*/) {
        var h/*args*/ = k/*_mochaLocalTmp22*/.args,
            f/*args2*/ = j/*_mochaLocalTmp23*/.tmp && j/*_mochaLocalTmp23*/.tmp["args2"]?j/*_mochaLocalTmp23*/.tmp.args2 : undefined,
            e/*args3*/ = i/*_mochaLocalTmp24*/[0],
            d/*args4*/ = i/*_mochaLocalTmp24*/[1],
            c/*args5*/ = i/*_mochaLocalTmp24*/[2] && i/*_mochaLocalTmp24*/[2].args5?i/*_mochaLocalTmp24*/[2].args5 : undefined,
            g/*args7*/ = i/*_mochaLocalTmp24*/[2] && i/*_mochaLocalTmp24*/[2].args6 && i/*_mochaLocalTmp24*/[2].args6.args7?i/*_mochaLocalTmp24*/[2].args6.args7 : undefined;
        return console.log(1);
      }
      function v/*testConstFunctionHasFormalWithContext*/(c/*args*/,b/*args2*/,a/*args3*/) {
        return console.log(1);
      }
      function r/*testConstFunctionHasForamlDsta*/(k/*_mochaLocalTmp18*/,h/*_mochaLocalTmp19*/,j/*_mochaLocalTmp20*/) {
        var g/*args*/ = k/*_mochaLocalTmp18*/.args,
            e/*args2*/ = h/*_mochaLocalTmp19*/.tmp && h/*_mochaLocalTmp19*/.tmp["args2"]?h/*_mochaLocalTmp19*/.tmp.args2 : undefined,
            d/*args3*/ = j/*_mochaLocalTmp20*/[0],
            i/*args4*/ = j/*_mochaLocalTmp20*/[1],
            c/*args5*/ = j/*_mochaLocalTmp20*/[2] && j/*_mochaLocalTmp20*/[2].args5?j/*_mochaLocalTmp20*/[2].args5 : undefined,
            f/*args7*/ = j/*_mochaLocalTmp20*/[2] && j/*_mochaLocalTmp20*/[2].args6 && j/*_mochaLocalTmp20*/[2].args6.args7?j/*_mochaLocalTmp20*/[2].args6.args7 : undefined;
        return console.log(1);
      }
      function o/*testConstFunctionHasForaml*/(c/*args*/,b/*args2*/,a/*args3*/) {
        return console.log(1);
      }
      function w/*testConstFunctionHasBlockHasFormalDsta*/(k/*_mochaLocalTmp15*/,j/*_mochaLocalTmp16*/,i/*_mochaLocalTmp17*/) {
        var g/*args*/ = k/*_mochaLocalTmp15*/.args,
            e/*args2*/ = j/*_mochaLocalTmp16*/.tmp && j/*_mochaLocalTmp16*/.tmp["args2"]?j/*_mochaLocalTmp16*/.tmp.args2 : undefined,
            d/*args3*/ = i/*_mochaLocalTmp17*/[0],
            c/*args4*/ = i/*_mochaLocalTmp17*/[1],
            h/*args5*/ = i/*_mochaLocalTmp17*/[2] && i/*_mochaLocalTmp17*/[2].args5?i/*_mochaLocalTmp17*/[2].args5 : undefined,
            f/*args7*/ = i/*_mochaLocalTmp17*/[2] && i/*_mochaLocalTmp17*/[2].args6 && i/*_mochaLocalTmp17*/[2].args6.args7?i/*_mochaLocalTmp17*/[2].args6.args7 : undefined;
        
        console.log(1);
      }
      function x/*testConstFunctionHasBlockHasFormal*/(c/*args*/,b/*args2*/,a/*args3*/) {
        console.log(1);
      }
      function y/*testDeclHasFormalDstaWithContext*/(k/*_mochaLocalTmp11*/,i/*_mochaLocalTmp12*/,g/*_mochaLocalTmp13*/) {
        var f/*args*/ = k/*_mochaLocalTmp11*/.args,
            d/*args2*/ = i/*_mochaLocalTmp12*/.tmp && i/*_mochaLocalTmp12*/.tmp["args2"]?i/*_mochaLocalTmp12*/.tmp.args2 : undefined,
            c/*args3*/ = g/*_mochaLocalTmp13*/[0],
            h/*args4*/ = g/*_mochaLocalTmp13*/[1],
            j/*args5*/ = g/*_mochaLocalTmp13*/[2] && g/*_mochaLocalTmp13*/[2].args5?g/*_mochaLocalTmp13*/[2].args5 : undefined,
            e/*args7*/ = g/*_mochaLocalTmp13*/[2] && g/*_mochaLocalTmp13*/[2].args6 && g/*_mochaLocalTmp13*/[2].args6.args7?g/*_mochaLocalTmp13*/[2].args6.args7 : undefined;
        return console.log(_mochaLocalTmp14);
      }
      function z/*testDeclHasFormalWithContext*/(c/*args*/,b/*args2*/,a/*args3*/) {
        return console.log(1);
      }
      function A/*testDeclHasFormalDsta*/(k/*_mochaLocalTmp7*/,j/*_mochaLocalTmp8*/,i/*_mochaLocalTmp9*/) {
        var h/*args*/ = k/*_mochaLocalTmp7*/.args,
            f/*args2*/ = j/*_mochaLocalTmp8*/.tmp && j/*_mochaLocalTmp8*/.tmp["args2"]?j/*_mochaLocalTmp8*/.tmp.args2 : undefined,
            e/*args3*/ = i/*_mochaLocalTmp9*/[0],
            d/*args4*/ = i/*_mochaLocalTmp9*/[1],
            c/*args5*/ = i/*_mochaLocalTmp9*/[2] && i/*_mochaLocalTmp9*/[2].args5?i/*_mochaLocalTmp9*/[2].args5 : undefined,
            g/*args7*/ = i/*_mochaLocalTmp9*/[2] && i/*_mochaLocalTmp9*/[2].args6 && i/*_mochaLocalTmp9*/[2].args6.args7?i/*_mochaLocalTmp9*/[2].args6.args7 : undefined;
        return console.log(1);
      }
      function t/*testDeclHasFormal*/(c/*args*/,b/*args2*/,a/*args3*/) {
        return console.log(1);
      }
      var m/*_mochaLocalTmp10*/ = this;
      
      var s/*_mochaLocalTmp14*/ = this;
      
      var l/*_mochaLocalTmp21*/ = this;
      
      var u/*_mochaLocalTmp25*/ = this;
      
      var i/*_mochaLocalTmp32*/ = this;
      
      var f/*_mochaLocalTmp36*/ = this;
      
      var k/*_mochaLocalTmp37*/ = this;
      
      var c/*_mochaLocalTmp41*/ = this;
    }();
  }();
}();
