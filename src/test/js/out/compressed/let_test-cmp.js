!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-759650552-let_test.js'] = {};
    
    var f/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-759650552-let_test.js'],
        e/*x*/ = 0,
        c/*ret*/ = [];
    
    for (var d/*i*/ = 0;d/*i*/<10;d/*i*/ ++ )
    !function (a/*i*/) {
      c/*ret*/.push(function () {
        return a/*i*/;
      });
    ...
    c/*ret*/.forEach(function (c/*item*/,b/*index*/) {
