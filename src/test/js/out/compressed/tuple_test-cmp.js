!function() {
  ...
  !function () {
    try {
      var __FILE__ = "Y:/mocha/src/test/js/harmony/tuple_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport['tuple_test.js;1'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias = _mochaGlobalExport['tuple_test.js;1'],
          test = Runtime.createTuple({},4),
          test2 = Runtime.createRecord( {
            "name" : "foo",
            age : "20",
            addr : "tokyo"
          }),
