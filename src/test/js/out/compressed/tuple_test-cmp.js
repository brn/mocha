!function() {
  ...
  !function () {
    c/*_mochaGlobalExport*/['-759650552-tuple_test.js'] = {};
    
    var g/*_mochaGlobalAlias*/ = c/*_mochaGlobalExport*/['-759650552-tuple_test.js'],
        f/*test*/ = a/*Runtime*/.createTuple({},4),
        e/*test2*/ = a/*Runtime*/.createRecord( {
          "name" : "foo",
          age : "20",
          addr : "tokyo"
        }),
        d/*test3*/ = new b/*Tuple*/(0,1,3,4,5,6,7,7);
