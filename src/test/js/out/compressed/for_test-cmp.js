!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['1653259312-for_test.js'] = {};
    
    var f/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['1653259312-for_test.js'],
        d/*target*/ = ['a','b','c','d','e','f','g','h','i','j'],
        e/*arr*/ = [];
    
    for (var c/*i*/ = 0;c/*i*/<10;c/*i*/ ++ )
    e/*arr*/.push(d/*target*/[c/*i*/]);
    
    e/*arr*/ = [];
    
    for (c/*i*/ = 0;c/*i*/<10;c/*i*/ ++ )e/*arr*/.push(d/*target*/[c/*i*/]);
