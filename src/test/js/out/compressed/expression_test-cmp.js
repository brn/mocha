!function() {
  ...
  !function () {
    function f/*primaryTest*/() {
      var b/*array*/ = [,,,];
    }
    function h/*expressionTest*/() {
      var b/*exp*/ = function () {
            return 1;
          }();
    ...
    function i/*memberExpressionTest*/() {
      var b/*test*/ =  {
            test2 :  {
              "@test" :  {
                0 :  {
    ...
    function d/*unaryExpressionTest*/() {
      var e/*strNum*/ = "1",
          c/*ret*/ = +e/*strNum*/;
    ...
    function c/*postfixExpressionTest*/() {
      var c/*add*/ = 0;
    ...
    function j/*binaryExpressionTest*/() {
      var l/*item*/ = 100,
          s/*trueValue*/ = true,
          r/*falseValue*/ = false,
          b/*val*/ = 0;
      
      l/*item*/ && s/*trueValue*/ && !r/*falseValue*/ && (b/*val*/ = 1);
      
      ((l/*item*/ && s/*trueValue*/) || r/*falseValue*/) && (b/*val*/ = 2);
      
      ((l/*item*/ && r/*falseValue*/) || !s/*trueValue*/) && (b/*val*/ = 3);
      
      var k/*changeVal*/ = function (c/*value*/) {
            b/*val*/ = c/*value*/;
          };
      
      (l/*item*/) && (s/*trueValue*/) && (!r/*falseValue*/) && (k/*changeVal*/(4));
      ...
      var d/*obj*/ =  {
          ...
          c/*testInAnd*/ = 'onmouseenter' in d/*obj*/ && 'onmouseleave' in d/*obj*/;
    }
    function e/*callExpressionTest*/() {
      var g/*highFn*/ = function () {
            return function () {
              return function () {
                return true;
              };
      ...
      var b/*inner1*/ = function () {
          ...
          c/*inner2*/ = function (){},
          f/*flg*/ = 1,
          e/*instance*/ = new ((f/*flg*/)?g/*highFn*/ : b/*inner1*/);
      
      var d/*flg2*/ = 0;
      
      e/*instance*/ = new ((d/*flg2*/)?g/*highFn*/ : b/*inner1*/);
    }
    function g/*objectAndNewTest*/() {
      var h/*testObject*/ = {};
      
      h/*testObject*/.testProp = {};
      
      h/*testObject*/.testProp.testProp = {};
      
      h/*testObject*/.testProp.testProp.testProp = {};
      
      h/*testObject*/.testFn = function () {
        return true;
      };
      
      h/*testObject*/.testProp.testFn = function () {
        return false;
      };
      
      h/*testObject*/.testProp.testProp.testFn = function () {
        return 2;
      };
      
      var o/*highFn*/ = function () {
            return b/*inner1*/;
          },
          b/*inner1*/ = function () {
            return c/*inner2*/;
          ...
          c/*inner2*/ = function (){},
          m/*instance*/ = new o/*highFn*/(),
          k/*instance2*/ = new new o/*highFn*/(),
          i/*instance3*/ = new new new o/*highFn*/();
      ...
      var j/*fnObj*/ =  {
          ...
          n/*instance4*/ = new j/*fnObj*/.highFn(),
          g/*instance5*/ = new new j/*fnObj*/.highFn(),
          f/*instance6*/ = new new new j/*fnObj*/.highFn();
      
      var e/*instance7*/ = new j/*fnObj*/.highFnInner.highFn(),
          l/*instance8*/ = new new j/*fnObj*/.highFnInner.highFn(),
          d/*instance9*/ = new new new j/*fnObj*/.highFnInner.highFn();
    }
    function k/*parseTest*/() {
      var b/*x*/ = 2.000000;
    ...
    b/*_mochaGlobalExport*/['1653259312-expression_test.js'] = {};
    
    var l/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['1653259312-expression_test.js'];
    ...
    e/*callExpressionTest*/();
    
    j/*binaryExpressionTest*/();
    
    c/*postfixExpressionTest*/();
    
    d/*unaryExpressionTest*/();
    
    i/*memberExpressionTest*/();
