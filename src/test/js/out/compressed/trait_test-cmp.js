!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-759650552-trait_test.js'] = {};
    
    var j/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-759650552-trait_test.js'],
        g/*TestTraitP*/ =  {
          _mochaTraitPrivate :  {
            _greaterThant : function h/*_greaterThant*/(b/*x*/,a/*y*/) {
              return b/*x*/<a/*y*/;
            }
          },
          _mochaTraitPublic :  {
            greaterThan : function i/*greaterThan*/(b/*x*/,a/*y*/) {
              return b/*x*/<a/*y*/;
            }
          },
          _mochaRequires : {},
        ...
        d/*TestTrait*/ =  {
          _mochaTraitPrivate :  {
            _lessThan : function f/*_lessThan*/(b/*x*/,a/*y*/) {
              return b/*x*/<a/*y*/;
            }
          },
          _mochaTraitPublic :  {
            lessThan : function e/*lessThan*/(b/*x*/,a/*y*/) {
              return b/*x*/<a/*y*/;
            }
          },
          _mochaRequires :  {
    ...
    a/*Runtime*/.traitMixin(d/*TestTrait*/,g/*TestTraitP*/, {
      greaterThan : "gt",
      _greaterThant : "_gt"
    },{});
    
    var c/*traitexp*/ = function () {
          var a/*_mochaLocalTmp0*/ =  {
                _mochaTraitPrivate :  {
                  mastercmp : function c/*mastercmp*/(b/*x*/,a/*y*/) {
                    return b/*x*/>a/*y*/;
                  }
                },
                _mochaTraitPublic :  {
                  lessthan : function b/*lessthan*/(b/*x*/,a/*y*/) {
                    return b/*x*/>a/*y*/;
                  }
                },
                _mochaRequires : {},
