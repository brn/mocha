!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-1426553882-json_parse.js'] = {};
    
    var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-1426553882-json_parse.js'],
        c/*json_parse*/ = (function () {
          "use strict";
          var b/*at*/,
              d/*ch*/,
              f/*escapee*/ =  {
              ...
              e/*next*/ = function (e/*c*/) {
                e/*c*/ && e/*c*/ !== d/*ch*/ && c/*error*/("Expected '"+e/*c*/+"' instead of '"+d/*ch*/+"'");
                
                d/*ch*/ = a/*text*/.charAt(b/*at*/);
              ...
              m/*number*/ = function () {
                ...
                if (d/*ch*/ === '.'){
                  ...
                  while (e/*next*/() && d/*ch*/ >= '0' && d/*ch*/ <= '9')f/*string*/ += d/*ch*/;
                }
                ...
                if (!isFinite(g/*number*/))c/*error*/("Bad number");
                 else return g/*number*/;
              },
              i/*string*/ = function () {
                var j/*hex*/,
                    i/*i*/,
                ...
                if (d/*ch*/ === '"')while (e/*next*/())if (d/*ch*/ === '"'){
                  ...
                  if (d/*ch*/ === 'u'){
                    ...
                    for (i/*i*/ = 0;i/*i*/<4;i/*i*/ += 1){
                      ...
                      j/*hex*/ = parseInt(e/*next*/(),16);
                      if (!isFinite(j/*hex*/))break;
                      
                      g/*uffff*/ = g/*uffff*/*16+j/*hex*/;
                    }
                    
                    h/*string*/ += String.fromCharCode(g/*uffff*/);
                  } else if (typeof f/*escapee*/[d/*ch*/] === 'string')h/*string*/ += f/*escapee*/[d/*ch*/];
                   else break;
                } else h/*string*/ += d/*ch*/;
              ...
              l/*object*/ = function () {
                ...
                if (d/*ch*/ === '{'){
                  ...
                  while (d/*ch*/){
                    ...
                    Object.hasOwnProperty.call(j/*object*/,k/*key*/) && c/*error*/('Duplicate key "'+k/*key*/+'"');
                    
                    j/*object*/[k/*key*/] = g/*value*/();
          ...
          g/*value*/ = function () {
            ...
            switch (d/*ch*/) {
              ...
              case '-' :
                return m/*number*/();
              default :
                return d/*ch*/ >= '0' && d/*ch*/ <= '9'?m/*number*/() : j/*word*/();
                
            }
            
          };
          return function (j/*source*/,e/*reviver*/) {
            var i/*result*/;
            ...
            d/*ch*/ && c/*error*/("Syntax error");
            return typeof e/*reviver*/ === 'function'?(function f/*walk*/(k/*holder*/,j/*key*/) {
              var i/*k*/,
                  h/*v*/,
                  g/*value*/ = k/*holder*/[j/*key*/];
              
              if (g/*value*/ && typeof g/*value*/ === 'object')for (i/*k*/ in g/*value*/)if (({}).hasOwnProperty.call(g/*value*/,i/*k*/)){
                
                h/*v*/ = f/*walk*/(g/*value*/,i/*k*/);
                
                h/*v*/ !== undefined?g/*value*/[i/*k*/] = h/*v*/ : delete g/*value*/[i/*k*/];
              }
              return e/*reviver*/.call(k/*holder*/,j/*key*/,g/*value*/);
            }( {
              '' : i/*result*/
            },'')) : i/*result*/;
          };
