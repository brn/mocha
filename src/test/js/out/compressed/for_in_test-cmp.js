!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['1653259312-for_in_test.js'] = {};
    
    var g/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['1653259312-for_in_test.js'],
        e/*target*/ =  {
          value1 : 100,
          value2 : 200,
          value3 : 300,
    ...
    for (var d/*i*/ in e/*target*/)
    f/*arr*/.push(e/*target*/[d/*i*/]);
    
    f/*arr*/ = [];
    
    for (d/*i*/ in e/*target*/)f/*arr*/.push(e/*target*/[d/*i*/]);
    ...
    for (c/*index*/.prop in e/*target*/)f/*arr*/.push(e/*target*/[c/*index*/.prop]);
  }();
}();
