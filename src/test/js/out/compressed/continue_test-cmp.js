!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['1653259312-continue_test.js'] = {};
    
    var e/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['1653259312-continue_test.js'];
    
    for (var d/*i*/ = 0;d/*i*/<10;d/*i*/ ++ )continue ;
    
    for (d/*i*/ = 0;d/*i*/<10;d/*i*/ ++ ){
      END : 
      for (var c/*j*/ = 0;c/*j*/<5;c/*j*/ ++ )break END;
    }
