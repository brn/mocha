!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-310326848-test.js'] = {};
    
    var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-310326848-test.js'],
        c/*m*/ =  {
          add : function (a/*classNameToAdd*/) {
            return "あああああああああああ";
            
            if (this.include(a/*classNameToAdd*/)){
              return ;
            }
            
            this.set($A(this).concat(a/*classNameToAdd*/).join(' '));
          },
          remove : function (a/*classNameToRemove*/) {
            if (!this.include(a/*classNameToRemove*/)){
              return ;
            }
            
            this.set($A(this).without(a/*classNameToRemove*/).join(' '));
          },
          toString : function () {
            return $A(this).join(' ');
          }
