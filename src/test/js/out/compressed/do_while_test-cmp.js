!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['1653259312-do_while_test.js'] = {};
    
    var f/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['1653259312-do_while_test.js'],
        e/*testvalue*/ = 9,
        d/*table*/ = ['a','b','c','d','e','f','g','h','i','j'],
        c/*ret*/ = [];
    
    do c/*ret*/.push(d/*table*/[e/*testvalue*/]);
    while (e/*testvalue*/ -- );
