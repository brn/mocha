!function() {
  ...
  !function () {
    b/*_mochaGlobalExport*/['-1426553882-json2_compiled.js'] = {};
    
    var e/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['-1426553882-json2_compiled.js'],
        c/*g*/ = null,
        d/*json_parse*/ = function () {
          function a/*h*/(a/*a*/) {
            throw  {
              name : "SyntaxError",
              message : a/*a*/,
          ...
          function b/*b*/(h/*b*/) {
            h/*b*/ && h/*b*/ !== d/*a*/ && a/*h*/("Expected '"+h/*b*/+"' instead of '"+d/*a*/+"'");
          ...
          function h/*n*/() {
            ...
            for (;d/*a*/ >= "0" && d/*a*/ <= "9";)e/*c*/ += d/*a*/, b/*b*/(c/*g*/);
            
            if (d/*a*/ === ".")for (e/*c*/ += ".";b/*b*/(c/*g*/) && d/*a*/ >= "0" && d/*a*/ <= "9";)e/*c*/ += d/*a*/;
          ...
          function k/*l*/() {
            ...
            if (d/*a*/ === '"')for (;b/*b*/(c/*g*/);)if (d/*a*/ === '"')return b/*b*/(c/*g*/), g/*d*/;
             else if (d/*a*/ === "\\")if (b/*b*/(c/*g*/), d/*a*/ === "u"){
              
              for (h/*f*/ = f/*e*/ = 0;h/*f*/<4;h/*f*/ += 1){
                
                i/*c*/ = parseInt(b/*b*/(c/*g*/),16);
                if (!isFinite(i/*c*/))break;
                
                f/*e*/ = f/*e*/*16+i/*c*/;
              }
              
              g/*d*/ += String.fromCharCode(f/*e*/);
            } else if (typeof e/*m*/[d/*a*/] === "string")g/*d*/ += e/*m*/[d/*a*/];
             else break;
             else g/*d*/ += d/*a*/;
          ...
          j/*ja*/ = function () {
            ...
            switch (d/*a*/) {
                ...
                a : 
                {
                  ...
                  if (d/*a*/ === "{"){
                    ...
                    for (;d/*a*/;){
                      ...
                      Object.hasOwnProperty.call(m/*d*/,n/*f*/) && a/*h*/('Duplicate key "'+n/*f*/+'"');
              ...
              case "-" :
                return h/*n*/();
              default :
                return d/*a*/ >= "0" && d/*a*/ <= "9"?h/*n*/() : i/*o*/();
                
            }
            
          };
          return function (h/*b*/,b/*f*/) {
            var e/*d*/;
            ...
            d/*a*/ && a/*h*/("Syntax error");
            return typeof b/*f*/ === "function"?function c/*p*/(h/*a*/,g/*b*/) {
              var f/*c*/,
                  e/*e*/,
                  d/*d*/ = h/*a*/[g/*b*/];
              
              if (d/*d*/ && typeof d/*d*/ === "object")for (f/*c*/ in d/*d*/)({}).hasOwnProperty.call(d/*d*/,f/*c*/) && (e/*e*/ = c/*p*/(d/*d*/,f/*c*/), e/*e*/ !== void 0?d/*d*/[f/*c*/] = e/*e*/ : delete d/*d*/[f/*c*/]);
              return b/*f*/.call(h/*a*/,g/*b*/,d/*d*/);
            }( {
              "" : e/*d*/
            },"") : e/*d*/;
          };
    ...
    !function () {
      var f/*json_str*/ = '{"test" : 1,"test2":"test2","test3":null,"test4":{"test5":5}}',
          e/*json*/ = d/*json_parse*/(f/*json_str*/);
    }();
  }();
}();
