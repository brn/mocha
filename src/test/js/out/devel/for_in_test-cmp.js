!function() {
  ...
  !function () {
    try {
      var __FILE__ = "1653259312-for_in_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-for_in_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-for_in_test.js'],
          target/*target*/ =  {
            value1 : 100,
            value2 : 200,
            value3 : 300,
      ...
      __LINE__ = 11;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[0] === 100,"arr[0] === 100",11,'for_in_test.js');
      
      __LINE__ = 12;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[1] === 200,"arr[1] === 200",12,'for_in_test.js');
      
      __LINE__ = 13;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[2] === 300,"arr[2] === 300",13,'for_in_test.js');
      
      __LINE__ = 14;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[3] === 400,"arr[3] === 400",14,'for_in_test.js');
      
      __LINE__ = 16;
      arr/*arr*/ = [];
      
      __LINE__ = 17;
      for (i/*i*/ in target/*target*/){
        __LINE__ = 18;
        arr/*arr*/.push(target/*target*/[i/*i*/]);
      }
      
      __LINE__ = 20;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[0] === 100,"arr[0] === 100",20,'for_in_test.js');
      
      __LINE__ = 21;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[1] === 200,"arr[1] === 200",21,'for_in_test.js');
      
      __LINE__ = 22;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[2] === 300,"arr[2] === 300",22,'for_in_test.js');
      
      __LINE__ = 23;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[3] === 400,"arr[3] === 400",23,'for_in_test.js');
      ...
      __LINE__ = 28;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[0] === 100,"arr[0] === 100",28,'for_in_test.js');
      
      __LINE__ = 29;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[1] === 200,"arr[1] === 200",29,'for_in_test.js');
      
      __LINE__ = 30;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[2] === 300,"arr[2] === 300",30,'for_in_test.js');
      
      __LINE__ = 31;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[3] === 400,"arr[3] === 400",31,'for_in_test.js');
      ...
      __LINE__ = 36;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[0] === 100,"arr[0] === 100",36,'for_in_test.js');
      
      __LINE__ = 37;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[1] === 200,"arr[1] === 200",37,'for_in_test.js');
      
      __LINE__ = 38;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[2] === 300,"arr[2] === 300",38,'for_in_test.js');
      
      __LINE__ = 39;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[3] === 400,"arr[3] === 400",39,'for_in_test.js');
      ...
      __LINE__ = 43;
      for (index/*index*/.prop in target/*target*/){
        __LINE__ = 44;
        arr/*arr*/.push(target/*target*/[index/*index*/.prop]);
      }
      
      __LINE__ = 46;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[0] === 100,"arr[0] === 100",46,'for_in_test.js');
      
      __LINE__ = 47;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[1] === 200,"arr[1] === 200",47,'for_in_test.js');
      
      __LINE__ = 48;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[2] === 300,"arr[2] === 300",48,'for_in_test.js');
      
      __LINE__ = 49;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[3] === 400,"arr[3] === 400",49,'for_in_test.js');
    } catch(e){
