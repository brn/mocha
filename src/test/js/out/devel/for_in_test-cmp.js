!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 11;
      Runtime.assert(true,arr[0],"arr[0]",11,'./for_in_test.js');
      
      __LINE__ = 12;
      Runtime.assert(true,arr[1],"arr[1]",12,'./for_in_test.js');
      
      __LINE__ = 13;
      Runtime.assert(true,arr[2],"arr[2]",13,'./for_in_test.js');
      
      __LINE__ = 14;
      Runtime.assert(true,arr[3],"arr[3]",14,'./for_in_test.js');
      ...
      __LINE__ = 20;
      Runtime.assert(true,arr[0],"arr[0]",20,'./for_in_test.js');
      
      __LINE__ = 21;
      Runtime.assert(true,arr[1],"arr[1]",21,'./for_in_test.js');
      
      __LINE__ = 22;
      Runtime.assert(true,arr[2],"arr[2]",22,'./for_in_test.js');
      
      __LINE__ = 23;
      Runtime.assert(true,arr[3],"arr[3]",23,'./for_in_test.js');
      ...
      __LINE__ = 28;
      Runtime.assert(true,arr[0],"arr[0]",28,'./for_in_test.js');
      
      __LINE__ = 29;
      Runtime.assert(true,arr[1],"arr[1]",29,'./for_in_test.js');
      
      __LINE__ = 30;
      Runtime.assert(true,arr[2],"arr[2]",30,'./for_in_test.js');
      
      __LINE__ = 31;
      Runtime.assert(true,arr[3],"arr[3]",31,'./for_in_test.js');
      ...
      __LINE__ = 36;
      Runtime.assert(true,arr[0],"arr[0]",36,'./for_in_test.js');
      
      __LINE__ = 37;
      Runtime.assert(true,arr[1],"arr[1]",37,'./for_in_test.js');
      
      __LINE__ = 38;
      Runtime.assert(true,arr[2],"arr[2]",38,'./for_in_test.js');
      
      __LINE__ = 39;
      Runtime.assert(true,arr[3],"arr[3]",39,'./for_in_test.js');
      ...
      __LINE__ = 46;
      Runtime.assert(true,arr[0],"arr[0]",46,'./for_in_test.js');
      
      __LINE__ = 47;
      Runtime.assert(true,arr[1],"arr[1]",47,'./for_in_test.js');
      
      __LINE__ = 48;
      Runtime.assert(true,arr[2],"arr[2]",48,'./for_in_test.js');
      
      __LINE__ = 49;
      Runtime.assert(true,arr[3],"arr[3]",49,'./for_in_test.js');
    } catch(e){
