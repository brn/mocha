  ...
  !function () {
    ...
    function k() {
      ...
      var d =  {
          ...
          c = 'onmouseenter' in d && 'onmouseleave' in d;
    }
    function f() {
      var g = function () {
            return function () {
    ...
    function h() {
      ...
      h.testProp.testProp.testProp = {};
      
      h.testFn = function () {
        return true;
      };
      
      h.testProp.testFn = function () {
        return false;
      };
      
      h.testProp.testProp.testFn = function () {
        return 2;
      };
      ...
      var j =  {
          ...
          n = new j.highFn(),
          g = new new j.highFn(),
          f = new new new j.highFn();
      
      var e = new j.highFnInner.highFn(),
          l = new new j.highFnInner.highFn(),
          d = new new new j.highFnInner.highFn();
    }
    function l() {
      var b = 2.000000;
    ...
    c['1653259312-expression_test.js'] = {};
    
    var m = c['1653259312-expression_test.js'];
