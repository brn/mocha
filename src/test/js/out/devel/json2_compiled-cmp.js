  ...
  !function () {
    try {
      var __FILE__ = "-1426553882-json2_compiled.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-1426553882-json2_compiled.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-1426553882-json2_compiled.js'],
          g/*g*/ = null,
          json_parse/*json_parse*/ = function () {
            try {
              function h/*h*/(a/*a*/) {
                try {
                  __LINE__ = 1;
              ...
              function b/*b*/(b/*b*/) {
                try {
                  __LINE__ = 1;
                  b/*b*/ && b/*b*/ !== a/*a*/ && h/*h*/("Expected '"+b/*b*/+"' instead of '"+a/*a*/+"'");
                    ...
                    for (;b/*b*/(g/*g*/);){
                      ...
                      if (a/*a*/ === '"'){
                        ...
                        if (b/*b*/(g/*g*/), a/*a*/ === "u"){
                          ...
                          __LINE__ = 1;
                          for (f/*f*/ = e/*e*/ = 0;f/*f*/<4;f/*f*/ += 1){
                            
                            __LINE__ = 1;
                            c/*c*/ = parseInt(b/*b*/(g/*g*/),16);
                            if (!isFinite(c/*c*/)){
                              __LINE__ = 1;
                              break;
                            }
              ...
              function o/*o*/() {
                try {
                  ...
                  switch (a/*a*/) {
                    ...
                    case "n" :
                      __LINE__ = 1;
                      return b/*b*/("n"), b/*b*/("u"), b/*b*/("l"), b/*b*/("l"), g/*g*/;
                      ...
                      a : 
                      {
                        ...
                        if (a/*a*/ === "{"){
                          ...
                          for (;a/*a*/;){
                            ...
                            __LINE__ = 1;
                            Object.hasOwnProperty.call(d/*d*/,f/*f*/) && h/*h*/('Duplicate key "'+f/*f*/+'"');
              ...
              return function (b/*b*/,f/*f*/) {
                try {
                  ...
                  __LINE__ = 1;
                  a/*a*/ && h/*h*/("Syntax error");
                  __LINE__ = 1;
                  return typeof f/*f*/ === "function"?function p/*p*/(a/*a*/,b/*b*/) {
                    try {
                      __LINE__ = 1;
                      var c/*c*/,
                          e/*e*/,
                      ...
                      if (d/*d*/ && typeof d/*d*/ === "object"){
                        ...
                        for (c/*c*/ in d/*d*/){
                          __LINE__ = 1;
                          ({}).hasOwnProperty.call(d/*d*/,c/*c*/) && (e/*e*/ = p/*p*/(d/*d*/,c/*c*/), e/*e*/ !== void 0?d/*d*/[c/*c*/] = e/*e*/ : delete d/*d*/[c/*c*/]);
                        }
                        
                      }
                      __LINE__ = 1;
                      return f/*f*/.call(a/*a*/,b/*b*/,d/*d*/);
                    } catch(e){
                      Runtime.exceptionHandler(__LINE__, __FILE__, e);
                    }
                  }( {
      ...
      !function () {
        try {
          __LINE__ = 4;
          var json_str/*json_str*/ = '{"test" : 1,"test2":"test2","test3":null,"test4":{"test5":5}}',
              json/*json*/ = json_parse/*json_parse*/(json_str/*json_str*/);
          
          __LINE__ = 6;
          Runtime/*Runtime*/.assert(true,json/*json*/["test"] === 1,"json[\"test\"] === 1",6,'json2_compiled.js');
          
          __LINE__ = 7;
          Runtime/*Runtime*/.assert(true,json/*json*/["test2"] === "test2","json[\"test2\"] === \"test2\"",7,'json2_compiled.js');
          
          __LINE__ = 8;
          Runtime/*Runtime*/.assert(true,json/*json*/["test3"] === null,"json[\"test3\"] === null",8,'json2_compiled.js');
          
          __LINE__ = 9;
          Runtime/*Runtime*/.assert(true,json/*json*/["test4"]["test5"] === 5,"json[\"test4\"][\"test5\"] === 5",9,'json2_compiled.js');
        } catch(e){
          Runtime.exceptionHandler(__LINE__, __FILE__, e);
        }
      }();
