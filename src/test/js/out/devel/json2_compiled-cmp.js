    ...
    try {
            ...
            try {
                      ...
                      a : 
                      {
                        ...
                        if (a){
                          ...
                          for (;a;){
                            ...
                            __LINE__ = 1;
                            Object.hasOwnProperty.call(d,f);
              ...
              return function (b,f) {
                try {
                  ...
                  a;
                  __LINE__ = 1;
                  return typeof f?function p(a,b) {
                    try {
                      __LINE__ = 1;
                      var c,
                          e,
      ...
      !function () {
        try {
          ...
          __LINE__ = 6;
          Runtime.assert(true,json["test"],"json[\"test\"]",6,'./json2_compiled.js');
          
          __LINE__ = 7;
          Runtime.assert(true,json["test2"],"json[\"test2\"]",7,'./json2_compiled.js');
          
          __LINE__ = 8;
          Runtime.assert(true,json["test3"],"json[\"test3\"]",8,'./json2_compiled.js');
          
          __LINE__ = 9;
          Runtime.assert(true,json["test4"]["test5"],"json[\"test4\"][\"test5\"]",9,'./json2_compiled.js');
        } catch(e){
          Runtime.exceptionHandler(__LINE__, __FILE__, e);
        }
      }();
