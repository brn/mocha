!function() {
  ...
  !function () {
    c['-1426553882-json2_compiled.js'] = {};
    
    var e = c['-1426553882-json2_compiled.js'],
        b = null,
        d = function () {
          function a(a) {
            throw  {
          ...
          function c(h) {
            h && h !== d && a("Expected '"+h+"' instead of '"+d+"'");
          ...
          function k() {
            ...
            if (d === '"')for (;c(b);)if (d === '"')return c(b), g;
             else if (d === "\\")if (c(b), d === "u"){
            ...
            } else if (typeof e[d] === "string")g += e[d];
             else break;
             else g += d;
                ...
                a : 
                {
                  ...
                  if (d === "{"){
                    ...
                    for (;d;){
                      ...
                      Object.hasOwnProperty.call(m,n) && a('Duplicate key "'+n+'"');
          ...
          return function (h,b) {
            ...
            d && a("Syntax error");
            return typeof b === "function"?function c(h,g) {
              var f,
                  e,
                  d = h[g];
              
              if (d && typeof d === "object")for (f in d)({}).hasOwnProperty.call(d,f) && (e = c(d,f), e !== void 0?d[f] = e : delete d[f]);
              return b.call(h,g,d);
            }( {
              "" : e
            },"") : e;
    ...
    !function () {
      var f = '{"test" : 1,"test2":"test2","test3":null,"test4":{"test5":5}}',
          e = d(f);
    }();
  }();
}();
