!function() {
  ...
  !function () {
    c['-759650552-destructuring_test.js'] = {};
    
    var j = c['-759650552-destructuring_test.js'],
        i =  {
          value1 : 100,
          value2 :  {
            value3 : 100
    ...
    !function () {
      var g = i.value1,
          h = i.value2 && i.value2.value3?i.value2.value3 : undefined,
          e = i.value4 && i.value4[0]?i.value4[0] : undefined,
          f = i.value4 && i.value4[1]?i.value4[1] : undefined,
          d = i.value4 && i.value4[2]?i.value4[2] : undefined,
          c = i.value5 && i.value5.value6 && i.value5.value6[0] && i.value5.value6[0].value7?i.value5.value6[0].value7 : undefined,
          b = i["@value"] && i["@value"].strvalue?i["@value"].strvalue : undefined;
      
      value1 = i.value1;
      
      value3 = i.value2 && i.value2.value3?i.value2.value3 : undefined;
      ...
      value7 = i.value5 && i.value5.value6 && i.value5.value6[0] && i.value5.value6[0].value7?i.value5.value6[0].value7 : undefined;
      
      strvalue = i["@value"] && i["@value"].strvalue?i["@value"].strvalue : undefined;
    }();
    
    !function () {
      var g = h[0] && h[0].value1?h[0].value1 : undefined,
          f = h[1],
          d = h[2] && h[2].value2?h[2].value2 : undefined,
          e = h[3] && h[3]["value3"]?h[3].value3 : undefined,
          c = h[4] && h[4].value4 && h[4].value4.value5 && h[4].value4.value5[0]?h[4].value4.value5[0] : undefined,
          b = h[4] && h[4].value4 && h[4].value4.value5 && h[4].value4.value5[1]?h[4].value4.value5[1] : undefined;
      
      value1 = h[0] && h[0].value1?h[0].value1 : undefined;
      
      f = h[1];
      
      value2 = h[2] && h[2].value2?h[2].value2 : undefined;
      
      value3 = h[3] && h[3]["value3"]?h[3].value3 : undefined;
    ...
    !function () {
      var g = h[0] && h[0].value1?h[0].value1 : undefined,
          ...
          d = h[2] && h[2].value2?h[2].value2 : undefined,
          e = h[3] && h[3]["value3"]?h[3].value3 : undefined,
          c = h[4] && h[4].value4 && h[4].value4.value5?a.toArray(h[4].value4.value5,0) : undefined;
      ...
      b = h[4] && h[4].value4 && h[4].value4.value5?a.toArray(h[4].value4.value5,0) : undefined;
    }();
    
    !function (i) {
      var h = i.value1,
          f = i.value2 && i.value2.value3?i.value2.value3 : undefined,
          e = i.value4 && i.value4[0]?i.value4[0] : undefined,
          g = i.value4 && i.value4[1]?i.value4[1] : undefined,
          d = i.value4 && i.value4[2]?i.value4[2] : undefined,
          c = i.value5 && i.value5.value6 && i.value5.value6[0] && i.value5.value6[0].value7?i.value5.value6[0].value7 : undefined,
          b = i["@value"] && i["@value"].strvalue?i["@value"].strvalue : undefined;
    }(i);
    ...
    !function (g) {
      var f = g[0] && g[0].value1?g[0].value1 : undefined,
          e = g[1],
          c = g[2] && g[2].value2?g[2].value2 : undefined,
          d = g[3] && g[3]["value3"]?g[3].value3 : undefined,
          b = g[4] && g[4].value4 && g[4].value4.value5?a.toArray(g[4].value4.value5,0) : undefined;
    }(h);
