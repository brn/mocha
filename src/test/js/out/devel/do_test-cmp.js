  ...
  !function () {
    try {
      var __FILE__ = "-759650552-do_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-do_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-do_test.js'],
          testvalue/*testvalue*/ = function () {
            try {
              __LINE__ = 2;
              var x/*x*/ = 0;
              __LINE__ = 3;
      ...
      __LINE__ = 6;
      Runtime/*Runtime*/.assert(true,testvalue/*testvalue*/ === 0,"testvalue === 0",6,'do_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
