!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 4;
      Runtime.assert(true,i,"i",4,'./continue_test.js');
      
      __LINE__ = 5;
      Runtime.assert(true,i,"i",5,'./continue_test.js');
      ...
      for (i = 0;i;i ++ ){
        ...
        Runtime.assert(true,j,"j",11,'./continue_test.js');
      };
      
      __LINE__ = 13;
      Runtime.assert(true,i,"i",13,'./continue_test.js');
      
      __LINE__ = 14;
      Runtime.assert(true,i,"i",14,'./continue_test.js');
      
      __LINE__ = 15;
      Runtime.assert(true,i,"i",15,'./continue_test.js');
    } catch(e){
