!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 4;
      __Runtime.assert( true ,i === 10,"i === 10",4,'continue_test.js');
      
      __LINE__ = 5;
      __Runtime.assert( true ,i === 10,"i === 10",5,'continue_test.js');
      ...
      for (i = 0;i<10;i ++ ){
        ...
        __Runtime.assert( true ,j === 0,"j === 0",11,'continue_test.js');
      }
      
      __LINE__ = 13;
      __Runtime.assert( true ,i === 10,"i === 10",13,'continue_test.js');
      
      __LINE__ = 14;
      __Runtime.assert( true ,i === 10,"i === 10",14,'continue_test.js');
