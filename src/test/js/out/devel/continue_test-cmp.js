  ...
  !function () {
    try {
      var __FILE__ = "1653259312-continue_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-continue_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-continue_test.js'];
      ...
      __LINE__ = 4;
      Runtime/*Runtime*/.assert(true,i/*i*/ === 10,"i === 10",4,'continue_test.js');
      
      __LINE__ = 5;
      Runtime/*Runtime*/.assert(true,i/*i*/ === 10,"i === 10",5,'continue_test.js');
      ...
      for (i/*i*/ = 0;i/*i*/<10;i/*i*/ ++ ){
        ...
        END : {
          ...
          __LINE__ = 8;
          for (var j/*j*/ = 0;j/*j*/<5;j/*j*/ ++ ){
            __LINE__ = 9;
            break END;
          }
          
        }__LINE__ = 11;
        Runtime/*Runtime*/.assert(true,j/*j*/ === 0,"j === 0",11,'continue_test.js');
      }
      
      __LINE__ = 13;
      Runtime/*Runtime*/.assert(true,i/*i*/ === 10,"i === 10",13,'continue_test.js');
      
      __LINE__ = 14;
      Runtime/*Runtime*/.assert(true,i/*i*/ === 10,"i === 10",14,'continue_test.js');
      
      __LINE__ = 15;
      Runtime/*Runtime*/.assert(true,i/*i*/ === 10,"i === 10",15,'continue_test.js');
    } catch(e){
