!function() {
  ...
  !function () {
    try {
      var __FILE__ = "1653259312-for_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-for_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-for_test.js'],
          target/*target*/ = ['a','b','c','d','e','f','g','h','i','j'],
          arr/*arr*/ = [];
      
      __LINE__ = 3;
      for (var i/*i*/ = 0;i/*i*/<10;i/*i*/ ++ ){
        
        __LINE__ = 4;
        arr/*arr*/.push(target/*target*/[i/*i*/]);
      }
      
      __LINE__ = 6;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[0] === 'a',"arr[0] === 'a'",6,'for_test.js');
      
      __LINE__ = 7;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[1] === 'b',"arr[1] === 'b'",7,'for_test.js');
      
      __LINE__ = 8;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[2] === 'c',"arr[2] === 'c'",8,'for_test.js');
      
      __LINE__ = 9;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[3] === 'd',"arr[3] === 'd'",9,'for_test.js');
      
      __LINE__ = 10;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[4] === 'e',"arr[4] === 'e'",10,'for_test.js');
      
      __LINE__ = 11;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[5] === 'f',"arr[5] === 'f'",11,'for_test.js');
      
      __LINE__ = 12;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[6] === 'g',"arr[6] === 'g'",12,'for_test.js');
      
      __LINE__ = 13;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[7] === 'h',"arr[7] === 'h'",13,'for_test.js');
      
      __LINE__ = 14;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[8] === 'i',"arr[8] === 'i'",14,'for_test.js');
      
      __LINE__ = 15;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[9] === 'j',"arr[9] === 'j'",15,'for_test.js');
      
      __LINE__ = 17;
      arr/*arr*/ = [];
      
      __LINE__ = 18;
      for (i/*i*/ = 0;i/*i*/<10;i/*i*/ ++ ){
        __LINE__ = 19;
        arr/*arr*/.push(target/*target*/[i/*i*/]);
      }
      
      __LINE__ = 21;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[0] === 'a',"arr[0] === 'a'",21,'for_test.js');
      
      __LINE__ = 22;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[1] === 'b',"arr[1] === 'b'",22,'for_test.js');
      
      __LINE__ = 23;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[2] === 'c',"arr[2] === 'c'",23,'for_test.js');
      
      __LINE__ = 24;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[3] === 'd',"arr[3] === 'd'",24,'for_test.js');
      
      __LINE__ = 25;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[4] === 'e',"arr[4] === 'e'",25,'for_test.js');
      
      __LINE__ = 26;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[5] === 'f',"arr[5] === 'f'",26,'for_test.js');
      
      __LINE__ = 27;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[6] === 'g',"arr[6] === 'g'",27,'for_test.js');
      
      __LINE__ = 28;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[7] === 'h',"arr[7] === 'h'",28,'for_test.js');
      
      __LINE__ = 29;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[8] === 'i',"arr[8] === 'i'",29,'for_test.js');
      
      __LINE__ = 30;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[9] === 'j',"arr[9] === 'j'",30,'for_test.js');
      ...
      __LINE__ = 38;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[0] === 'a',"arr[0] === 'a'",38,'for_test.js');
      
      __LINE__ = 39;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[1] === 'b',"arr[1] === 'b'",39,'for_test.js');
      
      __LINE__ = 40;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[2] === 'c',"arr[2] === 'c'",40,'for_test.js');
      
      __LINE__ = 41;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[3] === 'd',"arr[3] === 'd'",41,'for_test.js');
      
      __LINE__ = 42;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[4] === 'e',"arr[4] === 'e'",42,'for_test.js');
      
      __LINE__ = 43;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[5] === 'f',"arr[5] === 'f'",43,'for_test.js');
      
      __LINE__ = 44;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[6] === 'g',"arr[6] === 'g'",44,'for_test.js');
      
      __LINE__ = 45;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[7] === 'h',"arr[7] === 'h'",45,'for_test.js');
      
      __LINE__ = 46;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[8] === 'i',"arr[8] === 'i'",46,'for_test.js');
      
      __LINE__ = 47;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[9] === 'j',"arr[9] === 'j'",47,'for_test.js');
      ...
      __LINE__ = 54;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[0] === 'a',"arr[0] === 'a'",54,'for_test.js');
      
      __LINE__ = 55;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[1] === 'b',"arr[1] === 'b'",55,'for_test.js');
      
      __LINE__ = 56;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[2] === 'c',"arr[2] === 'c'",56,'for_test.js');
      
      __LINE__ = 57;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[3] === 'd',"arr[3] === 'd'",57,'for_test.js');
      
      __LINE__ = 58;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[4] === 'e',"arr[4] === 'e'",58,'for_test.js');
      
      __LINE__ = 59;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[5] === 'f',"arr[5] === 'f'",59,'for_test.js');
      
      __LINE__ = 60;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[6] === 'g',"arr[6] === 'g'",60,'for_test.js');
      
      __LINE__ = 61;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[7] === 'h',"arr[7] === 'h'",61,'for_test.js');
      
      __LINE__ = 62;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[8] === 'i',"arr[8] === 'i'",62,'for_test.js');
      
      __LINE__ = 63;
      Runtime/*Runtime*/.assert(true,arr/*arr*/[9] === 'j',"arr[9] === 'j'",63,'for_test.js');
    } catch(e){
