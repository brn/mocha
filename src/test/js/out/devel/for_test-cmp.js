!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 6;
      Runtime.assert(true,arr[0],"arr[0]",6,'./for_test.js');
      
      __LINE__ = 7;
      Runtime.assert(true,arr[1],"arr[1]",7,'./for_test.js');
      
      __LINE__ = 8;
      Runtime.assert(true,arr[2],"arr[2]",8,'./for_test.js');
      
      __LINE__ = 9;
      Runtime.assert(true,arr[3],"arr[3]",9,'./for_test.js');
      
      __LINE__ = 10;
      Runtime.assert(true,arr[4],"arr[4]",10,'./for_test.js');
      
      __LINE__ = 11;
      Runtime.assert(true,arr[5],"arr[5]",11,'./for_test.js');
      
      __LINE__ = 12;
      Runtime.assert(true,arr[6],"arr[6]",12,'./for_test.js');
      
      __LINE__ = 13;
      Runtime.assert(true,arr[7],"arr[7]",13,'./for_test.js');
      
      __LINE__ = 14;
      Runtime.assert(true,arr[8],"arr[8]",14,'./for_test.js');
      
      __LINE__ = 15;
      Runtime.assert(true,arr[9],"arr[9]",15,'./for_test.js');
      ...
      __LINE__ = 21;
      Runtime.assert(true,arr[0],"arr[0]",21,'./for_test.js');
      
      __LINE__ = 22;
      Runtime.assert(true,arr[1],"arr[1]",22,'./for_test.js');
      
      __LINE__ = 23;
      Runtime.assert(true,arr[2],"arr[2]",23,'./for_test.js');
      
      __LINE__ = 24;
      Runtime.assert(true,arr[3],"arr[3]",24,'./for_test.js');
      
      __LINE__ = 25;
      Runtime.assert(true,arr[4],"arr[4]",25,'./for_test.js');
      
      __LINE__ = 26;
      Runtime.assert(true,arr[5],"arr[5]",26,'./for_test.js');
      
      __LINE__ = 27;
      Runtime.assert(true,arr[6],"arr[6]",27,'./for_test.js');
      
      __LINE__ = 28;
      Runtime.assert(true,arr[7],"arr[7]",28,'./for_test.js');
      
      __LINE__ = 29;
      Runtime.assert(true,arr[8],"arr[8]",29,'./for_test.js');
      
      __LINE__ = 30;
      Runtime.assert(true,arr[9],"arr[9]",30,'./for_test.js');
      ...
      __LINE__ = 38;
      Runtime.assert(true,arr[0],"arr[0]",38,'./for_test.js');
      
      __LINE__ = 39;
      Runtime.assert(true,arr[1],"arr[1]",39,'./for_test.js');
      
      __LINE__ = 40;
      Runtime.assert(true,arr[2],"arr[2]",40,'./for_test.js');
      
      __LINE__ = 41;
      Runtime.assert(true,arr[3],"arr[3]",41,'./for_test.js');
      
      __LINE__ = 42;
      Runtime.assert(true,arr[4],"arr[4]",42,'./for_test.js');
      
      __LINE__ = 43;
      Runtime.assert(true,arr[5],"arr[5]",43,'./for_test.js');
      
      __LINE__ = 44;
      Runtime.assert(true,arr[6],"arr[6]",44,'./for_test.js');
      
      __LINE__ = 45;
      Runtime.assert(true,arr[7],"arr[7]",45,'./for_test.js');
      
      __LINE__ = 46;
      Runtime.assert(true,arr[8],"arr[8]",46,'./for_test.js');
      
      __LINE__ = 47;
      Runtime.assert(true,arr[9],"arr[9]",47,'./for_test.js');
      ...
      __LINE__ = 54;
      Runtime.assert(true,arr[0],"arr[0]",54,'./for_test.js');
      
      __LINE__ = 55;
      Runtime.assert(true,arr[1],"arr[1]",55,'./for_test.js');
      
      __LINE__ = 56;
      Runtime.assert(true,arr[2],"arr[2]",56,'./for_test.js');
      
      __LINE__ = 57;
      Runtime.assert(true,arr[3],"arr[3]",57,'./for_test.js');
      
      __LINE__ = 58;
      Runtime.assert(true,arr[4],"arr[4]",58,'./for_test.js');
      
      __LINE__ = 59;
      Runtime.assert(true,arr[5],"arr[5]",59,'./for_test.js');
      
      __LINE__ = 60;
      Runtime.assert(true,arr[6],"arr[6]",60,'./for_test.js');
      
      __LINE__ = 61;
      Runtime.assert(true,arr[7],"arr[7]",61,'./for_test.js');
      
      __LINE__ = 62;
      Runtime.assert(true,arr[8],"arr[8]",62,'./for_test.js');
      
      __LINE__ = 63;
      Runtime.assert(true,arr[9],"arr[9]",63,'./for_test.js');
    } catch(e){
