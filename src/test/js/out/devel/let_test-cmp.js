  ...
  !function () {
    try {
      var __FILE__ = "-759650552-let_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-let_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-let_test.js'],
          x/*x*/ = 0,
          ret/*ret*/ = [];
      ...
      __LINE__ = 10;
      ret/*ret*/.forEach(function (item/*item*/,index/*index*/) {
        try {
          
          __LINE__ = 11;
          Runtime/*Runtime*/.assert(true,item/*item*/() === index/*index*/,"item() === index",11,'let_test.js');
        } catch(e){
          Runtime.exceptionHandler(__LINE__, __FILE__, e);
        }
      });
