!function() {
  ...
  !function () {
    try {
      var __FILE__ = "Y:/mocha/src/test/js/harmony/let_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport['./let_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias = _mochaGlobalExport['./let_test.js'],
          x = 0,
          ret = [];
      ...
      ret.forEach(function (item,index) {
        try {
          ...
          __LINE__ = 11;
          Runtime.assert(true,item(),"item()",11,'./let_test.js');
        } catch(e){
          Runtime.exceptionHandler(__LINE__, __FILE__, e);
        }
      });
