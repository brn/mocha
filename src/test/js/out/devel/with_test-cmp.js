!function() {
  ...
  !function () {
    try {
      ...
      with (testvalue){
        __LINE__ = 3;
        Runtime.assert(true,prop,"prop",3,'./with_test.js');
      };
      ...
      __LINE__ = 13;
      Runtime.assert(true,ret[0](),"ret[0]()",13,'./with_test.js');
      
      __LINE__ = 14;
      Runtime.assert(true,ret[1](),"ret[1]()",14,'./with_test.js');
      
      __LINE__ = 15;
      Runtime.assert(true,ret[2](),"ret[2]()",15,'./with_test.js');
      
      __LINE__ = 16;
      Runtime.assert(true,ret[3](),"ret[3]()",16,'./with_test.js');
      
      __LINE__ = 17;
      Runtime.assert(true,ret[4](),"ret[4]()",17,'./with_test.js');
      
      __LINE__ = 18;
      Runtime.assert(true,ret[5](),"ret[5]()",18,'./with_test.js');
      
      __LINE__ = 19;
      Runtime.assert(true,ret[6](),"ret[6]()",19,'./with_test.js');
      
      __LINE__ = 20;
      Runtime.assert(true,ret[7](),"ret[7]()",20,'./with_test.js');
      
      __LINE__ = 21;
      Runtime.assert(true,ret[8](),"ret[8]()",21,'./with_test.js');
      
      __LINE__ = 22;
      Runtime.assert(true,ret[9](),"ret[9]()",22,'./with_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
