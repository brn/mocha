!function() {
  ...
  !function () {
    try {
      ...
      with (testvalue){
        __LINE__ = 3;
        __Runtime.assert( true ,prop === 200,"prop === 200",3,'with_test.js');
      }
      ...
      __LINE__ = 13;
      __Runtime.assert( true ,ret[0]() === 0,"ret[0]() === 0",13,'with_test.js');
      
      __LINE__ = 14;
      __Runtime.assert( true ,ret[1]() === 1,"ret[1]() === 1",14,'with_test.js');
      
      __LINE__ = 15;
      __Runtime.assert( true ,ret[2]() === 2,"ret[2]() === 2",15,'with_test.js');
      
      __LINE__ = 16;
      __Runtime.assert( true ,ret[3]() === 3,"ret[3]() === 3",16,'with_test.js');
      
      __LINE__ = 17;
      __Runtime.assert( true ,ret[4]() === 4,"ret[4]() === 4",17,'with_test.js');
      
      __LINE__ = 18;
      __Runtime.assert( true ,ret[5]() === 5,"ret[5]() === 5",18,'with_test.js');
      
      __LINE__ = 19;
      __Runtime.assert( true ,ret[6]() === 6,"ret[6]() === 6",19,'with_test.js');
      
      __LINE__ = 20;
      __Runtime.assert( true ,ret[7]() === 7,"ret[7]() === 7",20,'with_test.js');
      
      __LINE__ = 21;
      __Runtime.assert( true ,ret[8]() === 8,"ret[8]() === 8",21,'with_test.js');
