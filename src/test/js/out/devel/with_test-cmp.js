  ...
  !function () {
    try {
      var __FILE__ = "1653259312-with_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-with_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-with_test.js'],
          testvalue/*testvalue*/ =  {
            prop : 200
          };
      
      __LINE__ = 2;
      with (testvalue/*testvalue*/){
        __LINE__ = 3;
        Runtime/*Runtime*/.assert(true,prop === 200,"prop === 200",3,'with_test.js');
      }
      ...
      __LINE__ = 13;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[0]() === 0,"ret[0]() === 0",13,'with_test.js');
      
      __LINE__ = 14;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[1]() === 1,"ret[1]() === 1",14,'with_test.js');
      
      __LINE__ = 15;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[2]() === 2,"ret[2]() === 2",15,'with_test.js');
      
      __LINE__ = 16;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[3]() === 3,"ret[3]() === 3",16,'with_test.js');
      
      __LINE__ = 17;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[4]() === 4,"ret[4]() === 4",17,'with_test.js');
      
      __LINE__ = 18;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[5]() === 5,"ret[5]() === 5",18,'with_test.js');
      
      __LINE__ = 19;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[6]() === 6,"ret[6]() === 6",19,'with_test.js');
      
      __LINE__ = 20;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[7]() === 7,"ret[7]() === 7",20,'with_test.js');
      
      __LINE__ = 21;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[8]() === 8,"ret[8]() === 8",21,'with_test.js');
      
      __LINE__ = 22;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[9]() === 9,"ret[9]() === 9",22,'with_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
