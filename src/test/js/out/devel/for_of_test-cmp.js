  ...
  !function () {
    try {
      var __FILE__ = "-759650552-for_of_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-for_of_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-for_of_test.js'],
          _mochaLocalTmp0/*_mochaLocalTmp0*/ = _mochaGlobalExport/*_mochaGlobalExport*/.iterators,
          iterator/*iterator*/ = _mochaLocalTmp0/*_mochaLocalTmp0*/.iterator,
          _mochaLocalTmp9/*_mochaLocalTmp9*/ =  {
            arr : [],
      ...
      __LINE__ = 21;
      Runtime/*Runtime*/.createUnenumProp(_mochaLocalTmp9/*_mochaLocalTmp9*/,iterator/*iterator*/,
      function () {
        try {
          __LINE__ = 26;
          ...
          return  {
            ...
            next : function () {
              try {
                __LINE__ = 30;
                if (arr/*arr*/.length>this.index){
                  
                  __LINE__ = 31;
                  var ret/*ret*/ = arr/*arr*/[this.index];
      ...
      __LINE__ = 2;
      var item/*item*/ = function (obj/*obj*/) {
            try {
              __LINE__ = 4;
              var _mochaLocalTmp4/*_mochaLocalTmp4*/ = {};
              
              __LINE__ = 4;
              Runtime/*Runtime*/.createUnenumProp(_mochaLocalTmp4/*_mochaLocalTmp4*/,iterator/*iterator*/,
              function () {
                try {
                  __LINE__ = 4;
                  var _mochaIsNewBorn/*_mochaIsNewBorn*/ = true,
                      ...
                      _yieldState/*_yieldState*/ = 0,
                      length/*length*/,
                      _mochaLocalTmp3/*_mochaLocalTmp3*/,
                      i/*i*/,
                      _mochaLocalTmp2/*_mochaLocalTmp2*/ = [],
                      _mochaGenerator/*_mochaGenerator*/ = function (_isYieldSend/*_isYieldSend*/,_isYieldSafe/*_isYieldSafe*/) {
                        try {
                          ...
                          while (1){
                            ...
                            switch (_yieldState/*_yieldState*/) {
                              case 0 :
                                ...
                                __LINE__ = 5;
                                for (var _mochaLocalTmp1/*_mochaLocalTmp1*/ in obj/*obj*/){
                                  
                                  __LINE__ = 5;
                                  _mochaLocalTmp2/*_mochaLocalTmp2*/.push(_mochaLocalTmp1/*_mochaLocalTmp1*/);
                                }
                                
                                __LINE__ = 5;
                                _mochaLocalTmp3/*_mochaLocalTmp3*/ = 0;
                                
                                __LINE__ = 5;
                                length/*length*/ = _mochaLocalTmp2/*_mochaLocalTmp2*/.length;
                                
                                __LINE__ = 5;
                                if (!(_mochaLocalTmp3/*_mochaLocalTmp3*/<length/*length*/)){
                              ...
                              case 1 :
                                ...
                                __LINE__ = 5;
                                i/*i*/ = _mochaLocalTmp2/*_mochaLocalTmp2*/[_mochaLocalTmp3/*_mochaLocalTmp3*/];
              ...
              __LINE__ = 3;
              return _mochaLocalTmp4/*_mochaLocalTmp4*/;
            } catch(e){
              Runtime.exceptionHandler(__LINE__, __FILE__, e);
            }
          },
          key/*key*/ = function (obj/*obj*/) {
            try {
              __LINE__ = 13;
              var _mochaLocalTmp8/*_mochaLocalTmp8*/ = {};
              
              __LINE__ = 13;
              Runtime/*Runtime*/.createUnenumProp(_mochaLocalTmp8/*_mochaLocalTmp8*/,iterator/*iterator*/,
              function () {
                try {
                  __LINE__ = 13;
                  var _mochaIsNewBorn/*_mochaIsNewBorn*/ = true,
                          ...
                          while (1){
                            ...
                            switch (_yieldState/*_yieldState*/) {
                              ...
                              case 1 :
                                ...
                                __LINE__ = 14;
                                i/*i*/ = _mochaLocalTmp6/*_mochaLocalTmp6*/[_mochaLocalTmp7/*_mochaLocalTmp7*/];
                                __LINE__ = 15;
                                return i/*i*/;
                              case 2 :
              ...
              __LINE__ = 12;
              return _mochaLocalTmp8/*_mochaLocalTmp8*/;
            } catch(e){
              Runtime.exceptionHandler(__LINE__, __FILE__, e);
            }
          },
          iter/*iter*/ = _mochaLocalTmp9/*_mochaLocalTmp9*/,
          testObj/*testObj*/ =  {
            value1 : 100,
            value2 : 200,
            value3 : 300,
          ...
          ret/*ret*/ = [],
          i/*i*/,
          _mochaLocalTmp10/*_mochaLocalTmp10*/ = item/*item*/(testObj/*testObj*/);
      
      __LINE__ = 49;
      _mochaLocalTmp10/*_mochaLocalTmp10*/ = Runtime/*Runtime*/.hasIterator(_mochaLocalTmp10/*_mochaLocalTmp10*/)?Runtime/*Runtime*/.getIterator(_mochaLocalTmp10/*_mochaLocalTmp10*/) : _mochaLocalTmp10/*_mochaLocalTmp10*/;
      
      __LINE__ = 49;
      if (_mochaLocalTmp10/*_mochaLocalTmp10*/.__nothrowNext__){
        __LINE__ = 49;
        while ((i/*i*/ = _mochaLocalTmp10/*_mochaLocalTmp10*/.__nothrowNext__())){
          __LINE__ = 50;
          ret/*ret*/.push(i/*i*/);
        }
        ...
        __LINE__ = 49;
        Runtime/*Runtime*/.exceptionHandler(49,'..///Users/aono_taketoshi/github/mocha/src/test/js/harmony/for_of_test.js','for of statement expect iterator or generator object.');
      }
      
      __LINE__ = 52;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[0] === 100,"ret[0] === 100",52,'for_of_test.js');
      
      __LINE__ = 53;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[1] === 200,"ret[1] === 200",53,'for_of_test.js');
      
      __LINE__ = 54;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[2] === 300,"ret[2] === 300",54,'for_of_test.js');
      
      __LINE__ = 55;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[3] === 400,"ret[3] === 400",55,'for_of_test.js');
      ...
      __LINE__ = 58;
      var x/*x*/,
          _mochaLocalTmp11/*_mochaLocalTmp11*/ = key/*key*/(testObj/*testObj*/);
      
      __LINE__ = 58;
      _mochaLocalTmp11/*_mochaLocalTmp11*/ = Runtime/*Runtime*/.hasIterator(_mochaLocalTmp11/*_mochaLocalTmp11*/)?Runtime/*Runtime*/.getIterator(_mochaLocalTmp11/*_mochaLocalTmp11*/) : _mochaLocalTmp11/*_mochaLocalTmp11*/;
      
      __LINE__ = 58;
      if (_mochaLocalTmp11/*_mochaLocalTmp11*/.__nothrowNext__){
        __LINE__ = 58;
        while ((x/*x*/ = _mochaLocalTmp11/*_mochaLocalTmp11*/.__nothrowNext__())){
          __LINE__ = 59;
          ret/*ret*/.push(x/*x*/);
        }
        ...
        __LINE__ = 58;
        Runtime/*Runtime*/.exceptionHandler(58,'..///Users/aono_taketoshi/github/mocha/src/test/js/harmony/for_of_test.js','for of statement expect iterator or generator object.');
      }
      
      __LINE__ = 61;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[0] === "value1","ret[0] === \"value1\"",61,'for_of_test.js');
      
      __LINE__ = 62;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[1] === "value2","ret[1] === \"value2\"",62,'for_of_test.js');
      
      __LINE__ = 63;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[2] === "value3","ret[2] === \"value3\"",63,'for_of_test.js');
      
      __LINE__ = 64;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[3] === "value4","ret[3] === \"value4\"",64,'for_of_test.js');
      ...
      __LINE__ = 71;
      var _mochaLocalTmp12/*_mochaLocalTmp12*/ = iter/*iter*/;
      ...
      if (_mochaLocalTmp12/*_mochaLocalTmp12*/.__nothrowNext__){
        __LINE__ = 71;
        while ((i/*i*/ = _mochaLocalTmp12/*_mochaLocalTmp12*/.__nothrowNext__())){
          __LINE__ = 72;
          ret/*ret*/.push(i/*i*/);
        }
        ...
        __LINE__ = 71;
        Runtime/*Runtime*/.exceptionHandler(71,'..///Users/aono_taketoshi/github/mocha/src/test/js/harmony/for_of_test.js','for of statement expect iterator or generator object.');
      }
      
      __LINE__ = 74;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[0] === 100,"ret[0] === 100",74,'for_of_test.js');
      
      __LINE__ = 75;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[1] === 200,"ret[1] === 200",75,'for_of_test.js');
      
      __LINE__ = 76;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[2] === 300,"ret[2] === 300",76,'for_of_test.js');
      
      __LINE__ = 77;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[3] === 400,"ret[3] === 400",77,'for_of_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
