!function() {
  ...
  !function () {
    ...
    var e = c.iterators,
        d = e.iterators = function () {
            ...
            function () {
              return function () {
                var h = true,
                    ...
                    f = [],
                    i = function (k,j) {
                      !k?h = false : k && h && arguments[1] !== undefined && a.exceptionHandler('attempt to send to newborn generator.');
            ...
            function () {
              return function () {
                var f = true,
                    ...
                    h = [],
                    i = function (k,j) {
                      !k?f = false : k && f && arguments[1] !== undefined && a.exceptionHandler('attempt to send to newborn generator.');
            ...
            function () {
              return function () {
                var h = true,
                    ...
                    i = [],
                    j = function (l,k) {
                      !l?h = false : l && h && arguments[1] !== undefined && a.exceptionHandler('attempt to send to newborn generator.');
            ...
            function () {
              return function () {
                var i = true,
                    ...
                    g = [],
                    j = function (l,k) {
                      !l?i = false : l && i && arguments[1] !== undefined && a.exceptionHandler('attempt to send to newborn generator.');
          ...
          var j = {},
              c = {}.hasOwnProperty,
              b = j.iterator = "__mocha_iterator_special_key__";
  ...
  !function () {
    c['-759650552-for_of_test.js'] = {};
    
    var p = c['-759650552-for_of_test.js'],
        o = c.iterators.iterators,
        e = o.iterator,
        m =  {
          arr : [],
          add : function (a) {
    ...
    a.createUnenumProp(m,e,
    function () {
      var a = this.arr;
      return  {
        index : 0,
        next : function () {
          if (a.length>this.index){
    ...
    n = a.hasIterator(n)?a.getIterator(n) : n;
    
    if (n.__nothrowNext__)while ((d = n.__nothrowNext__()))b.push(d);
     else a.exceptionHandler(49,'for_of_test.js','for of statement expect iterator or generator object.');
    ...
    j = a.hasIterator(j)?a.getIterator(j) : j;
    
    if (j.__nothrowNext__)while ((g = j.__nothrowNext__()))b.push(g);
     else a.exceptionHandler(58,'for_of_test.js','for of statement expect iterator or generator object.');
    ...
    if (f.__nothrowNext__)while ((d = f.__nothrowNext__()))b.push(d);
     else a.exceptionHandler(71,'for_of_test.js','for of statement expect iterator or generator object.');
  }();
}();
