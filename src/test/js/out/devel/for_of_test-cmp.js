!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 52;
      Runtime.assert(true,ret[0],"ret[0]",52,'./for_of_test.js');
      
      __LINE__ = 53;
      Runtime.assert(true,ret[1],"ret[1]",53,'./for_of_test.js');
      
      __LINE__ = 54;
      Runtime.assert(true,ret[2],"ret[2]",54,'./for_of_test.js');
      
      __LINE__ = 55;
      Runtime.assert(true,ret[3],"ret[3]",55,'./for_of_test.js');
      ...
      __LINE__ = 61;
      Runtime.assert(true,ret[0],"ret[0]",61,'./for_of_test.js');
      
      __LINE__ = 62;
      Runtime.assert(true,ret[1],"ret[1]",62,'./for_of_test.js');
      
      __LINE__ = 63;
      Runtime.assert(true,ret[2],"ret[2]",63,'./for_of_test.js');
      
      __LINE__ = 64;
      Runtime.assert(true,ret[3],"ret[3]",64,'./for_of_test.js');
      ...
      __LINE__ = 74;
      Runtime.assert(true,ret[0],"ret[0]",74,'./for_of_test.js');
      
      __LINE__ = 75;
      Runtime.assert(true,ret[1],"ret[1]",75,'./for_of_test.js');
      
      __LINE__ = 76;
      Runtime.assert(true,ret[2],"ret[2]",76,'./for_of_test.js');
      
      __LINE__ = 77;
      Runtime.assert(true,ret[3],"ret[3]",77,'./for_of_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
