!function() {
  ...
  !function () {
    c['-759650552-class_test.js'] = {};
    
    var u = c['-759650552-class_test.js'],
        l = function () {
          function b(c,b) {
            this.name = c;
          ...
          function d() {
            a.initializeClass(this,d,c,b,arguments,'Monster',1);
          }
          var c = function (){};
          
          a.createUnenumProp(b,"__harmony_class__",1);
          
          d.prototype.attack = function (a) {
            log('The monster attacks '+a);
          };
          
          d.prototype.isAlive = function () {
            return a.getPrivateRecord(this).health>0;
          };
          
          d.prototype.health = function (b) {
            if (b<0)throw new Error('Health must be non-negative.');
          ...
          a.constant(d.prototype,'attackMessage','The monster hits you!');
          
          a.constant(d,'DEFAULT_LIFE',100);
          
          a.createUnenumProp(d.prototype,"constructor",b);
          return d;
        }(),
        r = new l("slime",100);
    ...
    var b = function () {
          function b(d,c,b) {
            a.getPrivateRecord(this).name = d || "foo";
            
            a.getPrivateRecord(this).addr = c || "tokyo";
            
            a.getPrivateRecord(this).age = b;
          }
          function d() {
            a.initializeClass(this,d,c,b,arguments,'BaseTest',52);
          }
          var c = function (){};
          ...
          d.prototype.getName = function () {
            return a.getPrivateRecord(this).name;
          };
        ...
        d = function () {
          ...
          function e() {
            a.initializeClass(this,e,d,c,arguments,'DeriveTest',57);
          }
          var d = function (){};
          ...
          a.createUnenumProp(c,"__harmony_class__",1);
          
          e.prototype.getName = function () {
            return f.getName.call(this);
          };
          
          a.createUnenumProp(e.prototype,"constructor",c);
          return e;
        }(),
        k = function () {
          function b() {
          ...
          function e() {
            a.initializeClass(this,e,c,b,arguments,'Derive2',63);
          }
          var c = function (){};
          ...
          e.prototype.getAddr = function () {
            return a.getPrivateRecord(this).addr;
          };
          
          a.createUnenumProp(e.prototype,"constructor",b);
          return e;
        }(),
        h = function () {
          function c() {
            f.constructor.call(this,200,'tokyo',20);
          }
          function e() {
            a.initializeClass(this,e,d,c,arguments,'Drive3',69);
          }
          var d = function (){};
          
          var g = b;
          
          a.extendPrototype(e,g);
        ...
        j = function () {
          function b(c,b) {
            a.getPrivateRecord(this)._name = c || "test";
            
            a.getPrivateRecord(this)._age = b || 20;
            
            this.testProp = 1;
          }
          function d() {
            a.initializeClass(this,d,c,b,arguments,'_mochaLocalTmp6',75);
          }
          var c = function (){};
          ...
          d.prototype.getAge = function () {
            return a.getPrivateRecord(this)._age;
          };
          
          d.prototype.ptest = function () {
            return a.getPrivateRecord(this).test();
          };
          
          c.prototype.Inner = function () {
            function b(){}
            function d() {
              a.initializeClass(this,d,c,b,arguments,'Inner',82);
            }
            var c = function (){};
          ...
          c.prototype.test = function () {
            return a.getInstanceBody(this).testProp;
          };
    ...
    var e =  {
        ...
        m = function () {
          function b(){}
          function d() {
            a.initializeClass(this,d,c,b,arguments,'MixinTest',106);
          }
          var c = function (){};
          
          a.createUnenumProp(b,"__harmony_class__",1);
          
          d.prototype.doTestm1 = function () {
            return "aaa";
          };
          
          d.prototype.doTestm2 = function () {
            return "bbb";
          };
          ...
          a.checkRequirements(d,c,[e,f],'class_test.js',110);
    ...
    var t = function () {
          function c(c,b) {
            a.getPrivateRecord(this).width = c || 100;
            
            a.getPrivateRecord(this).height = b || 100;
          }
          function d() {
            a.initializeClass(this,d,b,c,arguments,'Box',117);
          }
          var b = function (){};
          ...
          b.prototype._type = e._type;
          
          b.prototype._max = e._max;
          
          a.createUnenumProp(d.prototype,"constructor",c);
          return d;
        }(),
        q = new t();
