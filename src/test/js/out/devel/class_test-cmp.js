          ...
          TestClass = function () {
            try {
              ...
              function _mochaLocalTmp5() {
                try {
                  __LINE__ = 0;
                  Runtime.initializeClass( this,_mochaLocalTmp5,_mochaPrivateHolder,constructor,arguments,'_mochaLocalTmp5','85' );
                } catch( e ){
                  Runtime.exceptionHandler( __LINE__ , __FILE__ , e );
                }
              }
              ...
              __LINE__ = 0;
              _mochaLocalTmp5.prototype.getName = function getName() {
                try {
                  __LINE__ = 0;
              ...
              __LINE__ = 0;
              _mochaLocalTmp5.prototype.getAge = function getAge() {
                try {
                  __LINE__ = 0;
              ...
              _mochaPrivateHolder.prototype.Inner = function () {
                try {
                  ...
                  function Inner() {
                    try {
                      __LINE__ = 0;
                      Runtime.initializeClass( this,Inner,_mochaPrivateHolder,constructor,arguments,'Inner','80' );
                    } catch( e ){
                      Runtime.exceptionHandler( __LINE__ , __FILE__ , e );
                    }
                  }
