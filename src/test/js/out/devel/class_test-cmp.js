!function() {
  ...
  !function () {
    try {
          ...
          Monster = function () {
            try {
              ...
              Monster.prototype.isAlive = function () {
                try {
                  __LINE__ = 23;
                  return Runtime.getPrivateRecord(this).health;
                } catch(e){
                  Runtime.exceptionHandler(__LINE__, __FILE__, e);
                }
              };
      ...
      __LINE__ = 85;
      Runtime.assert(true,new DeriveTest().getName(),"new DeriveTest().getName()",85,'./class_test.js');
      
      __LINE__ = 86;
      Runtime.assert(true,DeriveTest.getName(),"DeriveTest.getName()",86,'./class_test.js');
      
      __LINE__ = 87;
      Runtime.assert(true,new Derive2().getAddr(),"new Derive2().getAddr()",87,'./class_test.js');
      
      __LINE__ = 88;
      var instance = new TestClass();
      
      __LINE__ = 89;
      Runtime.assert(true,instance.getName(),"instance.getName()",89,'./class_test.js');
      
      __LINE__ = 90;
      Runtime.assert(true,instance.getAge(),"instance.getAge()",90,'./class_test.js');
      ...
      __LINE__ = 110;
      Runtime.assert(true,instance2.m1("foo"),"instance2.m1(\"foo\")",110,'./class_test.js');
      
      __LINE__ = 111;
      Runtime.assert(true,instance2.m2,"instance2.m2",111,'./class_test.js');
