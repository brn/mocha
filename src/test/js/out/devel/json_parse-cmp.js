  ...
  !function () {
    try {
      var __FILE__ = "-1426553882-json_parse.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-1426553882-json_parse.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-1426553882-json_parse.js'],
          json_parse/*json_parse*/ = (function () {
            try {
              ...
              var at/*at*/,
                  ...
                  next/*next*/ = function (c/*c*/) {
                    try {
                      __LINE__ = 95;
                      c/*c*/ && c/*c*/ !== ch/*ch*/ && error/*error*/("Expected '"+c/*c*/+"' instead of '"+ch/*ch*/+"'");
                      
                      __LINE__ = 101;
                      ch/*ch*/ = text/*text*/.charAt(at/*at*/);
                  ...
                  number/*number*/ = function () {
                    try {
                      ...
                      if (ch/*ch*/ === '.'){
                        ...
                        __LINE__ = 123;
                        while (next/*next*/() && ch/*ch*/ >= '0' && ch/*ch*/ <= '9'){
                          __LINE__ = 124;
                          string/*string*/ += ch/*ch*/;
                        }
                          ...
                          if (ch/*ch*/ === '"'){
                            ...
                            if (ch/*ch*/ === 'u'){
                              ...
                              for (i/*i*/ = 0;i/*i*/<4;i/*i*/ += 1){
                                ...
                                __LINE__ = 172;
                                uffff/*uffff*/ = uffff/*uffff*/*16+hex/*hex*/;
                              }
                              
                              __LINE__ = 174;
                              string/*string*/ += String.fromCharCode(uffff/*uffff*/);
                            } else if (typeof escapee/*escapee*/[ch/*ch*/] === 'string'){
                              __LINE__ = 176;
                              string/*string*/ += escapee/*escapee*/[ch/*ch*/];
                            } else {
                              __LINE__ = 178;
                              break;
                            }
                    ...
                    try {
                      ...
                      if (ch/*ch*/ === '{'){
                        ...
                        while (ch/*ch*/){
                          ...
                          __LINE__ = 273;
                          Object.hasOwnProperty.call(object/*object*/,key/*key*/) && error/*error*/('Duplicate key "'+key/*key*/+'"');
              ...
              value/*value*/ = function () {
                try {
                  ...
                  switch (ch/*ch*/) {
                    ...
                    default :
                      __LINE__ = 304;
                      return ch/*ch*/ >= '0' && ch/*ch*/ <= '9'?number/*number*/() : word/*word*/();
              ...
              __LINE__ = 311;
              return function (source/*source*/,reviver/*reviver*/) {
                try {
                  __LINE__ = 312;
                  var result/*result*/;
                  ...
                  __LINE__ = 320;
                  ch/*ch*/ && error/*error*/("Syntax error");
                  __LINE__ = 329;
                  return typeof reviver/*reviver*/ === 'function'?(function walk/*walk*/(holder/*holder*/,key/*key*/) {
                    try {
                      __LINE__ = 330;
                      var k/*k*/,
                          v/*v*/,
