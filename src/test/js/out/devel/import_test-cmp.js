  ...
  !function () {
    try {
      var __FILE__ = "-759650552-module_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-module_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-module_test.js'],
          testModule1/*testModule1*/ = _mochaGlobalAlias/*_mochaGlobalAlias*/.testModule1 = function () {
            try {
              function testExport1/*testExport1*/() {
                try {
                  __LINE__ = 4;
                  return 1;
                } catch(e){
              ...
              __LINE__ = 4;
              _mochaLocalExport/*_mochaLocalExport*/.testExport1 = testExport1/*testExport1*/;
              __LINE__ = 2;
              return _mochaLocalExport/*_mochaLocalExport*/;
            } catch(e){
              Runtime.exceptionHandler(__LINE__, __FILE__, e);
          ...
          testModule2/*testModule2*/ = _mochaGlobalAlias/*_mochaGlobalAlias*/.testModule2 = function () {
            try {
              __LINE__ = 8;
              var _mochaLocalExport/*_mochaLocalExport*/ = {},
                  testInnerModule3/*testInnerModule3*/ = _mochaLocalExport/*_mochaLocalExport*/.testInnerModule3 = function () {
                    try {
                      function testExport2/*testExport2*/() {
                        try {
                          __LINE__ = 10;
                          return 2;
                        } catch(e){
                      ...
                      __LINE__ = 10;
                      _mochaLocalExport/*_mochaLocalExport*/.testExport2 = testExport2/*testExport2*/;
                      
                      __LINE__ = 11;
                      var testExport3/*testExport3*/ = _mochaLocalExport/*_mochaLocalExport*/.testExport3 =  {
                            test : 200
                          };
                      __LINE__ = 9;
                      return _mochaLocalExport/*_mochaLocalExport*/;
      ...
      !function () {
        try {
          function testExport5/*testExport5*/() {
            try {
              __LINE__ = 19;
              return 4;
            } catch(e){
          ...
          var _mochaLocalExport/*_mochaLocalExport*/ = _mochaGlobalAlias/*_mochaGlobalAlias*/,
              testInnerModule4/*testInnerModule4*/ = _mochaLocalExport/*_mochaLocalExport*/.testInnerModule4 = function () {
                try {
                  function testExport4/*testExport4*/() {
                    try {
                      __LINE__ = 17;
                      return 3;
                    } catch(e){
                  ...
                  __LINE__ = 17;
                  _mochaLocalExport/*_mochaLocalExport*/.testExport4 = testExport4/*testExport4*/;
                  __LINE__ = 16;
                  return _mochaLocalExport/*_mochaLocalExport*/;
                } catch(e){
                  Runtime.exceptionHandler(__LINE__, __FILE__, e);
          ...
          __LINE__ = 19;
          _mochaLocalExport/*_mochaLocalExport*/.testExport5 = testExport5/*testExport5*/;
          __LINE__ = 15;
          return _mochaLocalExport/*_mochaLocalExport*/;
        } catch(e){
          Runtime.exceptionHandler(__LINE__, __FILE__, e);
  ...
  !function () {
    try {
      var __FILE__ = "-759650552-import_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-import_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-import_test.js'],
          _mochaLocalTmp0/*_mochaLocalTmp0*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-module_test.js'],
          testExport1/*testExport1*/ = _mochaLocalTmp0/*_mochaLocalTmp0*/.testModule1 && _mochaLocalTmp0/*_mochaLocalTmp0*/.testModule1.testExport1?_mochaLocalTmp0/*_mochaLocalTmp0*/.testModule1.testExport1 : undefined,
          testExport2/*testExport2*/ = _mochaLocalTmp0/*_mochaLocalTmp0*/.testModule2 && _mochaLocalTmp0/*_mochaLocalTmp0*/.testModule2.testInnerModule3 && _mochaLocalTmp0/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport2?_mochaLocalTmp0/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport2 : undefined,
          testExport3/*testExport3*/ = _mochaLocalTmp0/*_mochaLocalTmp0*/.testModule2 && _mochaLocalTmp0/*_mochaLocalTmp0*/.testModule2.testInnerModule3 && _mochaLocalTmp0/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport3?_mochaLocalTmp0/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport3 : undefined,
          testExport4/*testExport4*/ = _mochaLocalTmp0/*_mochaLocalTmp0*/.testInnerModule4 && _mochaLocalTmp0/*_mochaLocalTmp0*/.testInnerModule4.testExport4?_mochaLocalTmp0/*_mochaLocalTmp0*/.testInnerModule4.testExport4 : undefined,
          testExport5/*testExport5*/ = _mochaLocalTmp0/*_mochaLocalTmp0*/.testExport5;
      
      __LINE__ = 18;
      Runtime/*Runtime*/.assert(true,testExport1/*testExport1*/() === 1,"testExport1() === 1",18,'import_test.js');
      
      __LINE__ = 19;
      Runtime/*Runtime*/.assert(true,testExport2/*testExport2*/() === 2,"testExport2() === 2",19,'import_test.js');
      
      __LINE__ = 20;
      Runtime/*Runtime*/.assert(true,testExport3/*testExport3*/.test === 200,"testExport3.test === 200",20,'import_test.js');
      
      __LINE__ = 21;
      Runtime/*Runtime*/.assert(true,testExport4/*testExport4*/() === 3,"testExport4() === 3",21,'import_test.js');
      
      __LINE__ = 22;
      Runtime/*Runtime*/.assert(true,testExport5/*testExport5*/() === 4,"testExport5() === 4",22,'import_test.js');
      
      __LINE__ = 24;
      var testModule/*testModule*/ = _mochaGlobalAlias/*_mochaGlobalAlias*/.testModule = function () {
            try {
              function foo/*foo*/() {
                try {
                  __LINE__ = 25;
              ...
              __LINE__ = 25;
              _mochaLocalExport/*_mochaLocalExport*/.foo = foo/*foo*/;
              __LINE__ = 24;
              return _mochaLocalExport/*_mochaLocalExport*/;
            } catch(e){
              Runtime.exceptionHandler(__LINE__, __FILE__, e);
          ...
          _mochaLocalTmp1/*_mochaLocalTmp1*/ = testModule/*testModule*/,
          foo/*foo*/ = _mochaLocalTmp1/*_mochaLocalTmp1*/.foo;
      
      __LINE__ = 29;
      Runtime/*Runtime*/.assert(true,foo/*foo*/() === "ok","foo() === \"ok\"",29,'import_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
