!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 18;
      Runtime.assert(true,testExport1(),"testExport1()",18,'./import_test.js');
      
      __LINE__ = 19;
      Runtime.assert(true,testExport2(),"testExport2()",19,'./import_test.js');
      
      __LINE__ = 20;
      Runtime.assert(true,testExport3.test,"testExport3.test",20,'./import_test.js');
      
      __LINE__ = 21;
      Runtime.assert(true,testExport4(),"testExport4()",21,'./import_test.js');
      
      __LINE__ = 22;
      Runtime.assert(true,testExport5(),"testExport5()",22,'./import_test.js');
      ...
      __LINE__ = 29;
      Runtime.assert(true,foo(),"foo()",29,'./import_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
