    ...
    !function (window,undefined) {
      ...
      function ajaxConvert(s,response) {
        ...
        for (i = 1;i<length;i ++ ){
          ...
          if (i === 1)for (key in s.converters)typeof key === "string" && (converters[key.toLowerCase()] = s.converters[key]);
      ...
      function buildParams(prefix,obj,traditional,add) {
        ...
        function (i,v) {
         ...
         else if (!traditional && obj != null && typeof obj === "object")for (var name in obj)
      ...
      function cloneFixAttributes(src,dest) {
        ...
        } else nodeName === "option"?dest.selected = src.defaultSelected : nodeName === "input" || nodeName === "textarea" && (dest.defaultValue = src.defaultValue);
      ...
      function winnow(elements,qualifier,keep) {
        ...
        function (elem,i) {
         ...
         else if (qualifier.nodeType)return jQuery.grep(elements,
        function (elem,i) {
      ...
      jQuery.Callbacks = function (flags) {
        ...
        var list = [],
            ...
            fire = function (context,args) {
              ...
              if (list)if (!flags.once)if (stack && stack.length){
                
                memory = stack.shift();
                
                self.fireWith(memory[0],memory[1]);
              }
               else memory === true?self.disable() : list = [];
            },
            self =  {
              add : function () {
                if (list){
      ...
      !function () {
        ...
        var Sizzle = function (selector,context,results,seed) {
              ...
              if (toString.call(checkSet) === "[object Array]")if (!prune)results.push.apply(results,checkSet);
               else if (context && context.nodeType === 1)for (i = 0;checkSet[i] != null;i ++ )checkSet[i] && (checkSet[i] === true || checkSet[i].nodeType === 1 && Sizzle.contains(context,checkSet[i])) && results.push(set[i]);
               else for (i = 0;checkSet[i] != null;i ++ )checkSet[i] && checkSet[i].nodeType === 1 && results.push(set[i]);
        ...
        var getText = Sizzle.getText = function (elem) {
              ...
              if (nodeType)if (nodeType === 1 || nodeType === 9)if (typeof elem.textContent === 'string')return elem.textContent;
               ...
               else for (i = 0;(node = elem[i]);i ++ )node.nodeType !== 8 && (ret += getText(node));
              return ret;
            },
        ...
        try {
          ...
          makeArray = function (array,results) {
            ...
            if (toString.call(array) === "[object Array]")[].push.apply(ret,array);
              ...
              if (typeof array.length === "number")for (var l = array.length;i<l;i ++ )
              ret.push(array[i]);
