!function() {
  ...
  !function () {
    c['-759650552-array_comprehensions_test.js'] = {};
    
    var h = c['-759650552-array_comprehensions_test.js'],
        g = c.iterators.iterators,
        d = g.items,
        b =  {
          value1 : 100,
          value2 : 200,
    ...
    f = function () {
      ...
      e = a.hasIterator(e)?a.getIterator(e) : e;
      
      if (e.__nothrowNext__)while ((f = e.__nothrowNext__()))g.push(f);
       else a.exceptionHandler(19,'array_comprehensions_test.js','for of statement expect iterator or generator object.');
      return g;
    }.call(this);
    ...
    f = function () {
      ...
      c = a.hasIterator(c)?a.getIterator(c) : c;
      
      if (c.__nothrowNext__)while ((e = c.__nothrowNext__()))e[1] === 200 && f.push(e);
       else a.exceptionHandler(34,'array_comprehensions_test.js','for of statement expect iterator or generator object.');
      return f;
    }.call(this);
    ...
    f = function () {
      ...
      for (var e in b){
        ...
        if (c.__nothrowNext__)while ((f = c.__nothrowNext__()))g.push(f);
         else a.exceptionHandler(54,'array_comprehensions_test.js','for of statement expect iterator or generator object.');
      }
      return g;
    }.call(this);
