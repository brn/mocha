  ...
  !function () {
    try {
      var __FILE__ = "1653259312-switch_test.js",
          __LINE__ = 0;
      function switchTest/*switchTest*/(type/*type*/) {
        try {
          __LINE__ = 3;
          var ret/*ret*/ = 0;
      ...
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-switch_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-switch_test.js'];
      
      __LINE__ = 35;
      Runtime/*Runtime*/.assert(true,switchTest/*switchTest*/(1) === 1,"switchTest(1) === 1",35,'switch_test.js');
      
      __LINE__ = 36;
      Runtime/*Runtime*/.assert(true,switchTest/*switchTest*/(2) === 100,"switchTest(2) === 100",36,'switch_test.js');
      
      __LINE__ = 37;
      Runtime/*Runtime*/.assert(true,switchTest/*switchTest*/(3) === 1,"switchTest(3) === 1",37,'switch_test.js');
      
      __LINE__ = 38;
      Runtime/*Runtime*/.assert(true,switchTest/*switchTest*/(4) === 1,"switchTest(4) === 1",38,'switch_test.js');
      
      __LINE__ = 39;
      Runtime/*Runtime*/.assert(true,switchTest/*switchTest*/(5) === 1,"switchTest(5) === 1",39,'switch_test.js');
      
      __LINE__ = 40;
      Runtime/*Runtime*/.assert(true,switchTest/*switchTest*/(6) === 10,"switchTest(6) === 10",40,'switch_test.js');
      
      __LINE__ = 41;
      Runtime/*Runtime*/.assert(true,switchTest/*switchTest*/(7) === 10,"switchTest(7) === 10",41,'switch_test.js');
      
      __LINE__ = 42;
      Runtime/*Runtime*/.assert(true,switchTest/*switchTest*/(8) === 100,"switchTest(8) === 100",42,'switch_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
