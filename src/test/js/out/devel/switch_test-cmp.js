!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 35;
      Runtime.assert(true,switchTest(1),"switchTest(1)",35,'./switch_test.js');
      
      __LINE__ = 36;
      Runtime.assert(true,switchTest(2),"switchTest(2)",36,'./switch_test.js');
      
      __LINE__ = 37;
      Runtime.assert(true,switchTest(3),"switchTest(3)",37,'./switch_test.js');
      
      __LINE__ = 38;
      Runtime.assert(true,switchTest(4),"switchTest(4)",38,'./switch_test.js');
      
      __LINE__ = 39;
      Runtime.assert(true,switchTest(5),"switchTest(5)",39,'./switch_test.js');
      
      __LINE__ = 40;
      Runtime.assert(true,switchTest(6),"switchTest(6)",40,'./switch_test.js');
      
      __LINE__ = 41;
      Runtime.assert(true,switchTest(7),"switchTest(7)",41,'./switch_test.js');
      
      __LINE__ = 42;
      Runtime.assert(true,switchTest(8),"switchTest(8)",42,'./switch_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
