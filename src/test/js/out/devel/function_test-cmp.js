!function() {
  ...
  !function () {
    ...
    try {
      ...
      __LINE__ = 5;
      __Runtime.assert( true ,1 === test(),"1 === test()",5,'function_test.js');
      ...
      __LINE__ = 10;
      __Runtime.assert( true ,1 === testExpression(),"1 === testExpression()",10,'function_test.js');
      ...
      __LINE__ = 18;
      __Runtime.assert( true ,1 === testObject.prop(),"1 === testObject.prop()",18,'function_test.js');
      
      __LINE__ = 23;
      __Runtime.assert( true ,3 === testFormal(1,1,1),"3 === testFormal(1,1,1)",23,'function_test.js');
      ...
      __LINE__ = 29;
      __Runtime.assert( true ,3 === testExpressionFormal(1,1,1),"3 === testExpressionFormal(1,1,1)",29,'function_test.js');
