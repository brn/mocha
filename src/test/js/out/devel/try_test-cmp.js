  ...
  !function () {
    try {
      var __FILE__ = "1653259312-try_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-try_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-try_test.js'],
          value/*value*/ = 0;
      ...
      try {
        ...
        __LINE__ = 6;
        Runtime/*Runtime*/.assert(true,e instanceof Error,"e instanceof Error",6,'try_test.js');
      } finally {
        __LINE__ = 8;
        Runtime/*Runtime*/.assert(true,value/*value*/ === 100,"value === 100",8,'try_test.js');
      }
