!function() {
  ...
  !function () {
    c['-759650552-generator_expression_test.js'] = {};
    
    var h = c['-759650552-generator_expression_test.js'],
        e = c.iterators.iterators,
        d = e.keys,
        g = e.allItems,
        b =  {
          value1 : 100,
    ...
    f = function () {
      var g = true,
          ...
          f = d(b),
          h = function (i,h) {
            !i?g = false : i && g && arguments[1] !== undefined && a.exceptionHandler('attempt to send to newborn generator.');
