  ...
  !function () {
    try {
      var __FILE__ = "-759650552-generator_expression_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-generator_expression_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-generator_expression_test.js'],
          _mochaLocalTmp0/*_mochaLocalTmp0*/ = _mochaGlobalExport/*_mochaGlobalExport*/.iterators,
          keys/*keys*/ = _mochaLocalTmp0/*_mochaLocalTmp0*/.keys,
          allItems/*allItems*/ = _mochaLocalTmp0/*_mochaLocalTmp0*/.allItems,
                      ...
                      while (1){
                        ...
                        switch (_yieldState/*_yieldState*/) {
                          case 0 :
                            ...
                            __LINE__ = 8;
                            for (var _mochaLocalTmp1/*_mochaLocalTmp1*/ in testObject/*testObject*/){
                          ...
                          case 1 :
                            ...
                            __LINE__ = 8;
                            x/*x*/ = _mochaLocalTmp2/*_mochaLocalTmp2*/[_mochaLocalTmp3/*_mochaLocalTmp3*/];
                            
                            __LINE__ = 8;
                            x/*x*/ = testObject/*testObject*/[x/*x*/];
                            __LINE__ = 4339166464;
                            return x/*x*/;
                          case 2 :
      ...
      __LINE__ = 10;
      Runtime/*Runtime*/.assert(true,test/*test*/.next() === 100,"test.next() === 100",10,'generator_expression_test.js');
      
      __LINE__ = 11;
      Runtime/*Runtime*/.assert(true,test/*test*/.next() === 200,"test.next() === 200",11,'generator_expression_test.js');
      
      __LINE__ = 12;
      Runtime/*Runtime*/.assert(true,test/*test*/.next() === 300,"test.next() === 300",12,'generator_expression_test.js');
      ...
      test/*test*/ = function () {
        try {
          ...
          var _mochaIsNewBorn/*_mochaIsNewBorn*/ = true,
              ...
              _yieldState/*_yieldState*/ = 0,
              x/*x*/,
              _mochaLocalTmp4/*_mochaLocalTmp4*/ = keys/*keys*/(testObject/*testObject*/),
              _mochaGenerator/*_mochaGenerator*/ = function (_isYieldSend/*_isYieldSend*/,_isYieldSafe/*_isYieldSafe*/) {
                try {
                  __LINE__ = 4352333280;
                  !_isYieldSend/*_isYieldSend*/?_mochaIsNewBorn/*_mochaIsNewBorn*/ = false : _isYieldSend/*_isYieldSend*/ && _mochaIsNewBorn/*_mochaIsNewBorn*/ && arguments[1] !== undefined && Runtime/*Runtime*/.exceptionHandler('attempt to send to newborn generator.');
                  ...
                  while (1){
                    ...
                    switch (_yieldState/*_yieldState*/) {
                      ...
                      case 1 :
                        ...
                        __LINE__ = 14;
                        if (!((x/*x*/ = _mochaLocalTmp4/*_mochaLocalTmp4*/.__nothrowNext__()))){
                      ...
                      case 5 :
                        ...
                        __LINE__ = 14;
                        Runtime/*Runtime*/.exceptionHandler(14,'..///Users/aono_taketoshi/github/mocha/src/test/js/harmony/generator_expression_test.js','for of statement expect iterator or generator object.');
                      case 6 :
                      case -1 :
      ...
      __LINE__ = 16;
      Runtime/*Runtime*/.assert(true,test/*test*/.next() === "value1","test.next() === \"value1\"",16,'generator_expression_test.js');
      
      __LINE__ = 17;
      Runtime/*Runtime*/.assert(true,test/*test*/.next() === "value2","test.next() === \"value2\"",17,'generator_expression_test.js');
      
      __LINE__ = 18;
      Runtime/*Runtime*/.assert(true,test/*test*/.next() === "value3","test.next() === \"value3\"",18,'generator_expression_test.js');
                  ...
                  while (1){
                    ...
                    switch (_yieldState/*_yieldState*/) {
                      case 0 :
                        ...
                        __LINE__ = 20;
                        for (var _mochaLocalTmp5/*_mochaLocalTmp5*/ in testObject/*testObject*/){
                      ...
                      case 1 :
                        ...
                        __LINE__ = 20;
                        x/*x*/ = _mochaLocalTmp6/*_mochaLocalTmp6*/[_mochaLocalTmp7/*_mochaLocalTmp7*/];
      ...
      __LINE__ = 21;
      Runtime/*Runtime*/.assert(true,test/*test*/.next() === 200,"test.next() === 200",21,'generator_expression_test.js');
      ...
      test/*test*/ = function () {
        try {
          ...
          var _mochaIsNewBorn/*_mochaIsNewBorn*/ = true,
              ...
              _yieldState/*_yieldState*/ = 0,
              x/*x*/,
              _mochaLocalTmp8/*_mochaLocalTmp8*/ = keys/*keys*/(testObject/*testObject*/),
              _mochaGenerator/*_mochaGenerator*/ = function (_isYieldSend/*_isYieldSend*/,_isYieldSafe/*_isYieldSafe*/) {
                try {
                  __LINE__ = 23;
                  !_isYieldSend/*_isYieldSend*/?_mochaIsNewBorn/*_mochaIsNewBorn*/ = false : _isYieldSend/*_isYieldSend*/ && _mochaIsNewBorn/*_mochaIsNewBorn*/ && arguments[1] !== undefined && Runtime/*Runtime*/.exceptionHandler('attempt to send to newborn generator.');
                  ...
                  while (1){
                    ...
                    switch (_yieldState/*_yieldState*/) {
                      ...
                      case 1 :
                        ...
                        __LINE__ = 23;
                        if (!((x/*x*/ = _mochaLocalTmp8/*_mochaLocalTmp8*/.__nothrowNext__()))){
                      ...
                      case 7 :
                        ...
                        __LINE__ = 23;
                        Runtime/*Runtime*/.exceptionHandler(23,'..///Users/aono_taketoshi/github/mocha/src/test/js/harmony/generator_expression_test.js','for of statement expect iterator or generator object.');
                      case 8 :
                      case -1 :
      ...
      __LINE__ = 24;
      Runtime/*Runtime*/.assert(true,test/*test*/.next() === "value2","test.next() === \"value2\"",24,'generator_expression_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
