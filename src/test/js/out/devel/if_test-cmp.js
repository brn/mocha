!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 11;
      Runtime.assert(true,ifTest(1),"ifTest(1)",11,'./if_test.js');
      
      __LINE__ = 12;
      Runtime.assert(true,ifTest(2),"ifTest(2)",12,'./if_test.js');
      
      __LINE__ = 13;
      Runtime.assert(true,ifTest(3),"ifTest(3)",13,'./if_test.js');
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
