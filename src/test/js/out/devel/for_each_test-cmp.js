!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 10;
      Runtime.assert(true,arr[0],"arr[0]",10,'./for_each_test.js');
      
      __LINE__ = 11;
      Runtime.assert(true,arr[1],"arr[1]",11,'./for_each_test.js');
      
      __LINE__ = 12;
      Runtime.assert(true,arr[2],"arr[2]",12,'./for_each_test.js');
      ...
      __LINE__ = 18;
      Runtime.assert(true,arr[0],"arr[0]",18,'./for_each_test.js');
      
      __LINE__ = 19;
      Runtime.assert(true,arr[1],"arr[1]",19,'./for_each_test.js');
      
      __LINE__ = 20;
      Runtime.assert(true,arr[2],"arr[2]",20,'./for_each_test.js');
      ...
      __LINE__ = 26;
      Runtime.assert(true,arr[0],"arr[0]",26,'./for_each_test.js');
      
      __LINE__ = 27;
      Runtime.assert(true,arr[1],"arr[1]",27,'./for_each_test.js');
      
      __LINE__ = 28;
      Runtime.assert(true,arr[2],"arr[2]",28,'./for_each_test.js');
      ...
      __LINE__ = 34;
      Runtime.assert(true,arr[0],"arr[0]",34,'./for_each_test.js');
      
      __LINE__ = 35;
      Runtime.assert(true,arr[1],"arr[1]",35,'./for_each_test.js');
      
      __LINE__ = 36;
      Runtime.assert(true,arr[2],"arr[2]",36,'./for_each_test.js');
      ...
      __LINE__ = 46;
      Runtime.assert(true,arr[0],"arr[0]",46,'./for_each_test.js');
      
      __LINE__ = 47;
      Runtime.assert(true,arr[1],"arr[1]",47,'./for_each_test.js');
      
      __LINE__ = 48;
      Runtime.assert(true,arr[2],"arr[2]",48,'./for_each_test.js');
    } catch(e){
