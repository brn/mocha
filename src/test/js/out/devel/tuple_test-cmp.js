  ...
  !function () {
    try {
      var __FILE__ = "-759650552-tuple_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-tuple_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-tuple_test.js'],
          test/*test*/ = Runtime/*Runtime*/.createTuple({},4),
          test2/*test2*/ = Runtime/*Runtime*/.createRecord( {
            "name" : "foo",
            age : "20",
            addr : "tokyo"
          }),
          test3/*test3*/ = new Tuple/*Tuple*/(0,1,3,4,5,6,7,7);
