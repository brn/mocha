!function() {
    ...
    TupleConstructor : (function () {
      ...
      TupleConstructor.prototype =  {
        ...
        tupleToArray : function () {
          return __Runtime._slice.call(this);
        },
        toString : function () {
          return "[object Tuple]";
        }
  ...
  function Tuple(args) {
    args = __Runtime.toArray(arguments,0);
    return new __Runtime.TupleConstructor(args);
  }
  Tuple.prototype = __Runtime.TupleConstructor.prototype;
  
  __Runtime.extend(__Runtime, {
    RecordConstructor : (function () {
  ...
  function Record(member) {
    return new __Runtime.RecordConstructor(member);
  }
