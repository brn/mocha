  ...
  !function () {
    try {
      var __FILE__ = "Y:/mocha/src/test/js/262/label_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport['./label_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias = _mochaGlobalExport['./label_test.js'],
          ret = 0;
      __LINE__ = 1;
      TEST_LABEL : 
      {
      ...
      __LINE__ = 7;
      Runtime.assert(true,ret,"ret",7,'./label_test.js');
      __LINE__ = 144504976;
      TEST_LABEL2 : {
      ...
      __LINE__ = 10;
      Runtime.assert(true,ret,"ret",10,'./label_test.js');
    } catch(e){
