!function() {
  ...
  !function () {
    try {
      var __FILE__ = "-836421475-do_while_test.js",
          __LINE__ = 0;
      __LINE__ = 1;
      var testvalue = 9,
      ...
      __LINE__ = 8;
      __Runtime.assert( true ,ret[0] === 'j',"ret[0] === 'j'",8,'do_while_test.js');
      
      __LINE__ = 9;
      __Runtime.assert( true ,ret[1] === 'i',"ret[1] === 'i'",9,'do_while_test.js');
      
      __LINE__ = 10;
      __Runtime.assert( true ,ret[2] === 'h',"ret[2] === 'h'",10,'do_while_test.js');
      
      __LINE__ = 11;
      __Runtime.assert( true ,ret[3] === 'g',"ret[3] === 'g'",11,'do_while_test.js');
      
      __LINE__ = 12;
      __Runtime.assert( true ,ret[4] === 'f',"ret[4] === 'f'",12,'do_while_test.js');
      
      __LINE__ = 13;
      __Runtime.assert( true ,ret[5] === 'e',"ret[5] === 'e'",13,'do_while_test.js');
      
      __LINE__ = 14;
      __Runtime.assert( true ,ret[6] === 'd',"ret[6] === 'd'",14,'do_while_test.js');
      
      __LINE__ = 15;
      __Runtime.assert( true ,ret[7] === 'c',"ret[7] === 'c'",15,'do_while_test.js');
      
      __LINE__ = 16;
      __Runtime.assert( true ,ret[8] === 'b',"ret[8] === 'b'",16,'do_while_test.js');
      
      __LINE__ = 17;
      __Runtime.assert( true ,ret[9] === 'a',"ret[9] === 'a'",17,'do_while_test.js');
      ...
      __LINE__ = 24;
      __Runtime.assert( true ,ret[0] === 'j',"ret[0] === 'j'",24,'do_while_test.js');
      
      __LINE__ = 25;
      __Runtime.assert( true ,ret[1] === 'i',"ret[1] === 'i'",25,'do_while_test.js');
      
      __LINE__ = 26;
      __Runtime.assert( true ,ret[2] === 'h',"ret[2] === 'h'",26,'do_while_test.js');
      
      __LINE__ = 27;
      __Runtime.assert( true ,ret[3] === 'g',"ret[3] === 'g'",27,'do_while_test.js');
      
      __LINE__ = 28;
      __Runtime.assert( true ,ret[4] === 'f',"ret[4] === 'f'",28,'do_while_test.js');
      
      __LINE__ = 29;
      __Runtime.assert( true ,ret[5] === 'e',"ret[5] === 'e'",29,'do_while_test.js');
      
      __LINE__ = 30;
      __Runtime.assert( true ,ret[6] === 'd',"ret[6] === 'd'",30,'do_while_test.js');
      
      __LINE__ = 31;
      __Runtime.assert( true ,ret[7] === 'c',"ret[7] === 'c'",31,'do_while_test.js');
      
      __LINE__ = 32;
      __Runtime.assert( true ,ret[8] === 'b',"ret[8] === 'b'",32,'do_while_test.js');
      
      __LINE__ = 33;
      __Runtime.assert( true ,ret[9] === 'a',"ret[9] === 'a'",33,'do_while_test.js');
    } catch(e){
