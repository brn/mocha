!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 8;
      Runtime.assert(true,ret[0],"ret[0]",8,'./do_while_test.js');
      
      __LINE__ = 9;
      Runtime.assert(true,ret[1],"ret[1]",9,'./do_while_test.js');
      
      __LINE__ = 10;
      Runtime.assert(true,ret[2],"ret[2]",10,'./do_while_test.js');
      
      __LINE__ = 11;
      Runtime.assert(true,ret[3],"ret[3]",11,'./do_while_test.js');
      
      __LINE__ = 12;
      Runtime.assert(true,ret[4],"ret[4]",12,'./do_while_test.js');
      
      __LINE__ = 13;
      Runtime.assert(true,ret[5],"ret[5]",13,'./do_while_test.js');
      
      __LINE__ = 14;
      Runtime.assert(true,ret[6],"ret[6]",14,'./do_while_test.js');
      
      __LINE__ = 15;
      Runtime.assert(true,ret[7],"ret[7]",15,'./do_while_test.js');
      
      __LINE__ = 16;
      Runtime.assert(true,ret[8],"ret[8]",16,'./do_while_test.js');
      
      __LINE__ = 17;
      Runtime.assert(true,ret[9],"ret[9]",17,'./do_while_test.js');
      ...
      __LINE__ = 24;
      Runtime.assert(true,ret[0],"ret[0]",24,'./do_while_test.js');
      
      __LINE__ = 25;
      Runtime.assert(true,ret[1],"ret[1]",25,'./do_while_test.js');
      
      __LINE__ = 26;
      Runtime.assert(true,ret[2],"ret[2]",26,'./do_while_test.js');
      
      __LINE__ = 27;
      Runtime.assert(true,ret[3],"ret[3]",27,'./do_while_test.js');
      
      __LINE__ = 28;
      Runtime.assert(true,ret[4],"ret[4]",28,'./do_while_test.js');
      
      __LINE__ = 29;
      Runtime.assert(true,ret[5],"ret[5]",29,'./do_while_test.js');
      
      __LINE__ = 30;
      Runtime.assert(true,ret[6],"ret[6]",30,'./do_while_test.js');
      
      __LINE__ = 31;
      Runtime.assert(true,ret[7],"ret[7]",31,'./do_while_test.js');
      
      __LINE__ = 32;
      Runtime.assert(true,ret[8],"ret[8]",32,'./do_while_test.js');
      
      __LINE__ = 33;
      Runtime.assert(true,ret[9],"ret[9]",33,'./do_while_test.js');
    } catch(e){
