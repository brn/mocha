  ...
  !function () {
    try {
      var __FILE__ = "1653259312-do_while_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-do_while_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-do_while_test.js'],
          testvalue/*testvalue*/ = 9,
          table/*table*/ = ['a','b','c','d','e','f','g','h','i','j'],
          ret/*ret*/ = [];
      
      __LINE__ = 4;
      do {
        __LINE__ = 5;
        ret/*ret*/.push(table/*table*/[testvalue/*testvalue*/]);
      }while (testvalue/*testvalue*/ -- );
      
      __LINE__ = 8;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[0] === 'j',"ret[0] === 'j'",8,'do_while_test.js');
      
      __LINE__ = 9;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[1] === 'i',"ret[1] === 'i'",9,'do_while_test.js');
      
      __LINE__ = 10;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[2] === 'h',"ret[2] === 'h'",10,'do_while_test.js');
      
      __LINE__ = 11;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[3] === 'g',"ret[3] === 'g'",11,'do_while_test.js');
      
      __LINE__ = 12;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[4] === 'f',"ret[4] === 'f'",12,'do_while_test.js');
      
      __LINE__ = 13;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[5] === 'e',"ret[5] === 'e'",13,'do_while_test.js');
      
      __LINE__ = 14;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[6] === 'd',"ret[6] === 'd'",14,'do_while_test.js');
      
      __LINE__ = 15;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[7] === 'c',"ret[7] === 'c'",15,'do_while_test.js');
      
      __LINE__ = 16;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[8] === 'b',"ret[8] === 'b'",16,'do_while_test.js');
      
      __LINE__ = 17;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[9] === 'a',"ret[9] === 'a'",17,'do_while_test.js');
      ...
      __LINE__ = 24;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[0] === 'j',"ret[0] === 'j'",24,'do_while_test.js');
      
      __LINE__ = 25;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[1] === 'i',"ret[1] === 'i'",25,'do_while_test.js');
      
      __LINE__ = 26;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[2] === 'h',"ret[2] === 'h'",26,'do_while_test.js');
      
      __LINE__ = 27;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[3] === 'g',"ret[3] === 'g'",27,'do_while_test.js');
      
      __LINE__ = 28;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[4] === 'f',"ret[4] === 'f'",28,'do_while_test.js');
      
      __LINE__ = 29;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[5] === 'e',"ret[5] === 'e'",29,'do_while_test.js');
      
      __LINE__ = 30;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[6] === 'd',"ret[6] === 'd'",30,'do_while_test.js');
      
      __LINE__ = 31;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[7] === 'c',"ret[7] === 'c'",31,'do_while_test.js');
      
      __LINE__ = 32;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[8] === 'b',"ret[8] === 'b'",32,'do_while_test.js');
      
      __LINE__ = 33;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[9] === 'a',"ret[9] === 'a'",33,'do_while_test.js');
    } catch(e){
