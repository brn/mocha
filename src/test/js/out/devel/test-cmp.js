  ...
  !function () {
    try {
      ...
      var _mochaGlobalAlias = _mochaGlobalExport.iterators,
          iterators = _mochaGlobalAlias.iterators = function () {
            try {
  ...
  !function () {
    try {
      var __FILE__ = "-1301891693-test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport['-1301891693-test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias = _mochaGlobalExport['-1301891693-test.js'],
          x = _mochaGlobalExport['-839149963-module_test.js'],
          x = 0;
      
      __LINE__ = 5;
      x === 100 && typeof x === 'number' && console.log(100);
