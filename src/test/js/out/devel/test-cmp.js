  ...
  !function () {
    try {
      var __FILE__ = "-310326848-test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-310326848-test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-310326848-test.js'],
          m/*m*/ =  {
            add : function (classNameToAdd/*classNameToAdd*/) {
              try {
                ...
                __LINE__ = 5;
                this.set($A(this).concat(classNameToAdd/*classNameToAdd*/).join(' '));
              } catch(e){
            ...
            remove : function (classNameToRemove/*classNameToRemove*/) {
              try {
                ...
                __LINE__ = 10;
                this.set($A(this).without(classNameToRemove/*classNameToRemove*/).join(' '));
              } catch(e){
                Runtime.exceptionHandler(__LINE__, __FILE__, e);
              }
            },
