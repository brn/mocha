!function() {
  ...
  !function () {
    try {
      ...
      function b/*b*/(){}
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-310326848-name_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-310326848-name_test.js'];
      ...
      __LINE__ = 18;
      var ss/*ss*/ = 100+200*m/*m*/,
          sssss/*sssss*/ = (100)*2,
          sss/*sss*/ = NaN,
          ssssss/*ssssss*/ = "aaaaaaa222",
          test2/*test2*/ = {};
      ...
      __LINE__ = 57;
      var x/*x*/ = 200,
          _mochaLocalTmp0/*_mochaLocalTmp0*/ =  {
            v : 200
          };
      
      __LINE__ = 59;
      Runtime/*Runtime*/.createUnenumProp(_mochaLocalTmp0/*_mochaLocalTmp0*/,x/*x*/, {
        
      });
      
      __LINE__ = 59;
      Runtime/*Runtime*/.createUnenumProp(_mochaLocalTmp0/*_mochaLocalTmp0*/[x/*x*/],x/*x*/, {
        
      });
      
      __LINE__ = 59;
      Runtime/*Runtime*/.createUnenumProp(_mochaLocalTmp0/*_mochaLocalTmp0*/[x/*x*/][x/*x*/],x/*x*/,300);
      
      __LINE__ = 58;
      var m/*m*/ = _mochaLocalTmp0/*_mochaLocalTmp0*/;
    } catch(e){
      Runtime.exceptionHandler(__LINE__, __FILE__, e);
    }
  }();
