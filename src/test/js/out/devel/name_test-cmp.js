!function() {
  ...
  !function () {
    ...
    function e(c) {
      ...
      a.createTuple(b,arguments.length);
      return b;
    }
    function b(){}
    c['-310326848-name_test.js'] = {};
    
    var p = c['-310326848-name_test.js'];
    ...
    a.createUnenumProp(f,m, {
      
    });
    
    a.createUnenumProp(f[m],m, {
      
    });
    
    a.createUnenumProp(f[m][m],m,300);
