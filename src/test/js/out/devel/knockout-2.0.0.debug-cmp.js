        ...
        try {
          ...
          ko.utils = new !function () {
            try {
              ...
              for ( var eventType in knownEvents ){
                knownEventsForType = knownEvents[eventType];
          };
          ...
          return  {
            ...
            replaceDomNodes : function ( nodeToReplaceOrNodeArray,newNodesArray ) {
              try {
                __LINE__ = 143;
                var nodesToReplaceArray = nodeToReplaceOrNodeArray.nodeType?[] : nodeToReplaceOrNodeArray;
        ...
        try {
          ...
          function simpleHtmlParse( html ) {
            try {
              ...
              __LINE__ = 584;
              var wrap = tags.match( /^<(thead|tbody|tfoot)/ ) && [] || !tags.indexOf( "<tr" ) && [] || ( !tags.indexOf( "<td" ) || !tags.indexOf( "<th" ) ) && [] || [];
            ...
            try {
              ...
              return new ko.dependentObservable( function () {
                try {
                  ...
                  __LINE__ = 2800;
                  typeof unwrappedArray.length == "undefined" && ( unwrappedArray = [] );
          ...
          function fixUpVirtualElements( contiguousNodeArray ) {
            try {
              ...
              if ( contiguousNodeArray.length>2 ){
                ...
                __LINE__ = 3003;
                Array.prototype.splice.apply( contiguousNodeArray,[].concat( newContiguousSet ) );
              };
            } catch( e ){
              Runtime.exceptionHandler( __LINE__ , __FILE__ , e );
            }
