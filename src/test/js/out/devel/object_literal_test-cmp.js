  ...
  !function () {
    try {
      var __FILE__ = "-759650552-object_literal_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-object_literal_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-object_literal_test.js'],
      ...
      __LINE__ = 4;
      Runtime/*Runtime*/.extend(Runtime/*Runtime*/.extend(Runtime/*Runtime*/.extend(testObject/*testObject*/, {
        z : 400
      }), {
        z2 : 800
      }), {
