!function() {
    ...
    checkRequirements : function (_mochaLocalTmp3,_mochaLocalTmp4,traits,file,line) {
      ...
      for (var i = 0,len = traits.length;i<len;i ++ ){
        ...
        for (var prop in _mochaRequires){
          !(prop in proto1) && !(prop in proto2) && __Runtime.throwException("Class dose not meet the traits requirement. traits require implementation of property "+prop+"\nin file "+file+" at line "+line);
        }
  ...
  !function () {
    try {
      ...
      __LINE__ = 0;
      __Runtime.traitMixin(TestTrait,TestTraitP, {
        greaterThan : "gt",
        _greaterThant : "_gt"
      },{});
