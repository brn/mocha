  ...
  !function () {
    try {
      var __FILE__ = "-759650552-trait_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-trait_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['-759650552-trait_test.js'],
          TestTraitP/*TestTraitP*/ =  {
            _mochaTraitPrivate :  {
              _greaterThant : function _greaterThant/*_greaterThant*/(x/*x*/,y/*y*/) {
                try {
                  __LINE__ = 2;
                  return x/*x*/<y/*y*/;
                } catch(e){
            ...
            _mochaTraitPublic :  {
              greaterThan : function greaterThan/*greaterThan*/(x/*x*/,y/*y*/) {
                try {
                  __LINE__ = 3;
                  return x/*x*/<y/*y*/;
                } catch(e){
          ...
          TestTrait/*TestTrait*/ =  {
            _mochaTraitPrivate :  {
              _lessThan : function _lessThan/*_lessThan*/(x/*x*/,y/*y*/) {
                try {
                  __LINE__ = 10;
                  return x/*x*/<y/*y*/;
                } catch(e){
            ...
            _mochaTraitPublic :  {
              lessThan : function lessThan/*lessThan*/(x/*x*/,y/*y*/) {
                try {
                  __LINE__ = 11;
                  return x/*x*/<y/*y*/;
                } catch(e){
      ...
      __LINE__ = 0;
      Runtime/*Runtime*/.traitMixin(TestTrait/*TestTrait*/,TestTraitP/*TestTraitP*/, {
        greaterThan : "gt",
        _greaterThant : "_gt"
      },{});
      
      __LINE__ = 14;
      var traitexp/*traitexp*/ = function () {
            try {
              __LINE__ = 14;
              var _mochaLocalTmp0/*_mochaLocalTmp0*/ =  {
                    _mochaTraitPrivate :  {
                      mastercmp : function mastercmp/*mastercmp*/(x/*x*/,y/*y*/) {
                        try {
                          __LINE__ = 15;
                          return x/*x*/>y/*y*/;
                        } catch(e){
