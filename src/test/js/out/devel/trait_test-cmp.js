!function() {
  ...
  !function () {
    c['-759650552-trait_test.js'] = {};
    
    var k = c['-759650552-trait_test.js'],
        h =  {
          _mochaTraitPrivate :  {
            _greaterThant : function i(b,a) {
              return b<a;
            }
          },
          _mochaTraitPublic :  {
            greaterThan : function j(b,a) {
              return b<a;
            }
          },
          _mochaRequires : {},
        ...
        e =  {
          _mochaTraitPrivate :  {
            _lessThan : function g(b,a) {
              return b<a;
            }
          },
          _mochaTraitPublic :  {
            lessThan : function f(b,a) {
              return b<a;
            }
          },
          _mochaRequires :  {
    ...
    var d = function () {
          var a =  {
                _mochaTraitPrivate :  {
                  mastercmp : function c(b,a) {
                    return b>a;
                  }
                },
                _mochaTraitPublic :  {
                  lessthan : function b(b,a) {
                    return b>a;
                  }
                },
                _mochaRequires : {},
