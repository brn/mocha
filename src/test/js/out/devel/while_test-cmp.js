!function() {
  ...
  !function () {
    _mochaGlobalExport['1653259312-while_test.js'] = {};
    
    var _mochaGlobalAlias = _mochaGlobalExport['1653259312-while_test.js'],
        testvalue = 0,
        table = ['a','b','c','d','e','f','g','h','i','j'],
        ret = [];
    
    while (testvalue<10)ret.push(table[testvalue ++ ]);
