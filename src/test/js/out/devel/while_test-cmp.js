!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 7;
      __Runtime.assert( true ,ret[0] === 'a',"ret[0] === 'a'",7,'while_test.js');
      
      __LINE__ = 8;
      __Runtime.assert( true ,ret[1] === 'b',"ret[1] === 'b'",8,'while_test.js');
      
      __LINE__ = 9;
      __Runtime.assert( true ,ret[2] === 'c',"ret[2] === 'c'",9,'while_test.js');
      
      __LINE__ = 10;
      __Runtime.assert( true ,ret[3] === 'd',"ret[3] === 'd'",10,'while_test.js');
      
      __LINE__ = 11;
      __Runtime.assert( true ,ret[4] === 'e',"ret[4] === 'e'",11,'while_test.js');
      
      __LINE__ = 12;
      __Runtime.assert( true ,ret[5] === 'f',"ret[5] === 'f'",12,'while_test.js');
      
      __LINE__ = 13;
      __Runtime.assert( true ,ret[6] === 'g',"ret[6] === 'g'",13,'while_test.js');
      
      __LINE__ = 14;
      __Runtime.assert( true ,ret[7] === 'h',"ret[7] === 'h'",14,'while_test.js');
      
      __LINE__ = 15;
      __Runtime.assert( true ,ret[8] === 'i',"ret[8] === 'i'",15,'while_test.js');
      
      __LINE__ = 16;
      __Runtime.assert( true ,ret[9] === 'j',"ret[9] === 'j'",16,'while_test.js');
      ...
      __LINE__ = 23;
      __Runtime.assert( true ,ret[0] === 'a',"ret[0] === 'a'",23,'while_test.js');
      
      __LINE__ = 24;
      __Runtime.assert( true ,ret[1] === 'b',"ret[1] === 'b'",24,'while_test.js');
      
      __LINE__ = 25;
      __Runtime.assert( true ,ret[2] === 'c',"ret[2] === 'c'",25,'while_test.js');
      
      __LINE__ = 26;
      __Runtime.assert( true ,ret[3] === 'd',"ret[3] === 'd'",26,'while_test.js');
      
      __LINE__ = 27;
      __Runtime.assert( true ,ret[4] === 'e',"ret[4] === 'e'",27,'while_test.js');
      
      __LINE__ = 28;
      __Runtime.assert( true ,ret[5] === 'f',"ret[5] === 'f'",28,'while_test.js');
      
      __LINE__ = 29;
      __Runtime.assert( true ,ret[6] === 'g',"ret[6] === 'g'",29,'while_test.js');
      
      __LINE__ = 30;
      __Runtime.assert( true ,ret[7] === 'h',"ret[7] === 'h'",30,'while_test.js');
      
      __LINE__ = 31;
      __Runtime.assert( true ,ret[8] === 'i',"ret[8] === 'i'",31,'while_test.js');
