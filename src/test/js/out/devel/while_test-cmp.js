!function() {
  ...
  !function () {
    try {
      var __FILE__ = "Y:/mocha/src/test/js/262/while_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      ...
      __LINE__ = 7;
      Runtime.assert(true,ret[0],"ret[0]",7,'./while_test.js');
      
      __LINE__ = 8;
      Runtime.assert(true,ret[1],"ret[1]",8,'./while_test.js');
      
      __LINE__ = 9;
      Runtime.assert(true,ret[2],"ret[2]",9,'./while_test.js');
      
      __LINE__ = 10;
      Runtime.assert(true,ret[3],"ret[3]",10,'./while_test.js');
      
      __LINE__ = 11;
      Runtime.assert(true,ret[4],"ret[4]",11,'./while_test.js');
      
      __LINE__ = 12;
      Runtime.assert(true,ret[5],"ret[5]",12,'./while_test.js');
      
      __LINE__ = 13;
      Runtime.assert(true,ret[6],"ret[6]",13,'./while_test.js');
      
      __LINE__ = 14;
      Runtime.assert(true,ret[7],"ret[7]",14,'./while_test.js');
      
      __LINE__ = 15;
      Runtime.assert(true,ret[8],"ret[8]",15,'./while_test.js');
      
      __LINE__ = 16;
      Runtime.assert(true,ret[9],"ret[9]",16,'./while_test.js');
      ...
      __LINE__ = 23;
      Runtime.assert(true,ret[0],"ret[0]",23,'./while_test.js');
      
      __LINE__ = 24;
      Runtime.assert(true,ret[1],"ret[1]",24,'./while_test.js');
      
      __LINE__ = 25;
      Runtime.assert(true,ret[2],"ret[2]",25,'./while_test.js');
      
      __LINE__ = 26;
      Runtime.assert(true,ret[3],"ret[3]",26,'./while_test.js');
      
      __LINE__ = 27;
      Runtime.assert(true,ret[4],"ret[4]",27,'./while_test.js');
      
      __LINE__ = 28;
      Runtime.assert(true,ret[5],"ret[5]",28,'./while_test.js');
      
      __LINE__ = 29;
      Runtime.assert(true,ret[6],"ret[6]",29,'./while_test.js');
      
      __LINE__ = 30;
      Runtime.assert(true,ret[7],"ret[7]",30,'./while_test.js');
      
      __LINE__ = 31;
      Runtime.assert(true,ret[8],"ret[8]",31,'./while_test.js');
      
      __LINE__ = 32;
      Runtime.assert(true,ret[9],"ret[9]",32,'./while_test.js');
    } catch(e){
