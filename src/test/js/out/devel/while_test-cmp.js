!function() {
  ...
  !function () {
    try {
      var __FILE__ = "1653259312-while_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-while_test.js'] = {};
      
      __LINE__ = 3;
      var _mochaGlobalAlias/*_mochaGlobalAlias*/ = _mochaGlobalExport/*_mochaGlobalExport*/['1653259312-while_test.js'],
          testvalue/*testvalue*/ = 0,
          table/*table*/ = ['a','b','c','d','e','f','g','h','i','j'],
          ret/*ret*/ = [];
      
      __LINE__ = 4;
      while (testvalue/*testvalue*/<10){
        __LINE__ = 5;
        ret/*ret*/.push(table/*table*/[testvalue/*testvalue*/ ++ ]);
      }
      
      __LINE__ = 7;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[0] === 'a',"ret[0] === 'a'",7,'while_test.js');
      
      __LINE__ = 8;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[1] === 'b',"ret[1] === 'b'",8,'while_test.js');
      
      __LINE__ = 9;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[2] === 'c',"ret[2] === 'c'",9,'while_test.js');
      
      __LINE__ = 10;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[3] === 'd',"ret[3] === 'd'",10,'while_test.js');
      
      __LINE__ = 11;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[4] === 'e',"ret[4] === 'e'",11,'while_test.js');
      
      __LINE__ = 12;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[5] === 'f',"ret[5] === 'f'",12,'while_test.js');
      
      __LINE__ = 13;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[6] === 'g',"ret[6] === 'g'",13,'while_test.js');
      
      __LINE__ = 14;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[7] === 'h',"ret[7] === 'h'",14,'while_test.js');
      
      __LINE__ = 15;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[8] === 'i',"ret[8] === 'i'",15,'while_test.js');
      
      __LINE__ = 16;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[9] === 'j',"ret[9] === 'j'",16,'while_test.js');
      ...
      __LINE__ = 23;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[0] === 'a',"ret[0] === 'a'",23,'while_test.js');
      
      __LINE__ = 24;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[1] === 'b',"ret[1] === 'b'",24,'while_test.js');
      
      __LINE__ = 25;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[2] === 'c',"ret[2] === 'c'",25,'while_test.js');
      
      __LINE__ = 26;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[3] === 'd',"ret[3] === 'd'",26,'while_test.js');
      
      __LINE__ = 27;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[4] === 'e',"ret[4] === 'e'",27,'while_test.js');
      
      __LINE__ = 28;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[5] === 'f',"ret[5] === 'f'",28,'while_test.js');
      
      __LINE__ = 29;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[6] === 'g',"ret[6] === 'g'",29,'while_test.js');
      
      __LINE__ = 30;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[7] === 'h',"ret[7] === 'h'",30,'while_test.js');
      
      __LINE__ = 31;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[8] === 'i',"ret[8] === 'i'",31,'while_test.js');
      
      __LINE__ = 32;
      Runtime/*Runtime*/.assert(true,ret/*ret*/[9] === 'j',"ret[9] === 'j'",32,'while_test.js');
    } catch(e){
