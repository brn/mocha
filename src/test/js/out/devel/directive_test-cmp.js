!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 49;
      _mochaLocalTmp7 = __Runtime.getIterator(_mochaLocalTmp7);
      
      __LINE__ = 49;
      while ((i = _mochaLocalTmp7.__nothrowNext__()) !== __Runtime._NULL){
        __LINE__ = 50;
        ret.push(i);
      }
      ...
      __LINE__ = 58;
      while ((x = _mochaLocalTmp8.__nothrowNext__()) !== __Runtime._NULL){
        __LINE__ = 59;
        ret.push(x);
      }
      ...
      __LINE__ = 71;
      _mochaLocalTmp9 = __Runtime.getIterator(_mochaLocalTmp9);
      
      __LINE__ = 71;
      while ((i = _mochaLocalTmp9.__nothrowNext__()) !== __Runtime._NULL){
        __LINE__ = 72;
        ret.push(i);
      }
    ...
    findChildElements: function(element, expressions) {
      ...
      var Test = function () {
            function constructor(_mochaLocalTmp0) {
              try {
                __LINE__ = 5;
                __Runtime.getPrivateRecord(this)._x = _mochaLocalTmp0 || 100;
              } catch(__mocha_error){
                __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
              }
            }
            function Test() {
              try {
                __LINE__ = 4;
                __Runtime.initializeClass(this,Test,_mochaPrivateHolder,constructor,arguments,'Test',4);
              } catch(__mocha_error){
                __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
              }
            }
            try {
              ...
              _mochaPrivateHolder.prototype.getX = function () {
                try {
                  __LINE__ = 6;
                  return __Runtime.getPrivateRecord(this)._x;
                } catch(__mocha_error){
                  __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
                }
              };
              ...
              __LINE__ = 4;
              __Runtime.createUnenumProp(Test.prototype,"constructor",constructor);
              __LINE__ = 4;
              return Test;
            } catch(__mocha_error){
              __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
