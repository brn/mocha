!function() {
  ...
  !function () {
    try {
      var __FILE__ = "-839149963-for_of_test.js",
          __LINE__ = 0;
      __LINE__ = 1;
      var _mochaLocalTmp0 = Runtime.modules.get('iterators'),
      ...
      __LINE__ = 49;
      _mochaLocalTmp7 = Runtime.hasIterator(_mochaLocalTmp7)?Runtime.getIterator(_mochaLocalTmp7) : _mochaLocalTmp7;
      ...
      __LINE__ = 71;
      _mochaLocalTmp9 = Runtime.hasIterator(_mochaLocalTmp9)?Runtime.getIterator(_mochaLocalTmp9) : _mochaLocalTmp9;
  ...
  !function () {
    try {
      var __FILE__ = "-839149963-directive_test.js",
          __LINE__ = 0;
...
(function() {
  ...
  Object.extend(Selector, {
    ...
    findChildElements: function(element, expressions) {
      ...
      __LINE__ = 4;
      var Test = function () {
            function constructor(_mochaLocalTmp0) {
              try {
                __LINE__ = 5;
                Runtime.getPrivateRecord( this ).x = _mochaLocalTmp0 || 100;
              } catch(e){
                Runtime.exceptionHandler(__LINE__, __FILE__, e);
              }
            }
            function Test() {
              try {
                __LINE__ = 4;
                Runtime.initializeClass(this,Test,_mochaPrivateHolder,constructor,arguments,'Test',4);
              } catch(e){
                Runtime.exceptionHandler(__LINE__, __FILE__, e);
              }
            }
            try {
              ...
              __LINE__ = 6;
              _mochaPrivateHolder.prototype.getX = function () {
                try {
                  __LINE__ = 6;
                  return Runtime.getPrivateRecord( this ).x;
                } catch(e){
                  Runtime.exceptionHandler(__LINE__, __FILE__, e);
                }
              };
              ...
              __LINE__ = 4;
              Runtime.createUnenumProp(Test.prototype,"constructor",constructor);
              __LINE__ = 4;
              return Test;
            } catch(e){
              Runtime.exceptionHandler(__LINE__, __FILE__, e);
