(function() {
  ...
  ( function () {
    p/*_mochaGlobalExport*/['./module_test.js'] = {};
    
    var a/*_mochaGlobalAlias*/ = p/*_mochaGlobalExport*/['./module_test.js'];
    
    var b/*testModule1*/ = a/*_mochaGlobalAlias*/.b/*testModule1*/ = ( function b/*testModule1*/() {
          var a/*_mochaLocalExport*/ = {};
          
          var b/*testExport1*/ = a/*_mochaLocalExport*/.testExport1 = function b/*testExport1*/() {
                return 1;
              };
          return a/*_mochaLocalExport*/;
        })();
    
    var c/*testModule2*/ = a/*_mochaGlobalAlias*/.c/*testModule2*/ = ( function c/*testModule2*/() {
          var a/*_mochaLocalExport*/ = {};
          
          var b/*testInnerModule3*/ = a/*_mochaLocalExport*/.b/*testInnerModule3*/ = ( function b/*testInnerModule3*/() {
                var a/*_mochaLocalExport*/ = {};
                
                var b/*testExport2*/ = a/*_mochaLocalExport*/.testExport2 = function b/*testExport2*/() {
                      return 2;
                    };
                
                var c/*testExport3*/ = a/*_mochaLocalExport*/.testExport3 =  {
                      test : 200
                    };
                return a/*_mochaLocalExport*/;
              })();
    ...
    ( function () {
      var a/*_mochaLocalExport*/ = a/*_mochaGlobalAlias*/;
      
      var b/*testInnerModule4*/ = a/*_mochaLocalExport*/.b/*testInnerModule4*/ = ( function b/*testInnerModule4*/() {
            var a/*_mochaLocalExport*/ = {};
            
            var b/*testExport4*/ = a/*_mochaLocalExport*/.testExport4 = function b/*testExport4*/() {
                  return 3;
                };
            return a/*_mochaLocalExport*/;
          })();
      
      var c/*testExport5*/ = a/*_mochaLocalExport*/.testExport5 = function c/*testExport5*/() {
            return 4;
          };
      return a/*_mochaLocalExport*/;
    })();
  ...
  ( function () {
    p/*_mochaGlobalExport*/['./import_test.js'] = {};
    
    var f/*_mochaGlobalAlias*/ = p/*_mochaGlobalExport*/['./import_test.js'];
    
    var g/*_mochaLocalTmp0*/ = p/*_mochaGlobalExport*/['./module_test.js'],
        h/*testExport1*/ = g/*_mochaLocalTmp0*/.testModule1 && g/*_mochaLocalTmp0*/.testModule1.testExport1?g/*_mochaLocalTmp0*/.testModule1.testExport1 : undefined,
        i/*testExport2*/ = g/*_mochaLocalTmp0*/.testModule2 && g/*_mochaLocalTmp0*/.testModule2.testInnerModule3 && g/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport2?g/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport2 : undefined,
        j/*testExport3*/ = g/*_mochaLocalTmp0*/.testModule2 && g/*_mochaLocalTmp0*/.testModule2.testInnerModule3 && g/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport3?g/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport3 : undefined,
        k/*testExport4*/ = g/*_mochaLocalTmp0*/.testInnerModule4 && g/*_mochaLocalTmp0*/.testInnerModule4.testExport4?g/*_mochaLocalTmp0*/.testInnerModule4.testExport4 : undefined,
        m/*testExport5*/ = g/*_mochaLocalTmp0*/.testExport5;
    
    var n/*testModule*/ = f/*_mochaGlobalAlias*/.n/*testModule*/ = ( function n/*testModule*/() {
          var a/*_mochaLocalExport*/ = {};
          
          var b/*foo*/ = a/*_mochaLocalExport*/.foo = function b/*foo*/() {
                return "ok";
              };
          return a/*_mochaLocalExport*/;
        })();
    
    var o/*_mochaLocalTmp1*/ = n/*testModule*/,
        q/*foo*/ = o/*_mochaLocalTmp1*/.foo;
  })();
})();
