!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 3;
      var c = b['./module_test.js'],
          d = c.testModule1 = function () {
            try {
              __LINE__ = 2;
              var b = {};
          ...
          e = c.testModule2 = function () {
            try {
              __LINE__ = 8;
              var b = {},
                  c = b.testInnerModule3 = function () {
                    try {
                      __LINE__ = 9;
                      var b = {};
  ...
  !function () {
    try {
      ...
      __LINE__ = 3;
      var c = b['./import_test.js'],
          d = b['./module_test.js'],
          e = d.testModule1 && d.testModule1.testExport1?d.testModule1.testExport1 : undefined,
          f = d.testModule2 && d.testModule2.testInnerModule3 && d.testModule2.testInnerModule3.testExport2?d.testModule2.testInnerModule3.testExport2 : undefined,
          g = d.testModule2 && d.testModule2.testInnerModule3 && d.testModule2.testInnerModule3.testExport3?d.testModule2.testInnerModule3.testExport3 : undefined,
          h = d.testInnerModule4 && d.testInnerModule4.testExport4?d.testInnerModule4.testExport4 : undefined,
          i = d.testExport5;
      
      __LINE__ = 18;
      a.assert( true,e() === 1,"testExport1() === 1",18,'./import_test.js' );
      
      __LINE__ = 19;
      a.assert( true,f() === 2,"testExport2() === 2",19,'./import_test.js' );
      
      __LINE__ = 20;
      a.assert( true,g.test === 200,"testExport3.test === 200",20,'./import_test.js' );
      
      __LINE__ = 21;
      a.assert( true,h() === 3,"testExport4() === 3",21,'./import_test.js' );
      
      __LINE__ = 22;
      a.assert( true,i() === 4,"testExport5() === 4",22,'./import_test.js' );
      
      __LINE__ = 0;
      var j = c.testModule = function () {
            try {
              __LINE__ = 24;
              var b = {};
      ...
      __LINE__ = 29;
      a.assert( true,l() === "ok","foo() === \"ok\"",29,'./import_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  }();
