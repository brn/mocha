(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./module_test.js'] = {};
    
    var b/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./module_test.js'];
    
    var F/*testModule1*/ = b/*_mochaGlobalAlias*/.testModule1 = ( function testModule1() {
          var b/*_mochaLocalExport*/ = {};
          
          var c/*testExport1*/ = b/*_mochaLocalExport*/.testExport1 = function c/*testExport1*/() {
                return 1;
              };
          return b/*_mochaLocalExport*/;
        })();
    
    var G/*testModule2*/ = b/*_mochaGlobalAlias*/.testModule2 = ( function testModule2() {
          var b/*_mochaLocalExport*/ = {};
          
          var c/*testInnerModule3*/ = b/*_mochaLocalExport*/.testInnerModule3 = ( function testInnerModule3() {
                var c/*_mochaLocalExport*/ = {};
                
                var d/*testExport2*/ = c/*_mochaLocalExport*/.testExport2 = function d/*testExport2*/() {
                      return 2;
                    };
                
                var e/*testExport3*/ = c/*_mochaLocalExport*/.testExport3 =  {
                      test : 200
                    };
                return c/*_mochaLocalExport*/;
              })();
          return b/*_mochaLocalExport*/;
        })();
    
    ( function () {
      var a/*_mochaLocalExport*/ = b/*_mochaGlobalAlias*/;
      
      var d/*testInnerModule4*/ = a/*_mochaLocalExport*/.testInnerModule4 = ( function testInnerModule4() {
            var b/*_mochaLocalExport*/ = {};
            
            var c/*testExport4*/ = b/*_mochaLocalExport*/.testExport4 = function c/*testExport4*/() {
                  return 3;
                };
            return b/*_mochaLocalExport*/;
          })();
      
      var e/*testExport5*/ = a/*_mochaLocalExport*/.testExport5 = function e/*testExport5*/() {
            return 4;
          };
      return a/*_mochaLocalExport*/;
    })();
  })();
  
  ( function () {
    D/*_mochaGlobalExport*/['./import_test.js'] = {};
    
    var k/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./import_test.js'];
    
    var l/*_mochaLocalTmp0*/ = D/*_mochaGlobalExport*/['./module_test.js'],
        n/*testExport1*/ = l/*_mochaLocalTmp0*/.testModule1 && l/*_mochaLocalTmp0*/.testModule1.testExport1?l/*_mochaLocalTmp0*/.testModule1.testExport1 : undefined,
        o/*testExport2*/ = l/*_mochaLocalTmp0*/.testModule2 && l/*_mochaLocalTmp0*/.testModule2.testInnerModule3 && l/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport2?l/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport2 : undefined,
        p/*testExport3*/ = l/*_mochaLocalTmp0*/.testModule2 && l/*_mochaLocalTmp0*/.testModule2.testInnerModule3 && l/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport3?l/*_mochaLocalTmp0*/.testModule2.testInnerModule3.testExport3 : undefined,
        q/*testExport4*/ = l/*_mochaLocalTmp0*/.testInnerModule4 && l/*_mochaLocalTmp0*/.testInnerModule4.testExport4?l/*_mochaLocalTmp0*/.testInnerModule4.testExport4 : undefined,
        r/*testExport5*/ = l/*_mochaLocalTmp0*/.testExport5;
    
    var s/*testModule*/ = k/*_mochaGlobalAlias*/.testModule = ( function testModule() {
          var b/*_mochaLocalExport*/ = {};
          
          var c/*foo*/ = b/*_mochaLocalExport*/.foo = function c/*foo*/() {
                return "ok";
              };
          return b/*_mochaLocalExport*/;
        })();
    
    var t/*_mochaLocalTmp1*/ = s/*testModule*/,
        u/*foo*/ = t/*_mochaLocalTmp1*/.foo;
  })();
})();
