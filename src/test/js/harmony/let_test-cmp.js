(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/harmony/let_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      c/*_mochaGlobalExport*/['./let_test.js'] = {};
      
      __LINE__ = 3;
      var d/*_mochaGlobalAlias*/ = c/*_mochaGlobalExport*/['./let_test.js'];
      ...
      __LINE__ = 0;
      b/*ret*/.forEach( function ( b/*item*/,c/*index*/ ) {
        try {
          
          __LINE__ = 11;
          a/*Runtime*/.assert( true,b/*item*/() === c/*index*/,"item() === index",11,'./let_test.js' );
        } catch( e ){
          a.exceptionHandler( __LINE__ , __FILE__ , e );
        }
      });
