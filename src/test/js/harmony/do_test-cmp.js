  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/harmony/do_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./do_test.js'] = {};
      
      __LINE__ = 3;
      var c/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./do_test.js'];
      
      __LINE__ = 1;
      var d/*testvalue*/ = ( function () {
            try {
              __LINE__ = 2;
              var b/*x*/ = 0;
              __LINE__ = 0;
      ...
      __LINE__ = 6;
      a/*Runtime*/.assert( true,d/*testvalue*/ === 0,"testvalue === 0",6,'./do_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  })();
