  ...
  !function () {
    try {
      var __FILE__ = "/Users/aono_taketoshi/github/mocha/src/test/js/harmony/array_comprehensions_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b['./array_comprehensions_test.js'] = {};
      ...
      __LINE__ = 10;
      a.assert( true,g[0] === 100,"cmpTest[0] === 100",10,'./array_comprehensions_test.js' );
      
      __LINE__ = 11;
      a.assert( true,g[1] === 200,"cmpTest[1] === 200",11,'./array_comprehensions_test.js' );
      
      __LINE__ = 12;
      a.assert( true,g[2] === 300,"cmpTest[2] === 300",12,'./array_comprehensions_test.js' );
      ...
      __LINE__ = 15;
      a.assert( true,g[0] === "value1","cmpTest[0] === \"value1\"",15,'./array_comprehensions_test.js' );
      
      __LINE__ = 16;
      a.assert( true,g[1] === "value2","cmpTest[1] === \"value2\"",16,'./array_comprehensions_test.js' );
      
      __LINE__ = 17;
      a.assert( true,g[2] === "value3","cmpTest[2] === \"value3\"",17,'./array_comprehensions_test.js' );
      ...
      g = function () {
        try {
          ...
          __LINE__ = 0;
          g = a.hasIterator( g )?a.getIterator( g ) : g;
          
          __LINE__ = 0;
          if ( g.__nothrowNext__ ){
            __LINE__ = 0;
            while ( ( f = g.__nothrowNext__(  ) ) ){
              __LINE__ = 0;
              e.push( f );
            };
          } else {
            __LINE__ = 0;
            a.exceptionHandler( 19,'./array_comprehensions_test.js','for of statement expect iterator or generator object.' );
          };
          __LINE__ = 0;
          return e;
        } catch( e ){
      ...
      __LINE__ = 20;
      a.assert( true,g[0][0] === "value1","cmpTest[0][0] === \"value1\"",20,'./array_comprehensions_test.js' );
      
      __LINE__ = 21;
      a.assert( true,g[0][1] === 100,"cmpTest[0][1] === 100",21,'./array_comprehensions_test.js' );
      
      __LINE__ = 22;
      a.assert( true,g[1][0] === "value2","cmpTest[1][0] === \"value2\"",22,'./array_comprehensions_test.js' );
      
      __LINE__ = 23;
      a.assert( true,g[1][1] === 200,"cmpTest[1][1] === 200",23,'./array_comprehensions_test.js' );
      
      __LINE__ = 24;
      a.assert( true,g[2][0] === "value3","cmpTest[2][0] === \"value3\"",24,'./array_comprehensions_test.js' );
      
      __LINE__ = 25;
      a.assert( true,g[2][1] === 300,"cmpTest[2][1] === 300",25,'./array_comprehensions_test.js' );
      ...
      __LINE__ = 29;
      a.assert( true,g[0] === 200,"cmpTest[0] === 200",29,'./array_comprehensions_test.js' );
      ...
      __LINE__ = 32;
      a.assert( true,g[0] === "value2","cmpTest[0] === \"value2\"",32,'./array_comprehensions_test.js' );
      ...
      g = function () {
        try {
          ...
          if ( f.__nothrowNext__ ){
            ...
            __LINE__ = 0;
            a.exceptionHandler( 34,'./array_comprehensions_test.js','for of statement expect iterator or generator object.' );
          };
          __LINE__ = 0;
          return b;
        } catch( e ){
      ...
      __LINE__ = 35;
      a.assert( true,g[0][0] === "value2","cmpTest[0][0] === \"value2\"",35,'./array_comprehensions_test.js' );
      
      __LINE__ = 36;
      a.assert( true,g[0][1] === 200,"cmpTest[0][1] === 200",36,'./array_comprehensions_test.js' );
      ...
      __LINE__ = 45;
      a.assert( true,g[0] === 100,"cmpTest[0] === 100",45,'./array_comprehensions_test.js' );
      
      __LINE__ = 46;
      a.assert( true,g[1] === 200,"cmpTest[1] === 200",46,'./array_comprehensions_test.js' );
      
      __LINE__ = 47;
      a.assert( true,g[2] === 300,"cmpTest[2] === 300",47,'./array_comprehensions_test.js' );
      ...
      __LINE__ = 50;
      a.assert( true,g[0] === "value1","cmpTest[0] === \"value1\"",50,'./array_comprehensions_test.js' );
      
      __LINE__ = 51;
      a.assert( true,g[1] === "value2","cmpTest[1] === \"value2\"",51,'./array_comprehensions_test.js' );
      
      __LINE__ = 52;
      a.assert( true,g[2] === "value3","cmpTest[2] === \"value3\"",52,'./array_comprehensions_test.js' );
        ...
        try {
          ...
          for ( var e in c ){
            ...
            if ( g.__nothrowNext__ ){
              ...
              __LINE__ = 0;
              a.exceptionHandler( 54,'./array_comprehensions_test.js','for of statement expect iterator or generator object.' );
            };
          };
          __LINE__ = 0;
          return b;
      ...
      __LINE__ = 55;
      a.assert( true,g[0][0] === "value1","cmpTest[0][0] === \"value1\"",55,'./array_comprehensions_test.js' );
      
      __LINE__ = 56;
      a.assert( true,g[0][1] === 100,"cmpTest[0][1] === 100",56,'./array_comprehensions_test.js' );
      
      __LINE__ = 57;
      a.assert( true,g[1][0] === "value2","cmpTest[1][0] === \"value2\"",57,'./array_comprehensions_test.js' );
      
      __LINE__ = 58;
      a.assert( true,g[1][1] === 200,"cmpTest[1][1] === 200",58,'./array_comprehensions_test.js' );
      
      __LINE__ = 59;
      a.assert( true,g[2][0] === "value3","cmpTest[2][0] === \"value3\"",59,'./array_comprehensions_test.js' );
      
      __LINE__ = 60;
      a.assert( true,g[2][1] === 300,"cmpTest[2][1] === 300",60,'./array_comprehensions_test.js' );
