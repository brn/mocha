!function() {
        ...
        function () {
          return function () {
            var b = true,
                ...
                f = [],
                k = function ( j,k ) {
                  !j?b = false : j && b && arguments[1] !== undefined && a.exceptionHandler( 'attempt to send to newborn generator.' );
  ...
  !function () {
    ...
    var e = b['./array_comprehensions_test.js'],
        f = b['../../../../../../../home/brn/.mocha/module/iterators.js'],
        d = f.items,
        c =  {
          value1 : 100,
          value2 : 200,
    ...
    g = function () {
      ...
      if ( g.__nothrowNext__ ){
        while ( ( f = g.__nothrowNext__(  ) ) )e.push( f );
      } else {
    ...
    g = function () {
      ...
      if ( f.__nothrowNext__ ){
        while ( ( e = f.__nothrowNext__(  ) ) )e[1] === 200 && b.push( e );
      } else {
    ...
    g = function () {
      ...
      for ( var e in c ){
        ...
        if ( g.__nothrowNext__ ){
          while ( ( f = g.__nothrowNext__(  ) ) )b.push( f );
        } else {
