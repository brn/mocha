        ...
        try {
          ...
          function c( b,c,d ) {
            try {
              __LINE__ = 0;
              var e = b.args,
                  f = c.tmp && c.tmp["args2"]?c.tmp["args2"] : undefined,
                  g = d[0],
                  h = d[1],
                  i = d[2] && d[2].args5?d[2].args5 : undefined,
                  j = d[2] && d[2].args6 && d[2].args6.args7?d[2].args6.args7 : undefined,
                  k = a.toArray( arguments,3 );
              __LINE__ = 35;
              return console.log( 1 );
            } catch( e ){
              a.exceptionHandler( __LINE__ , __FILE__ , e );
