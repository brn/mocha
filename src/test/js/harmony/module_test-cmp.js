    ...
    try {
      ...
      var testModule1 = _mochaGlobalAlias.testModule1 = ( function testModule1() {
            try {
              ...
              __LINE__ = 0;
              _mochaLocalExport.testExport1 = function testExport1() {
                try {
                  __LINE__ = 4;
                  return arguments;
                } catch( e ){
            ...
            try {
              ...
              var testInnerModule3 = _mochaLocalExport.testInnerModule3 = ( function testInnerModule3() {
                    try {
                      ...
                      __LINE__ = 0;
                      _mochaLocalExport.testExport2 = function testExport2() {
                        try {
                          __LINE__ = 10;
                          return arguments;
                        } catch( e ){
        ...
        try {
          ...
          var testInnerModule4 = _mochaLocalExport.testInnerModule4 = ( function testInnerModule4() {
                try {
                  ...
                  __LINE__ = 0;
                  _mochaLocalExport.testExport4 = function testExport4() {
                    try {
                      __LINE__ = 17;
                      return arguments;
                    } catch( e ){
          ...
          __LINE__ = 0;
          _mochaLocalExport.testExport5 = function testExport5() {
            try {
              __LINE__ = 19;
              return arguments;
            } catch( e ){
