  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/harmony/module_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      c/*_mochaGlobalExport*/['./module_test.js'] = {};
      
      __LINE__ = 3;
      var b/*_mochaGlobalAlias*/ = c/*_mochaGlobalExport*/['./module_test.js'];
      
      __LINE__ = 0;
      var d/*testModule1*/ = b/*_mochaGlobalAlias*/.d/*testModule1*/ = ( function d/*testModule1*/() {
            try {
              __LINE__ = 2;
      ...
      __LINE__ = 0;
      var e/*testModule2*/ = b/*_mochaGlobalAlias*/.e/*testModule2*/ = ( function e/*testModule2*/() {
            try {
              __LINE__ = 8;
              var b/*_mochaLocalExport*/ = {};
              
              __LINE__ = 0;
              var c/*testInnerModule3*/ = b/*_mochaLocalExport*/.c/*testInnerModule3*/ = ( function c/*testInnerModule3*/() {
                    try {
                      __LINE__ = 9;
                      var b/*_mochaLocalExport*/ = {};
                      
                      __LINE__ = 0;
                      var c/*testExport2*/ = b/*_mochaLocalExport*/.testExport2 = function c/*testExport2*/() {
                            try {
                              __LINE__ = 10;
                              return 2;
                            } catch( e ){
                      ...
                      __LINE__ = 0;
                      var d/*testExport3*/ = b/*_mochaLocalExport*/.testExport3 =  {
                            test : 200
                          };
                      __LINE__ = 0;
                      return b/*_mochaLocalExport*/;
      ...
      ( function () {
        try {
          __LINE__ = 15;
          var c/*_mochaLocalExport*/ = b/*_mochaGlobalAlias*/;
          
          __LINE__ = 0;
          var d/*testInnerModule4*/ = c/*_mochaLocalExport*/.d/*testInnerModule4*/ = ( function d/*testInnerModule4*/() {
                try {
                  __LINE__ = 16;
                  var b/*_mochaLocalExport*/ = {};
          ...
          __LINE__ = 0;
          var e/*testExport5*/ = c/*_mochaLocalExport*/.testExport5 = function e/*testExport5*/() {
                try {
                  __LINE__ = 19;
                  return 4;
                } catch( e ){
