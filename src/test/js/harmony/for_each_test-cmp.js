!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 10;
      a.assert( true,e[0] === 100,"arr[0] === 100",10,'./for_each_test.js' );
      
      __LINE__ = 11;
      a.assert( true,e[1] === 200,"arr[1] === 200",11,'./for_each_test.js' );
      
      __LINE__ = 12;
      a.assert( true,e[2] === 300,"arr[2] === 300",12,'./for_each_test.js' );
      ...
      __LINE__ = 18;
      a.assert( true,e[0] === 100,"arr[0] === 100",18,'./for_each_test.js' );
      
      __LINE__ = 19;
      a.assert( true,e[1] === 200,"arr[1] === 200",19,'./for_each_test.js' );
      
      __LINE__ = 20;
      a.assert( true,e[2] === 300,"arr[2] === 300",20,'./for_each_test.js' );
      ...
      __LINE__ = 26;
      a.assert( true,e[0] === 100,"arr[0] === 100",26,'./for_each_test.js' );
      
      __LINE__ = 27;
      a.assert( true,e[1] === 200,"arr[1] === 200",27,'./for_each_test.js' );
      
      __LINE__ = 28;
      a.assert( true,e[2] === 300,"arr[2] === 300",28,'./for_each_test.js' );
      ...
      __LINE__ = 34;
      a.assert( true,e[0] === 100,"arr[0] === 100",34,'./for_each_test.js' );
      
      __LINE__ = 35;
      a.assert( true,e[1] === 200,"arr[1] === 200",35,'./for_each_test.js' );
      
      __LINE__ = 36;
      a.assert( true,e[2] === 300,"arr[2] === 300",36,'./for_each_test.js' );
      ...
      __LINE__ = 46;
      a.assert( true,e[0] === 100,"arr[0] === 100",46,'./for_each_test.js' );
      
      __LINE__ = 47;
      a.assert( true,e[1] === 200,"arr[1] === 200",47,'./for_each_test.js' );
      
      __LINE__ = 48;
      a.assert( true,e[2] === 300,"arr[2] === 300",48,'./for_each_test.js' );
    } catch( e ){
