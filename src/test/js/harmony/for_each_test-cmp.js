(function() {
  ...
  ( function () {
    p/*_mochaGlobalExport*/['./for_each_test.js'] = {};
    
    var b/*_mochaGlobalAlias*/ = p/*_mochaGlobalExport*/['./for_each_test.js'];
    ...
    for ( var e/*i*/ in c/*targetObject*/ ){
      e/*i*/ = c/*targetObject*/[e/*i*/];
    ...
    for ( f/*prop*/.val in c/*targetObject*/ ){
      f/*prop*/.val = c/*targetObject*/[f/*prop*/.val];
      
      d/*arr*/.push( f/*prop*/.val );
    };
  })();
})();
