(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./for_each_test.js'] = {};
    
    var I/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./for_each_test.js'];
    ...
    for ( var L/*i*/ in J/*targetObject*/ ){
      L/*i*/ = J/*targetObject*/[L/*i*/];
    ...
    for ( M/*prop*/.val in J/*targetObject*/ ){
      M/*prop*/.val = J/*targetObject*/[M/*prop*/.val];
      
      K/*arr*/.push( M/*prop*/.val );
    };
  })();
})();
