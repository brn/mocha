(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/harmony/generator_expression_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./generator_expression_test.js'] = {};
      
      __LINE__ = 3;
      var c/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./generator_expression_test.js'];
      
      __LINE__ = 0;
      var d/*_mochaLocalTmp0*/ = b/*_mochaGlobalExport*/['../../../../../../../home/brn/.mocha/module/iterators.js'],
          e/*keys*/ = d/*_mochaLocalTmp0*/.keys,
          f/*allItems*/ = d/*_mochaLocalTmp0*/.allItems;
                      ...
                      while ( 1 ){
                        ...
                        switch ( b/*_yieldState*/ ) {
                          case 0 :
                            ...
                            __LINE__ = 8;
                            for ( var e/*_mochaLocalTmp1*/ in g/*testObject*/ ){
                          ...
                          case 1 :
                            ...
                            __LINE__ = 0;
                            f/*x*/ = h/*_mochaLocalTmp2*/[f/*_mochaLocalTmp3*/];
                            
                            __LINE__ = 0;
                            f/*x*/ = g/*testObject*/[f/*x*/];
                            __LINE__ = 0;
                            return f/*x*/;
                          case 2 :
      ...
      __LINE__ = 10;
      a/*Runtime*/.assert( true,h/*test*/.next() === 100,"test.next() === 100",10,'./generator_expression_test.js' );
      
      __LINE__ = 11;
      a/*Runtime*/.assert( true,h/*test*/.next() === 200,"test.next() === 200",11,'./generator_expression_test.js' );
      
      __LINE__ = 12;
      a/*Runtime*/.assert( true,h/*test*/.next() === 300,"test.next() === 300",12,'./generator_expression_test.js' );
      ...
      h/*test*/ = ( function () {
        try {
          ...
          __LINE__ = 0;
          var f/*_mochaLocalTmp4*/ = e/*keys*/( g/*testObject*/ );
                  ...
                  while ( 1 ){
                    ...
                    switch ( b/*_yieldState*/ ) {
                      ...
                      case 1 :
                        ...
                        __LINE__ = 0;
                        if ( !( ( e/*x*/ = f/*_mochaLocalTmp4*/.__nothrowNext__(  ) ) ) ){
                          __LINE__ = 0;
                          b/*_yieldState*/ = 4;
                          __LINE__ = 0;
                          break;
                      ...
                      case 5 :
                        ...
                        __LINE__ = 0;
                        a/*Runtime*/.exceptionHandler( 14,'./generator_expression_test.js','for of statement expect iterator or generator object.' );
                      case 6 :
                      case -1 :
      ...
      __LINE__ = 16;
      a/*Runtime*/.assert( true,h/*test*/.next() === "value1","test.next() === \"value1\"",16,'./generator_expression_test.js' );
      
      __LINE__ = 17;
      a/*Runtime*/.assert( true,h/*test*/.next() === "value2","test.next() === \"value2\"",17,'./generator_expression_test.js' );
      
      __LINE__ = 18;
      a/*Runtime*/.assert( true,h/*test*/.next() === "value3","test.next() === \"value3\"",18,'./generator_expression_test.js' );
                  ...
                  while ( 1 ){
                    ...
                    switch ( b/*_yieldState*/ ) {
                      case 0 :
                        ...
                        __LINE__ = 20;
                        for ( var e/*_mochaLocalTmp5*/ in g/*testObject*/ ){
                      ...
                      case 1 :
                        ...
                        __LINE__ = 0;
                        f/*x*/ = h/*_mochaLocalTmp6*/[f/*_mochaLocalTmp7*/];
      ...
      __LINE__ = 21;
      a/*Runtime*/.assert( true,h/*test*/.next() === 200,"test.next() === 200",21,'./generator_expression_test.js' );
      ...
      h/*test*/ = ( function () {
        try {
          ...
          __LINE__ = 0;
          var f/*_mochaLocalTmp8*/ = e/*keys*/( g/*testObject*/ );
                  ...
                  while ( 1 ){
                    ...
                    switch ( b/*_yieldState*/ ) {
                      case 0 :
                        ...
                        __LINE__ = 0;
                        f/*_mochaLocalTmp8*/ = a/*Runtime*/.hasIterator( f/*_mochaLocalTmp8*/ )?a/*Runtime*/.getIterator( f/*_mochaLocalTmp8*/ ) : f/*_mochaLocalTmp8*/;
                        
                        __LINE__ = 0;
                        if ( f/*_mochaLocalTmp8*/.__nothrowNext__ ){
                          __LINE__ = 0;
                          b/*_yieldState*/ = 1;
                          __LINE__ = 0;
                          break;
                      ...
                      case 1 :
                        ...
                        __LINE__ = 0;
                        if ( !( ( e/*x*/ = f/*_mochaLocalTmp8*/.__nothrowNext__(  ) ) ) ){
                          __LINE__ = 0;
                          b/*_yieldState*/ = 6;
                          __LINE__ = 0;
                          break;
                      ...
                      case 7 :
                        ...
                        __LINE__ = 0;
                        a/*Runtime*/.exceptionHandler( 23,'./generator_expression_test.js','for of statement expect iterator or generator object.' );
                      case 8 :
                      case -1 :
      ...
      __LINE__ = 24;
      a/*Runtime*/.assert( true,h/*test*/.next() === "value2","test.next() === \"value2\"",24,'./generator_expression_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  })();
