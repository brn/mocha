!function() {
  ...
  !function () {
    try {
      ...
      __LINE__ = 10;
      a.assert( true,h.next() === 100,"test.next() === 100",10,'./generator_expression_test.js' );
      
      __LINE__ = 11;
      a.assert( true,h.next() === 200,"test.next() === 200",11,'./generator_expression_test.js' );
      
      __LINE__ = 12;
      a.assert( true,h.next() === 300,"test.next() === 300",12,'./generator_expression_test.js' );
      ...
      __LINE__ = 16;
      a.assert( true,h.next() === "value1","test.next() === \"value1\"",16,'./generator_expression_test.js' );
      
      __LINE__ = 17;
      a.assert( true,h.next() === "value2","test.next() === \"value2\"",17,'./generator_expression_test.js' );
      
      __LINE__ = 18;
      a.assert( true,h.next() === "value3","test.next() === \"value3\"",18,'./generator_expression_test.js' );
      ...
      __LINE__ = 21;
      a.assert( true,h.next() === 200,"test.next() === 200",21,'./generator_expression_test.js' );
      ...
      __LINE__ = 24;
      a.assert( true,h.next() === "value2","test.next() === \"value2\"",24,'./generator_expression_test.js' );
    } catch( e ){
      a.exceptionHandler( __LINE__ , __FILE__ , e );
    }
  }();
