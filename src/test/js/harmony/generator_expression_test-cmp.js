(function() {
  ...
  ( function () {
    p/*_mochaGlobalExport*/['./generator_expression_test.js'] = {};
    
    var m/*_mochaGlobalAlias*/ = p/*_mochaGlobalExport*/['./generator_expression_test.js'];
    
    var n/*_mochaLocalTmp0*/ = p/*_mochaGlobalExport*/['../../../../../../.mocha/module/iterators.js'],
        o/*keys*/ = n/*_mochaLocalTmp0*/.keys,
        q/*allItems*/ = n/*_mochaLocalTmp0*/.allItems;
                ...
                while ( 1 ){
                  switch ( a/*_yieldState*/ ) {
                    case 0 :
                      ...
                      for ( var _mochaLocalTmp1 in r/*testObject*/ )
                    ...
                    case 1 :
                      ...
                      i/*x*/ = q/*_mochaLocalTmp2*/[p/*_mochaLocalTmp3*/];
                      
                      i/*x*/ = r/*testObject*/[i/*x*/];
                      return i/*x*/;
                    case 2 :
    ...
    s/*test*/ = ( function () {
      ...
      var o/*_mochaLocalTmp4*/ = o/*keys*/( r/*testObject*/ );
            ...
            while ( 1 ){
              switch ( a/*_yieldState*/ ) {
                case 0 :
                  ...
                  o/*_mochaLocalTmp4*/ = l/*Runtime*/.hasIterator( o/*_mochaLocalTmp4*/ )?l/*Runtime*/.getIterator( o/*_mochaLocalTmp4*/ ) : o/*_mochaLocalTmp4*/;
                ...
                case 1 :
                  ...
                  if ( !( ( n/*x*/ = o/*_mochaLocalTmp4*/.__nothrowNext__(  ) ) ) ){
                    a/*_yieldState*/ = 4;
                    break;
                  };
                case 2 :
                ...
                case 5 :
                  ...
                  l/*Runtime*/.exceptionHandler( 14,'./generator_expression_test.js','for of statement expect iterator or generator object.' );
                case 6 :
                case -1 :
            ...
            while ( 1 ){
              switch ( a/*_yieldState*/ ) {
                case 0 :
                  ...
                  for ( var _mochaLocalTmp5 in r/*testObject*/ )
                  q/*_mochaLocalTmp6*/.push( _mochaLocalTmp5 );
                  
                  p/*_mochaLocalTmp7*/ = 0;
                  
                  o/*length*/ = q/*_mochaLocalTmp6*/.length;
                ...
                case 1 :
                  ...
                  i/*x*/ = q/*_mochaLocalTmp6*/[p/*_mochaLocalTmp7*/];
    ...
    s/*test*/ = ( function () {
      ...
      var o/*_mochaLocalTmp8*/ = o/*keys*/( r/*testObject*/ );
            ...
            while ( 1 ){
              switch ( a/*_yieldState*/ ) {
                case 0 :
                  ...
                  o/*_mochaLocalTmp8*/ = l/*Runtime*/.hasIterator( o/*_mochaLocalTmp8*/ )?l/*Runtime*/.getIterator( o/*_mochaLocalTmp8*/ ) : o/*_mochaLocalTmp8*/;
                  
                  if ( o/*_mochaLocalTmp8*/.__nothrowNext__ ){
                    a/*_yieldState*/ = 1;
                    break;
                  } else {
                    a/*_yieldState*/ = 7;
                ...
                case 1 :
                  ...
                  if ( !( ( n/*x*/ = o/*_mochaLocalTmp8*/.__nothrowNext__(  ) ) ) ){
                    a/*_yieldState*/ = 6;
                    break;
                  };
                case 2 :
                ...
                case 7 :
                  ...
                  l/*Runtime*/.exceptionHandler( 23,'./generator_expression_test.js','for of statement expect iterator or generator object.' );
                case 8 :
                case -1 :
