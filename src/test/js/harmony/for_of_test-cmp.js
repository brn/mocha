!function() {
  ...
  !function () {
    ...
    var h = function ( b ) {
          ...
          function () {
            var c = true,
                ...
                e = [],
                j = function ( i,j ) {
                  !i?c = false : i && c && arguments[1] !== undefined && a.exceptionHandler( 'attempt to send to newborn generator.' );
    ...
    if ( m.__nothrowNext__ ){
      while ( ( d = m.__nothrowNext__(  ) ) )l.push( d );
    } else {
    ...
    if ( o.__nothrowNext__ ){
      while ( ( n = o.__nothrowNext__(  ) ) )l.push( n );
    } else {
    ...
    if ( p.__nothrowNext__ ){
      while ( ( d = p.__nothrowNext__(  ) ) )l.push( d );
    } else {
