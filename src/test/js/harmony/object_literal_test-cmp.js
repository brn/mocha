(function() {
  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/harmony/object_literal_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./object_literal_test.js'] = {};
      
      __LINE__ = 3;
      var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./object_literal_test.js'];
      ...
      __LINE__ = 0;
      a/*Runtime*/.extend( a/*Runtime*/.extend( a/*Runtime*/.extend( e/*testObject*/, {
        z : 400
      }), {
        z2 : 800
      }), {
