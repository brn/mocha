!function() {
  ...
  !function () {
    ...
    var h = function () {
          ...
          d.prototype.attack = function attack( a ) {
            log( 'The monster attacks '+a );
          };
          
          d.prototype.isAlive = function isAlive() {
            return a.getPrivateRecord( this ).health>0;
          };
          
          d.prototype.health = function health( b ) {
            if ( b<0 ){
          ...
          a.createUnenumProp( d.prototype,"constructor",constructor );
          return d;
        }();
    
    var i = new h( "slime",100 );
    ...
    var d = function () {
          ...
          b.prototype.getName = function getName() {
            return e.getName.constructor.call( this );
          };
          
          a.createUnenumProp( f.prototype,"constructor",constructor );
          return f;
        }();
    ...
    var j = function () {
          ...
          function c() {
            return e.constructor.call( this );
          }
          a.createUnenumProp( c,"__harmony_class__",1 );
          
          f.prototype.getAddr = function getAddr() {
    ...
    var k = function () {
          ...
          d.prototype.getAge = function getAge() {
    ...
    var p = function () {
          ...
          g.prototype.doTestm1 = function doTestm1() {
            return "aaa";
          };
          
          g.prototype.doTestm2 = function doTestm2() {
            return "bbb";
          };
          ...
          a.checkRequirements( g,b,[e,f],'./class_test.js',107 );
          
          a.createUnenumProp( g.prototype,"constructor",constructor );
          return g;
        }();
