(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./class_test.js'] = {};
    
    var P/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./class_test.js'];
    
    var b/*Monster*/ = ( function () {
          var d/*_mochaPrivateHolder*/ = function (){};
          
          function g/*Monster*/() {
            m/*Runtime*/.createPrivateRecord( this,d/*_mochaPrivateHolder*/ );
            
            e/*constructor*/.apply( this,arguments );
          };
          
          function e/*constructor*/( g/*name*/,h/*health*/ ) {
            
            this.name = g/*name*/;
            
            m/*Runtime*/.getPrivateRecord( this ).health = h/*health*/;
          }
          m/*Runtime*/.createUnenumProp( e/*constructor*/,"__harmony_class__",1 );
          
          g/*Monster*/.prototype.attack = function attack( b/*target*/ ) {
            log( 'The monster attacks '+b/*target*/ );
          };
          
          g/*Monster*/.prototype.isAlive = function isAlive() {
            return m/*Runtime*/.getPrivateRecord( this ).health>0;
          };
          
          g/*Monster*/.prototype.health = function health( b/*value*/ ) {
            if ( b/*value*/<0 ){
              throw new Error( 'Health must be non-negative.' );
            };
            
            m/*Runtime*/.getPrivateRecord( this ).health = b/*value*/;
          };
          
          g/*Monster*/.prototype.numAttacks = 0;
          
          m/*Runtime*/.constant( g/*Monster*/.prototype,'attackMessage','The monster hits you!' );
          
          m/*Runtime*/.constant( g/*Monster*/,'DEFAULT_LIFE',100 );
          
          m/*Runtime*/.createUnenumProp( g/*Monster*/.prototype,"constructor",constructor );
          return g/*Monster*/;
        })();
    
    var Q/*monster*/ = new b/*Monster*/( "slime",100 );
    
    var d/*BaseTest*/ = ( function () {
          var b/*_mochaPrivateHolder*/ = function (){};
          
          function f/*BaseTest*/() {
            m/*Runtime*/.createPrivateRecord( this,b/*_mochaPrivateHolder*/ );
            
            c/*constructor*/.apply( this,arguments );
          };
          
          function c/*constructor*/( d/*_mochaLocalTmp2*/,e/*_mochaLocalTmp3*/,f/*_mochaLocalTmp4*/ ) {
            this.name = d/*_mochaLocalTmp2*/ || 200;
            
            m/*Runtime*/.getPrivateRecord( this ).addr = e/*_mochaLocalTmp3*/ || "tokyo";
            
            m/*Runtime*/.getPrivateRecord( this ).age = f/*_mochaLocalTmp4*/;
          }
          m/*Runtime*/.createUnenumProp( c/*constructor*/,"__harmony_class__",1 );
          
          f/*BaseTest*/.prototype.getName = function getName() {
            return "hogehoge";
          };
          
          f/*BaseTest*/.getName = function getName() {
            return "static hogehoge";
          };
          
          m/*Runtime*/.createUnenumProp( f/*BaseTest*/.prototype,"constructor",constructor );
          return f/*BaseTest*/;
        })();
    
    var f/*DeriveTest*/ = ( function () {
          var a/*_mochaPrivateHolder*/ = function (){};
          
          function k/*DeriveTest*/() {
            m/*Runtime*/.createPrivateRecord( this,a/*_mochaPrivateHolder*/ );
            
            b/*constructor*/.apply( this,arguments );
          };
          
          var l/*_mochaLocalTmp6*/ = d/*BaseTest*/;
          
          m/*Runtime*/.extendClass( k/*DeriveTest*/,l/*_mochaLocalTmp6*/ );
          
          var c/*_mochaSuper*/ = m/*Runtime*/.getSuper( l/*_mochaLocalTmp6*/ );
          
          function b/*constructor*/() {
            c/*_mochaSuper*/.constructor.call( this );
          }
          m/*Runtime*/.createUnenumProp( b/*constructor*/,"__harmony_class__",1 );
          
          a/*_mochaPrivateHolder*/.prototype.getName = function getName() {
            return c/*_mochaSuper*/.getName.constructor.call( this );
          };
          
          m/*Runtime*/.createUnenumProp( k/*DeriveTest*/.prototype,"constructor",constructor );
          return k/*DeriveTest*/;
        })();
    ...
    var k/*Derive2*/ = ( function () {
          ...
          var q/*_mochaLocalTmp8*/ = f/*DeriveTest*/;
          
          m/*Runtime*/.extendClass( p/*Derive2*/,q/*_mochaLocalTmp8*/ );
          
          var c/*_mochaSuper*/ = m/*Runtime*/.getSuper( q/*_mochaLocalTmp8*/ );
          
          function b/*constructor*/() {
            return c/*_mochaSuper*/.constructor.call( this );
          }
          m/*Runtime*/.createUnenumProp( b/*constructor*/,"__harmony_class__",1 );
          
          p/*Derive2*/.prototype.getAddr = function getAddr() {
            return m/*Runtime*/.getPrivateRecord( this ).addr;
          };
          
          m/*Runtime*/.createUnenumProp( p/*Derive2*/.prototype,"constructor",constructor );
          return p/*Derive2*/;
        })();
    
    var R/*TestClass*/ = ( function () {
          var h/*_mochaPrivateHolder*/ = function (){};
          
          function i/*_mochaLocalTmp10*/() {
            m/*Runtime*/.createPrivateRecord( this,h/*_mochaPrivateHolder*/ );
            
            f/*constructor*/.apply( this,arguments );
          };
          
          function f/*constructor*/( c/*_mochaLocalTmp11*/,d/*_mochaLocalTmp12*/ ) {
            m/*Runtime*/.getPrivateRecord( this )._name = c/*_mochaLocalTmp11*/ || "test";
            
            m/*Runtime*/.getPrivateRecord( this )._age = d/*_mochaLocalTmp12*/ || 20;
          }
          m/*Runtime*/.createUnenumProp( f/*constructor*/,"__harmony_class__",1 );
          
          i/*_mochaLocalTmp10*/.prototype.getName = function getName() {
            return m/*Runtime*/.getPrivateRecord( this )._name;
          };
          
          i/*_mochaLocalTmp10*/.prototype.getAge = function getAge() {
            return m/*Runtime*/.getPrivateRecord( this )._age;
          };
          
          h/*_mochaPrivateHolder*/.prototype.Inner = ( function () {
            var a/*_mochaPrivateHolder*/ = function (){};
            ...
            m/*Runtime*/.createUnenumProp( i/*Inner*/.prototype,"constructor",constructor );
            return i/*Inner*/;
          })();
          
          m/*Runtime*/.createUnenumProp( i/*_mochaLocalTmp10*/.prototype,"constructor",constructor );
          return i/*_mochaLocalTmp10*/;
        })();
    
    var S/*instance*/ = new R/*TestClass*/();
    ...
    var r/*TestTrait*/ =  {
          ...
          _mochaTraitPublic :  {
            testm1 : function T/*testm1*/(  ) {
              var b/*arg*/ = m/*Runtime*/.toArray( arguments,0 );
              return b/*arg*/[0];
            }
          },
          _mochaRequires :  {
    ...
    var s/*TestTrait2*/ =  {
          ...
          _mochaTraitPublic :  {
            testm2 : function U/*testm2*/(  ) {
              var b/*arg*/ = m/*Runtime*/.toArray( arguments,0 );
              return b/*arg*/[0];
            },
            testm3 : function V/*testm3*/() {
              return "ok";
            }
          },
          _mochaRequires :  {
    ...
    var p/*MixinTest*/ = ( function () {
          var b/*_mochaPrivateHolder*/ = function (){};
          
          function t/*MixinTest*/() {
            m/*Runtime*/.createPrivateRecord( this,b/*_mochaPrivateHolder*/ );
          ...
          t/*MixinTest*/.prototype.doTestm1 = function doTestm1() {
            return "aaa";
          };
          
          t/*MixinTest*/.prototype.doTestm2 = function doTestm2() {
            return "bbb";
          };
          
          m/*Runtime*/.classMixin( t/*MixinTest*/,b/*_mochaPrivateHolder*/,r/*TestTrait*/, {
            testm1 : "m1"
          },{});
          
          m/*Runtime*/.classMixin( t/*MixinTest*/,b/*_mochaPrivateHolder*/,s/*TestTrait2*/,{}, {
            testm2 : true,
            testm3 : true
          });
          
          m/*Runtime*/.checkRequirements( t/*MixinTest*/,b/*_mochaPrivateHolder*/,[r/*TestTrait*/,s/*TestTrait2*/],'./class_test.js',107 );
          
          m/*Runtime*/.createUnenumProp( t/*MixinTest*/.prototype,"constructor",constructor );
          return t/*MixinTest*/;
        })();
    
    var W/*instance2*/ = new p/*MixinTest*/();
  })();
})();
