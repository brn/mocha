(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./trait_test.js'] = {};
    
    var G/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./trait_test.js'];
    
    var J/*TestTraitP*/ =  {
          _mochaTraitPrivate :  {
            _greaterThant : function H/*_greaterThant*/( c/*x*/,d/*y*/ ) {
              return c/*x*/<d/*y*/;
            }
          },
          _mochaTraitPublic :  {
            greaterThan : function I/*greaterThan*/( c/*x*/,d/*y*/ ) {
              return c/*x*/<d/*y*/;
            }
          },
          _mochaRequires :  {
    ...
    var M/*TestTrait*/ =  {
          _mochaTraitPrivate :  {
            _lessThan : function K/*_lessThan*/( c/*x*/,d/*y*/ ) {
              return c/*x*/<d/*y*/;
            }
          },
          _mochaTraitPublic :  {
            lessThan : function L/*lessThan*/( c/*x*/,d/*y*/ ) {
              return c/*x*/<d/*y*/;
            }
          },
          _mochaRequires :  {
    ...
    m/*Runtime*/.traitMixin( M/*TestTrait*/,J/*TestTraitP*/, {
      greaterThan : "gt",
      _greaterThant : "_gt"
    },{});
    
    var N/*traitexp*/ = ( function () {
          var e/*_mochaLocalTmp0*/ =  {
                _mochaTraitPrivate :  {
                  mastercmp : function c/*mastercmp*/( c/*x*/,d/*y*/ ) {
                    return c/*x*/>d/*y*/;
                  }
                },
                _mochaTraitPublic :  {
                  lessthan : function d/*lessthan*/( c/*x*/,d/*y*/ ) {
                    return c/*x*/>d/*y*/;
                  }
                },
                _mochaRequires :  {
