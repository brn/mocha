!function() {
  ...
  !function () {
    ...
    var c = b['./trait_test.js'];
    
    var f =  {
          _mochaTraitPrivate :  {
            _greaterThant : function d( a,b ) {
              return a<b;
            }
          },
          _mochaTraitPublic :  {
            greaterThan : function e( a,b ) {
              return a<b;
            }
          },
          _mochaRequires :  {
    ...
    var i =  {
          _mochaTraitPrivate :  {
            _lessThan : function g( a,b ) {
              return a<b;
            }
          },
          _mochaTraitPublic :  {
            lessThan : function h( a,b ) {
              return a<b;
            }
          },
          _mochaRequires :  {
    ...
    var j = function () {
          var c =  {
                _mochaTraitPrivate :  {
                  mastercmp : function a( a,b ) {
                    return a>b;
                  }
                },
                _mochaTraitPublic :  {
                  lessthan : function b( a,b ) {
                    return a>b;
                  }
                },
                _mochaRequires :  {
