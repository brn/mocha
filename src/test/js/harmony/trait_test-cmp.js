(function() {
  ...
  ( function () {
    p/*_mochaGlobalExport*/['./trait_test.js'] = {};
    
    var a/*_mochaGlobalAlias*/ = p/*_mochaGlobalExport*/['./trait_test.js'];
    
    var d/*TestTraitP*/ =  {
          _mochaTraitPrivate :  {
            _greaterThant : function b/*_greaterThant*/( a/*x*/,b/*y*/ ) {
              return a/*x*/<b/*y*/;
            }
          },
          _mochaTraitPublic :  {
            greaterThan : function c/*greaterThan*/( a/*x*/,b/*y*/ ) {
              return a/*x*/<b/*y*/;
            }
          },
          _mochaRequires :  {
    ...
    var g/*TestTrait*/ =  {
          _mochaTraitPrivate :  {
            _lessThan : function e/*_lessThan*/( a/*x*/,b/*y*/ ) {
              return a/*x*/<b/*y*/;
            }
          },
          _mochaTraitPublic :  {
            lessThan : function f/*lessThan*/( a/*x*/,b/*y*/ ) {
              return a/*x*/<b/*y*/;
            }
          },
          _mochaRequires :  {
    ...
    l/*Runtime*/.traitMixin( g/*TestTrait*/,d/*TestTraitP*/, {
      greaterThan : "gt",
      _greaterThant : "_gt"
    },{});
    
    var h/*traitexp*/ = ( function () {
          var c/*_mochaLocalTmp0*/ =  {
                _mochaTraitPrivate :  {
                  mastercmp : function a/*mastercmp*/( a/*x*/,b/*y*/ ) {
                    return a/*x*/>b/*y*/;
                  }
                },
                _mochaTraitPublic :  {
                  lessthan : function b/*lessthan*/( a/*x*/,b/*y*/ ) {
                    return a/*x*/>b/*y*/;
                  }
                },
                _mochaRequires :  {
