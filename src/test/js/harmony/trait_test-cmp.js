  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/harmony/trait_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./trait_test.js'] = {};
      
      __LINE__ = 3;
      var c/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./trait_test.js'];
      
      __LINE__ = 0;
      var f/*TestTraitP*/ =  {
            _mochaTraitPrivate :  {
              _greaterThant : function d/*_greaterThant*/( b/*x*/,c/*y*/ ) {
                try {
                  __LINE__ = 2;
                  return b/*x*/<c/*y*/;
                } catch( e ){
            ...
            _mochaTraitPublic :  {
              greaterThan : function e/*greaterThan*/( b/*x*/,c/*y*/ ) {
                try {
                  __LINE__ = 3;
                  return b/*x*/<c/*y*/;
                } catch( e ){
      ...
      var i/*TestTrait*/ =  {
            _mochaTraitPrivate :  {
              _lessThan : function g/*_lessThan*/( b/*x*/,c/*y*/ ) {
                try {
                  __LINE__ = 10;
                  return b/*x*/<c/*y*/;
                } catch( e ){
            ...
            _mochaTraitPublic :  {
              lessThan : function h/*lessThan*/( b/*x*/,c/*y*/ ) {
                try {
                  __LINE__ = 11;
                  return b/*x*/<c/*y*/;
                } catch( e ){
      ...
      __LINE__ = 0;
      a/*Runtime*/.traitMixin( i/*TestTrait*/,f/*TestTraitP*/, {
        greaterThan : "gt",
        _greaterThant : "_gt"
      },{});
      
      __LINE__ = 14;
      var j/*traitexp*/ = ( function () {
            try {
              __LINE__ = 0;
              var d/*_mochaLocalTmp0*/ =  {
                    _mochaTraitPrivate :  {
                      mastercmp : function b/*mastercmp*/( b/*x*/,c/*y*/ ) {
                        try {
                          __LINE__ = 15;
                          return b/*x*/>c/*y*/;
                        } catch( e ){
                    ...
                    _mochaTraitPublic :  {
                      lessthan : function c/*lessthan*/( b/*x*/,c/*y*/ ) {
                        try {
                          __LINE__ = 16;
                          return b/*x*/>c/*y*/;
                        } catch( e ){
