  ...
  ( function () {
    try {
      var __FILE__ = "/var/samba/mocha/src/test/js/harmony/tuple_test.js",
          __LINE__ = 0;
      __LINE__ = 2;
      b/*_mochaGlobalExport*/['./tuple_test.js'] = {};
      
      __LINE__ = 3;
      var d/*_mochaGlobalAlias*/ = b/*_mochaGlobalExport*/['./tuple_test.js'];
      
      __LINE__ = 3;
      var e/*test*/ = a/*Runtime*/.createTuple(  {
            0 : 0,
            1 : 1,
            2 : 2,
            3 : 3
      ...
      __LINE__ = 4;
      var f/*test2*/ = a/*Runtime*/.createRecord(  {
            "name" : "foo",
            age : "20",
            addr : "tokyo"
          });
