(function() {
  ...
  ( function () {
    p/*_mochaGlobalExport*/['./tuple_test.js'] = {};
    
    var b/*_mochaGlobalAlias*/ = p/*_mochaGlobalExport*/['./tuple_test.js'];
    
    var c/*test*/ = l/*Runtime*/.createTuple(  {
          0 : 0,
          1 : 1,
          2 : 2,
          3 : 3
    ...
    var d/*test2*/ = l/*Runtime*/.createRecord(  {
          "name" : "foo",
          age : "20",
          addr : "tokyo"
        });
