(function() {
  ...
  ( function () {
    D/*_mochaGlobalExport*/['./tuple_test.js'] = {};
    
    var G/*_mochaGlobalAlias*/ = D/*_mochaGlobalExport*/['./tuple_test.js'];
    
    var H/*test*/ = m/*Runtime*/.createTuple(  {
          0 : 0,
          1 : 1,
          2 : 2,
          3 : 3
    ...
    var I/*test2*/ = m/*Runtime*/.createRecord(  {
          "name" : "foo",
          age : "20",
          addr : "tokyo"
        });
