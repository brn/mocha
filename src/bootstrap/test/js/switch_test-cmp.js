...
node=elem;case "last":
while ((node=node.nextSibling)){if (node.nodeType===1){return false;};};return true;case "nth":
first=match[2];
last=match[3];
...
if (first===0){return diff===0;} else {return (diff%first===0&&diff/first>=0);};break;default:
console.log(1);};})();