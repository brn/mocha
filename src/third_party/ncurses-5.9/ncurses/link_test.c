...
{
	T((T_CALLED("setcchar(%p,%p,%s,%d,%p)"), (const void *)a1, (const void *)a2, _traceattr2(2,a3), a4, (const void *)z)); returnCode(setcchar(a1, a2, a3, a4, z));
}
...
{
	T((T_CALLED("vid_attr(%s,%d,%p)"), _traceattr2(0,a1), a2, (const void *)z)); returnCode(vid_attr(a1, a2, z));
}
...
{
	T((T_CALLED("vid_puts(%s,%d,%p,%#lx)"), _traceattr2(0,a1), a2, (const void *)a3, (long)z)); returnCode(vid_puts(a1, a2, a3, z));
}
...
{
	T((T_CALLED("NCURSES_SP_NAME(vid_attr)(%p,%s,%d,%p)"), (const void *)a1, _traceattr2(1,a2), a3, (const void *)z)); returnCode(NCURSES_SP_NAME(vid_attr)(a1, a2, a3, z));
}
#endif


#if USE_SP_FUNC_SUPPORT
extern int call_NCURSES_SP_NAME___vid_puts (SCREEN * a1, attr_t a2, short a3, void * a4, NCURSES_OUTC z);
int call_NCURSES_SP_NAME___vid_puts (SCREEN * a1, attr_t a2, short a3, void * a4, NCURSES_OUTC z)
{
	T((T_CALLED("NCURSES_SP_NAME(vid_puts)(%p,%s,%d,%p,%#lx)"), (const void *)a1, _traceattr2(1,a2), a3, (const void *)a4, (long)z)); returnCode(NCURSES_SP_NAME(vid_puts)(a1, a2, a3, a4, z));
}
#endif
