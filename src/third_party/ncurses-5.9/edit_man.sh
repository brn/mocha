...
*.[0-9]*)
	...
	if test ! -f /var/samba/mocha/src/third_party/ncurses-5.9/man_alias.sed ; then
cat >>/var/samba/mocha/src/third_party/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /var/samba/mocha/src/third_party/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /var/samba/mocha/src/third_party/ncurses-5.9/man_alias.sed | sort -u`
	cf_target=`grep "^$cf_source" /var/samba/mocha/src/third_party/ncurses-5.9/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /var/samba/mocha/src/third_party/ncurses-5.9/man_alias.sed \
		< $i | sed -f /var/samba/mocha/src/third_party/ncurses-5.9/edit_man.sed >$TMP
