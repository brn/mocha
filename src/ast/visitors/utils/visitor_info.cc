...
VisitorInfo::VisitorInfo( Scope* scope , Compiler *compiler,
    ...
    tmp_index_( 0 ) , is_dst_injection_( false ), is_rest_injection_( false ),is_in_module_( 1 ), main_file_path_( main_file_path ),
    file_name_( file_name ) , version_( XMLSettingInfo::GetVersion( main_file_path ) ) ,dsta_exp_( dsta_exp ),
