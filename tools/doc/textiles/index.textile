...
* cursesかncurses (osx, linux) -> おそらく最初から入ってる。

h2. ガイド

* "最初の一歩":first_step_guide.html
* 設定ファイルを作る
** "config.js":config.js_guide.html
** "コンパイル設定ファイル":compile_setting_guide.html
** "コマンドの設定":command_guide.html
* 設定用jsファイル
** "環境":env_guide.html
** "v8javascript engine":v8_guide.html
* コンパイル
** "コンパイルの実行":option_guide.html
** "コンパイラ拡張":compiler_directive_guide.html
* テスト
** "phantomjsを使う":phantomjs_guide.html
* "APIリファレンス":api_guide.html
