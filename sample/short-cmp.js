(function(){
  ...
  __global_exports["/var/samba/back/jpm/sample/jquery-1.6.2.js"] = (function(){
    var exports = {};
    @module("jQuery");
          ...
          if (notxml) {
            ...
            if (!hooks) {
              if (rboolean.test(name)) {
                hooks = boolHook;
              } else if (formHook && name !== "className" && (jQuery.nodeName(elem, "form") || rinvalidChar.test(name))) {
                hooks = formHook;
              }
            }
          }
  ...
  __global_exports["/var/samba/back/jpm/sample/short.js"] = (function(){
    var exports = {};
    var core = __global_exports["./jquery-1.6.2.js"];
    var m = obj.xgs.grig.shkg.wog.t();
    var x = function () {
          var x = function test() {
                return this._name;
              };
