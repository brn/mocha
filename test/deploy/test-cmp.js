(function() {
  ...
  ( function () {
    ( function () {
      ...
      var x = _mochaLocalExport.x = function () {
            var _mochaLocalTmp0;
            return _mochaLocalTmp0 = [200,300];
          };
      return _mochaLocalExport;
    })();
  })();
  ...
  ( function () {
    ...
    var _mochaLocalTmp1 = _mochaGlobalExport['{1-397-1092-205522212-1695-60819241-52432-jquery-devel.js}'],
        jQuery = _mochaLocalTmp1.jQuery;
    var Monster = ( function () {
          ...
          Runtime.createUnenumProp( Monster,'constructor',function constructor( name,health ) {
            ...
            Runtime.constant( this.__private__,'name',( _mochaLocalTmp3.x && _mochaLocalTmp3.x[0] )?_mochaLocalTmp3.x[0] : undefined );
            Runtime.constant( this.__private__,'age',( _mochaLocalTmp3.x && _mochaLocalTmp3.x[1] )?_mochaLocalTmp3.x[1] : undefined );
            Runtime.constant( this.__private__,'hobby',( _mochaLocalTmp3.x && _mochaLocalTmp3.x[2] && _mochaLocalTmp3.x[2].hobby )?_mochaLocalTmp3.x[2].hobby : undefined );
          ...
          Monster.name = ( _mochaLocalTmp4.human && _mochaLocalTmp4.human.name )?_mochaLocalTmp4.human.name : undefined;
          Monster.age = ( _mochaLocalTmp4.human && _mochaLocalTmp4.human.age )?_mochaLocalTmp4.human.age : undefined;
          Monster.h1 = ( _mochaLocalTmp4.human && _mochaLocalTmp4.human.hobby && _mochaLocalTmp4.human.hobby[0] )?_mochaLocalTmp4.human.hobby[0] : undefined;
          Monster.h2 = ( _mochaLocalTmp4.human && _mochaLocalTmp4.human.hobby && _mochaLocalTmp4.human.hobby[1] )?_mochaLocalTmp4.human.hobby[1] : undefined;
          Monster.h3 = ( _mochaLocalTmp4.human && _mochaLocalTmp4.human.hobby && _mochaLocalTmp4.human.hobby[2] )?_mochaLocalTmp4.human.hobby[2] : undefined;
          var _mochaLocalTmp5 = human_;
          Monster.name_ = ( _mochaLocalTmp5.human_ && _mochaLocalTmp5.human_.name_ )?_mochaLocalTmp5.human_.name_ : undefined;
          Monster.age_ = ( _mochaLocalTmp5.human_ && _mochaLocalTmp5.human_.age_ )?_mochaLocalTmp5.human_.age_ : undefined;
          Monster.h1_ = ( _mochaLocalTmp5.human_ && _mochaLocalTmp5.human_.hobby_ && _mochaLocalTmp5.human_.hobby_[0] )?_mochaLocalTmp5.human_.hobby_[0] : undefined;
          Monster.h2_ = ( _mochaLocalTmp5.human_ && _mochaLocalTmp5.human_.hobby_ && _mochaLocalTmp5.human_.hobby_[1] )?_mochaLocalTmp5.human_.hobby_[1] : undefined;
          Monster.h3_ = ( _mochaLocalTmp5.human_ && _mochaLocalTmp5.human_.hobby_ && _mochaLocalTmp5.human_.hobby_[2] )?_mochaLocalTmp5.human_.hobby_[2] : undefined;
          return Monster;
        })();
    ;
  })();
