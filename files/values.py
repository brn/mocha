...
'first_step_guide.html' : {
        ...
        'en' : {
            ...
            'comp_setting_proto_ext_sub' : 'Specify whether add the prototype extensions for es5 and harmony. This value is true by default.',
            ...
            'comp_dir_inst_sub' : 'A instance member shortcut.',
...
'api_guide.html' : {
        ...
        'en' : {
            ...
            'fs_open' : 'Open a file with the file stream. And you can pass the flags as a second argument, the list of flags is below. e.g. fs.open(path , \'rw\');',
            'fs_read' : 'Read the contents of a file. This is same as <code>fs.open(\'foo\').read();</code>',
            'fs_write' : 'Write to a file. This is same as <code>fs.open(\'foo\').write(\'bar\');</code>',
            'fs_listdir' : 'Get the list of the directries and files. If second arguments is \'true\', get all entries which include sub directories. This method return an array of fs.Entry.',
            'fs_getcwd' : 'Get the current working directory.',
            'fs_make_directory' : 'Create a directory tree.',
            'fs_chdir' : 'Change the current working directory.',
            'fs_remove' : 'Remove a file or a directory which include sub directories.',
            'fs_move' : 'Move a file or a directory.',
            'fs_copy' : 'Copy a file.',
            'fs_copy_tree' : 'Copy a file or a directory which include sub directories.',
            'fs_file_write' : 'Write a string to the file stream.',
            'fs_file_read' : 'Read from the file stream',
            'fs_file_close' : 'Close file stream.',
            'fs_entry_dir' : 'String value of a parent directory name.',
            'fs_entry_isfile' : 'Boolean flag of checking whether the path is a file or not.',
            'fs_entry_isdir' : 'Boolean flag of checking whether the path is a directory or not.',
            'fs_entry_name' : 'String value of the path name.',
            'fs_entry_fullpath' : 'String value of an absolute path of the path.',
            'fs_path_abspath' : 'Get an absolute path of a argument path.',
            'fs_path_basename' : 'Get a last path component of a argument path.',
            'fs_path_normal' : 'Normalize the path components of a argument path. e.g. \'/foo/./bar/./baz\' -> \'/foo/bar/baz\'',
            'fs_path_join' : 'Join all arguments by the path separator. The path separator is \'/\' in the all systems.',
            'fs_path_split' : 'Split a argument path by the path separator.',
            'fs_path_relative' : 'Get the relative path from a argument \'from\' to a argument \'to\'.',
            'fs_path_atime' : 'Return the string expression of the time of access of the path.',
            'fs_path_mtime' : 'Return the string expression of the time of modification of the path.',
            'fs_path_ctime' : 'Return the string expression of the time of status change of the path.',
            'fs_path_isexist' : 'Check whether a argument path is there or not.',
            'fs_path_isdir' : 'Check wheter a argument path is directory or not.',
            'fs_path_isfile' : 'Check wheter a argument path is file or not.',
            'os_spawn' : 'Create a child process and get string expression of the result.',
            'os_name' : 'Get system name. If you use the windows, this method return "Windows". If your os is not the windows, this method return the result of uname().',
            'os_system' : 'Call a c language\'s system function.',
            'os_run' : 'Run a application. In the windows, this method use a "start" command. In the posix os, this method use a "open" command.',
            'script_watcher_run' : 'Start the file observation.',
            'script_watcher_exit' : 'Exit the file observation',
            'script_watcher_isRunning' : 'Checking whether the file observation is now running or not.',
            'script_watcher_addSetting' : 'Add a new file to the observation subjects.',
            'script_watcher_removeSetting' : 'Remove a file from the observation subject list.',
            'script_watcher_getSetting' : 'Get a specified setting.',
            'script_compiler_compile' : 'Compile a argument str and return results.',
            'script_compiler_compileFile' : 'Compile a file and return results.',
            'script_compiler_deploy' : 'According to the setting lists, compile files which are registered by setting. The targets can chose by the predicate. You can specify predicate from any of function or regular expression or string. If you choose a function, that function receive the object which contain all options and filename as the arguments. If you choose others, a file which has filename matched with predicate is compiled.',
            'script_compiler_checkDependencies' : 'Inspect dependencies of the file and return an array of a filename.',
            'mocha_config_set' : 'Set a value which specified by a key to the setting',
            'mocha_config_get' : 'Get a value which specified by a key from the setting.',
            'mocha_import' : 'load a javascript file which specified as path. The module searching is do like below.',
            'mocha_import2' : 'Search files by relative path.',
            'mocha_import3' : 'Search native modules first, and if not exist, search files by relative path.',
            'mocha_export' : 'Export a value as name. The exported value can get by the above import method.',
            'mocha_loadfile' : 'Load a text file.',
            'mocha_addCommand' : 'Add a command which specified by a name argument.',
            'mocha_getCommand' : 'Get a command which specified by a name argument.',
            'mocha_callCommand' : 'Call command which specified by a name argument.'
            }
        }
}
