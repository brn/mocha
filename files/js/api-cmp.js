!function() {
  ...
  !function () {
    try {
      var __FILE__ = "functions",
          __LINE__ = 0;
      __LINE__ = 2;
      Runtime.modules.add('functions');
      
      __LINE__ = 0;
      var Functions = Runtime.modules.get('functions').Functions = function () {
            function compose(fns) {
              try {
                __LINE__ = 12;
                fns = Runtime.toArray(arguments,0);
  ...
  !function () {
    try {
      var __FILE__ = "-872173050-consts.js",
          __LINE__ = 0;
      __LINE__ = 2;
      Runtime.modules.add('-872173050-consts.js');
      
      __LINE__ = 1;
      var _mochaLocalTmp0 = Runtime.modules.get('functions'),
          Functions = _mochaLocalTmp0.Functions,
          consts = Runtime.modules.get('-872173050-consts.js').consts = function () {
            try {
              __LINE__ = 2;
              var _mochaLocalExport = {},
  ...
  !function () {
    try {
      var __FILE__ = "-872173050-api.js",
          __LINE__ = 0;
      __LINE__ = 2;
      Runtime.modules.add('-872173050-api.js');
      try{
  throw new SyntaxError("Y:/mocha/files/js/source/jQuery.js No such file.")
}catch(e){
  throw new Error(e);
}
;try{
  throw new SyntaxError("Y:/mocha/files/js/source/jQuery.color.js No such file.")
}catch(e){
  throw new Error(e);
}
;
      ...
      !function () {
        try {
          try{
  throw new SyntaxError("Y:/mocha/files/js/source/prettify.js No such file.")
}catch(e){
  throw new Error(e);
}
;
      ...
      __LINE__ = 8;
      var _mochaLocalTmp0 = Runtime.modules.get('-872173050-consts.js').consts,
          ...
          LeftNav = function () {
            function constructor() {
              try {
                ...
                __LINE__ = 12;
                Runtime.getPrivateRecord(this)._leftBlock = api.LEFT_BLOCK;
              } catch(e){
                Runtime.exceptionHandler(__LINE__, __FILE__, e);
              }
            }
            function LeftNav() {
              try {
                __LINE__ = 10;
                Runtime.initializeClass(this,LeftNav,_mochaPrivateHolder,constructor,arguments,'LeftNav',10);
              } catch(e){
                Runtime.exceptionHandler(__LINE__, __FILE__, e);
              }
            }
            try {
              ...
              LeftNav.prototype.addEvent = function () {
                try {
                  __LINE__ = 26;
                  $(document.body).on('click',api.LEFT_A_SELECTOR,Runtime.getPrivateRecord( this ).clickHandler.bind( this ));
                  
                  __LINE__ = 27;
                  $(document.body).on('mouseenter',api.LEFT_A_SELECTOR,Runtime.getPrivateRecord( this ).hoverHandler.bind( this ));
                  
                  __LINE__ = 28;
                  $(document.body).on('mouseleave',api.LEFT_A_SELECTOR,Runtime.getPrivateRecord( this ).hoverHandler.bind( this ));
                } catch(e){
                  Runtime.exceptionHandler(__LINE__, __FILE__, e);
                }
              };
              ...
              _mochaPrivateHolder.prototype.clickHandler = function (e) {
                try {
                  ...
                  if (!elem.parent().hasClass('active')){
                    ...
                    __LINE__ = 41;
                    Runtime.getPrivateRecord( this ).toggleHandler(elem);
                  }
              ...
              __LINE__ = 10;
              Runtime.createUnenumProp(LeftNav.prototype,"constructor",constructor);
              __LINE__ = 10;
              return LeftNav;
            } catch(e){
              Runtime.exceptionHandler(__LINE__, __FILE__, e);
