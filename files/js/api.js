    ...
    try {
      ...
      jQuery.extend(jQuery.easing, {
        ...
        easeOutBounce : function (x,t,b,c,d) {
          try {
            __LINE__ = 159;
            return (t /= d)<(0.363636)?c*(7.5625*t*t)+b : t<(0.727273)?c*(7.5625*(t -= (0.545455))*t+.75)+b : t<(0.909091)?c*(7.5625*(t -= (0.818182))*t+.9375)+b : c*(7.5625*(t -= (0.954545))*t+.984375)+b;
          } catch(__mocha_error){
            __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
          }
        },
  ...
  !function () {
    try {
      ...
      var _mochaLocalTmp0 = __Runtime.modules.get('1278969539-consts.js').consts,
          api = _mochaLocalTmp0.api,
          _mochaLocalTmp1 = __Runtime.modules.get('1278969539-agent.js'),
          agent = _mochaLocalTmp1.agent,
          LeftNav = function () {
            function constructor() {
              try {
                ...
                __LINE__ = 15;
                rightActive.find('pre.prettyprint code').each(function (i,item) {
                  try {
                    __LINE__ = 16;
                    return item.innerHTML = prettyPrintOne($(item).html());
                  } catch(__mocha_error){
                    __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
                  }
                ...
                __LINE__ = 7;
                __Runtime.getPrivateRecord(this)._leftBlock = api.LEFT_BLOCK;
              } catch(__mocha_error){
                __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
              }
            }
            function LeftNav() {
              try {
                __LINE__ = 5;
                __Runtime.initializeClass(this,LeftNav,_mochaPrivateHolder,constructor,arguments,'LeftNav',5);
              } catch(__mocha_error){
                __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
              }
            }
            try {
              ...
              __LINE__ = 20;
              LeftNav.prototype.addEvent = function () {
                try {
                  __LINE__ = 21;
                  $(document.body).on('click',api.LEFT_A_SELECTOR,__Runtime.getPrivateRecord(this).clickHandler.bind(this));
                  
                  __LINE__ = 22;
                  $(document.body).on('click','a.collapseHead',__Runtime.getPrivateRecord(this).collapseHandler.bind(this));
                  
                  __LINE__ = 23;
                  $(document.body).on('mouseenter',api.LEFT_A_SELECTOR,__Runtime.getPrivateRecord(this).hoverHandler.bind(this));
                  
                  __LINE__ = 24;
                  $(document.body).on('mouseleave',api.LEFT_A_SELECTOR,__Runtime.getPrivateRecord(this).hoverHandler.bind(this));
                } catch(__mocha_error){
                  __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
                }
              };
              ...
              __LINE__ = 27;
              _mochaPrivateHolder.prototype.clickHandler = function (e) {
                try {
                  __LINE__ = 28;
                  var elem = $(e.target),
                  ...
                  if (!elem.parent().hasClass('active')){
                    ...
                    __LINE__ = 32;
                    elem.parents('ul').find('li.active').removeClass('active').find('a').animate( {
                      color : '#FFFFFF'
                    },300).end().find('div').eq(0).css('opacity',1).animate( {
                      left : 0
                    }, {
                      duration : 500,
                      easing : 'easeInOutCirc'
                    ...
                    __LINE__ = 37;
                    __Runtime.getPrivateRecord(this).toggleHandler(elem);
                  }
              ...
              __LINE__ = 41;
              _mochaPrivateHolder.prototype.toggleHandler = function (elem) {
                try {
                  __LINE__ = 42;
                  ...
                  if (prettified === undefined && !agent.agent.legacy){
                    ...
                    function loop(item,current) {
                      try {
                        ...
                        __LINE__ = 53;
                        item.size()>current+1 && setTimeout(loop.bind( null ,item,current+1),16);
                      } catch(__mocha_error){
                        __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
                      }
                    }
              ...
              __LINE__ = 60;
              _mochaPrivateHolder.prototype.collapseHandler = function (_mochaLocalTmp2) {
                try {
                  __LINE__ = 60;
                  var target = _mochaLocalTmp2.target,
                      elem = $(target),
              ...
              __LINE__ = 68;
              _mochaPrivateHolder.prototype.hoverHandler = function (e) {
                try {
                  __LINE__ = 69;
                  var elem = $(e.target),
                      div = elem.parent().find('div').eq(0);
              ...
              __LINE__ = 5;
              __Runtime.createUnenumProp(LeftNav.prototype,"constructor",constructor);
              __LINE__ = 5;
              return LeftNav;
            } catch(__mocha_error){
              __Runtime.exceptionHandler(__LINE__, __FILE__, __mocha_error);
      ...
      $(function () {
        try {
          __LINE__ = 86;
          navigator.userAgent.indexOf('MSIE 6')>-1 && DD_belatedPNG.fix('#logo img');
