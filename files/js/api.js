...
r,k=Date;k.now||(k={now:function(){return+new Date}});var m=0,b,o=/\blang(?:uage)?-([\w.]+)(?!\S)/,s=/\bprettyprint\b/,q=/\bprettyprinted\b/,d=/pre|xmp/i,v=/^code$/i,f=/^(?:pre|code|xmp)$/i;i()}};typeof define==="function"&&define.amd&&define("google-code-prettify",[],function(){return S})})();
  ...
  !function () {
    try {
      var __FILE__ = "-2043510755-jQuery.color.js",
          __LINE__ = 0;
      __LINE__ = 7;
      !function (jQuery) {
  ...
  !function () {
    try {
      var __FILE__ = "-2043510755-jQuery.easing.js",
          __LINE__ = 0;
      __LINE__ = 39;
  ...
  !function () {
    try {
      var __FILE__ = "1278969539-api.js",
          __LINE__ = 0;
      __LINE__ = 3;
      var _mochaLocalTmp0 = __Runtime.modules.get('1278969539-consts.js').consts,
          ...
          LeftNav = function () {
            ...
            try {
              ...
              __LINE__ = 60;
              _mochaPrivateHolder.prototype.collapseHandler = function (_mochaLocalTmp1) {
                try {
                  __LINE__ = 60;
                  var target = _mochaLocalTmp1.target,
                      elem = $(target),
